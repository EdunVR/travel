...
class ovabrw_search_ajax_sidebar extends Widget_Base {
	...
	public function get_script_depends() {
		...
		wp_enqueue_script( 'ovabrw-search', OVABRW_PLUGIN_URI.'assets/js/elementor/product-search.js', array('jquery'), false, true );
		wp_enqueue_script( 'ovabrw-search-ajax-sidebar', OVABRW_PLUGIN_URI.'assets/js/elementor/product-search-ajax-sidebar.js', array('jquery'), false, true );
		return [ '' ];
	}
