...
echo "=== TEST CONTROLLER HPP CALCULATION ===\n\n";
...
if ($item) {
    ...
    if ($responseData['success']) {
        ...
        echo "Found " . count($interOutletItems) . " inter-outlet items\n";
        
        foreach ($interOutletItems as $marginItem) {
            if (strpos($marginItem['produk'], 'Tofu Spesial Udang 120g') !== false && $marginItem['qty'] == 8000) {
