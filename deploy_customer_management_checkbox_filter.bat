@echo off
echo ========================================
echo CUSTOMER MANAGEMENT CHECKBOX FILTER DEPLOYMENT
echo ========================================
echo.

echo 1. Running comprehensive test...
php test_customer_management_checkbox_filter.php
if %errorlevel% neq 0 (
    echo.
...
echo 2. Test Customer Management page: /admin/crm/pelanggan
