...
$content | Out-File -FilePath "resources/views/components/layouts/admin.blade.php" -Encoding UTF8
Write-Host "✅ File created successfully with ModalLoader!"
Write-Host ""
Get-Item "resources/views/components/layouts/admin.blade.php" | Select-Object Name, Length
Write-Host ""
Write-Host "Verifying ModalLoader..."
Select-String -Path "resources/views/components/layouts/admin.blade.php" -Pattern "ModalLoader" | Select-Object -First 3
