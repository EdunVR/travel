            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-card p-6">
                ...
                <div class="border-t border-slate-100 pt-4 space-y-2.5">
                    ...
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="text-slate-700"><?php echo e($affiliator->created_at->format('d M Y')); ?></span>
                    </div>
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            <tr class="hover:bg-slate-50">
                                <td class="px-4 py-2.5">
                                    ...
                                    <div class="text-slate-400 text-xs"><?php echo e($ref->order_date->format('d M Y')); ?></div>
                                </td>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-50">
                    <?php $__empty_1 = true; $__currentLoopData = $recentReferrals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-slate-50">
                        <td class="px-4 py-2.5 text-xs text-slate-600"><?php echo e($ref->order_date->format('d M Y H:i')); ?></td>
                        <td class="px-4 py-2.5">
                            <div class="font-medium text-slate-900 text-xs"><?php echo e($ref->package->package_name ?? 'N/A'); ?></div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50">
                        <td class="px-4 py-2.5 text-xs text-slate-600"><?php echo e($payout->created_at->format('d M Y H:i')); ?></td>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50">
                            <td class="px-4 py-2.5 text-xs text-slate-600"><?php echo e($trx['date']->format('d M Y H:i')); ?></td>
                            <td class="px-4 py-2.5">
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-card p-6">
            ...
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <div class="text-sm font-medium text-slate-900"><?php echo e($affiliator->created_at->format('d M Y H:i')); ?></div>
                </div>
                <?php if($affiliator->approved_at): ?>
                <div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50">
                            <td class="px-4 py-2.5 text-xs text-slate-600"><?php echo e($click->clicked_at->format('d M Y H:i')); ?></td>
