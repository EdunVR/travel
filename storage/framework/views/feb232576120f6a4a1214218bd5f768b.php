...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Accounting Books']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Accounting Books')]); ?>
  <div x-data="booksManagement()" x-init="init()" class="space-y-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'finance.buku.create')): ?>
    ...
    function booksManagement() {
      return {
        ...
        routes: {
          ...
          generateCode: '<?php echo e(route("finance.accounting-books.generate-code")); ?>',
          storeBook: '<?php echo e(route("finance.accounting-books.store")); ?>',
          updateBook: '<?php echo e(route("finance.accounting-books.update", ["id" => ":id"])); ?>',
          toggleBook: '<?php echo e(route("finance.accounting-books.toggle", ["id" => ":id"])); ?>',
          deleteBook: '<?php echo e(route("finance.accounting-books.delete", ["id" => ":id"])); ?>',
          closeBook: '<?php echo e(route("finance.accounting-books.close", ["id" => ":id"])); ?>',
          showBook: '<?php echo e(route("finance.accounting-books.show", ["id" => ":id"])); ?>',
        ...
        async generateBookCode() {
            try {
                ...
                const url = `<?php echo e(route('finance.accounting-books.generate-code')); ?>?${params}`;
        ...
        viewBook(id) {
            const url = '<?php echo e(route("finance.buku.detail", ["id" => ":id"])); ?>'.replace(':id', id);
        ...
        async loadActivityData() {
            try {
                ...
                const response = await fetch(`<?php echo e(route('finance.book-activity.data')); ?>?${params}`);
                const result = await response.json();
        ...
        async exportToXLSX() {
          try {
            ...
            const url = `<?php echo e(route('finance.accounting-books.export.xlsx')); ?>?${params}`;
        ...
        async exportToPDF() {
          try {
            ...
            const url = `<?php echo e(route('finance.accounting-books.export.pdf')); ?>?${params}`;
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\finance\buku\index.blade.php ENDPATH**/ ?>