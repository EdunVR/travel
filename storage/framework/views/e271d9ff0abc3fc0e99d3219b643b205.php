    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content modal-glass">
            ...
            <div class="modal-body bg-light">
                <form id="form-produksi" method="POST" action="<?php echo e(route('produksi.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="id_outlet_produksi" id="id_outlet_produksi" value="<?php echo e($id_outlet); ?>">
                                ...
                                <div class="col-md-6 border-right p-3">
                                    ...
                                    <div id="available-bahans" class="available-container">
                                        <?php $__currentLoopData = $bahans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bahan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <div class="bahan-item card card-pastel mb-2 <?php echo e($isDisabled ? 'bg-light' : 'cursor-pointer btn-hover-lift'); ?>" 
                                                 data-bahan-id="<?php echo e($bahan->id_bahan); ?>"
                                                 data-bahan-name="<?php echo e($bahan->nama_bahan); ?>"
                                                 data-stok="<?php echo e($stokTotal); ?>"
                                                 data-satuan="<?php echo e($bahan->satuan->nama_satuan ?? '-'); ?>"
                                                 data-harga-rata="<?php echo e($avgPrice); ?>"
                                                 onclick="<?php echo e(!$isDisabled ? "addBahanToProduction('{$bahan->id_bahan}')" : ''); ?>">
                                                <div class="card-body py-2">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <h6 class="mb-1 <?php echo e($isDisabled ? 'text-muted' : 'text-dark'); ?>">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <small class="text-muted">
                                                                    ...
                                                                    <span class="font-weight-bold"><?php echo e($stokTotal); ?></span> 
                                                                    <?php echo e($bahan->satuan->nama_satuan ?? '-'); ?>

                                                                </small>
                                                                <small class="text-success font-weight-bold">
                                                                    <i data-feather="dollar-sign" class="icon-xs mr-1"></i>
                                                                    ~<?php echo e(format_uang($avgPrice)); ?>
...
function calculateHargaFifo(bahanId, jumlah) {
    $.ajax({
        url: '<?php echo e(route("produksi.getHargaFifo")); ?>',
        type: 'POST',
        data: {
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\produksi\create.blade.php ENDPATH**/ ?>