...
<body class="bg-gradient-to-br from-green-50 to-emerald-100 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-md px-4">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form action="<?php echo e(route('affiliate.reset-password.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\affiliate\reset-password.blade.php ENDPATH**/ ?>