    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <button onclick="addForm('<?php echo e(route('service.mesin-customer.store')); ?>')" class="btn btn-success btn-xs btn-flat">
...
<?php if ($__env->exists('service_management.mesin_customer.form')) echo $__env->make('service_management.mesin_customer.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<script>
    ...
    $(function () {
        table = $('#table-mesin-customer').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('service.mesin-customer.index')); ?>',
            },
            columns: [
        ...
        tableProduk = $('.table-produk').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('produk.data')); ?>', // Pastikan route ini ada
            },
            columns: [
                {data: 'DT_RowIndex', searchable: false, sortable: false},
                {data: 'kode_produk'},
        ...
        tableMember = $('.table-member').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('member.data')); ?>', // Pastikan route ini ada
            },
            columns: [
                {data: 'DT_RowIndex', searchable: false, sortable: false},
                {data: 'nama'},
        ...
        $('#nama_produk').on('input', function() {
            ...
            if (keyword.length >= 2) {
                $.get('<?php echo e(route('produk.cari')); ?>', { keyword: keyword })
        ...
        $('#nama_member').on('input', function() {
            ...
            if (keyword.length >= 2) {
                $.get('<?php echo e(route('member.cari')); ?>', { keyword: keyword })
                    .done(function(response) {
                        if (response.length > 0) {
    ...
    function editForm(url) {
        ...
        var editUrl = '<?php echo e(route("service.mesin-customer.edit", ":id")); ?>'.replace(':id', id);
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\service_management\mesin_customer\index.blade.php ENDPATH**/ ?>