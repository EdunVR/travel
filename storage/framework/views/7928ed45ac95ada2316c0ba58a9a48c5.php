...
function loadProdukGerobak(gerobakId) {
    const url = '<?php echo e(route("agen_gerobak.gerobak.get-produk", ":gerobakId")); ?>'.replace(':gerobakId', gerobakId);
    $.get(url)
        .done(function(response) {
...
function simpanPerubahan() {
    ...
    const csrfToken = $('meta[name="csrf-token"]').attr('content');
     const url = '<?php echo e(route("agen_gerobak.gerobak.update-produk", ":gerobakId")); ?>'.replace(':gerobakId', currentGerobakId);
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\gerobak\manage_produk.blade.php ENDPATH**/ ?>