...
<?php $__env->startSection('title'); ?> Detail RAB Template <?php $__env->stopSection(); ?>
    ...
    <div class="col-lg-12">
        <div class="box shadow-sm rounded">
            ...
            <div class="box-body p-4">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <p class="mb-0"><?php echo e($template->nama_template); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <p class="mb-0"><?php echo e($template->deskripsi); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <span class="badge badge-<?php echo e($template->status == 'Draft' ? 'secondary' : 
                                    ...
                                    <i data-feather="<?php echo e($template->status == 'Draft' ? 'edit-3' : 
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-body p-3">
                                        ...
                                        <h4 class="mb-0">Rp <?php echo e(number_format($template->total_budget, 0, ',', '.')); ?></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-body p-3">
                                        ...
                                        <h4 class="mb-0">Rp <?php echo e(number_format($template->total_nilai_disetujui, 0, ',', '.')); ?></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-body p-3">
                                        ...
                                        <h4 class="mb-0">Rp <?php echo e(number_format($template->total_realisasi, 0, ',', '.')); ?></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <form action="<?php echo e(route('rab_template.update_approval', $template->id_rab)); ?>" method="POST" enctype="multipart/form-data" id="approval-form">
                    <?php echo csrf_field(); ?>
                    <div class="form-group mb-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $template->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="rab-item">
                                        <td>
                                            <strong><?php echo e($detail->nama_komponen); ?></strong>
                                            <?php if($detail->deskripsi): ?>
                                                <p class="text-muted mb-0 small"><?php echo e($detail->deskripsi); ?></p>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-center"><?php echo e($detail->jumlah); ?></td>
                                        <td class="text-center"><?php echo e($detail->satuan); ?></td>
                                        <td class="text-right">Rp <?php echo e(number_format($detail->harga_satuan, 0, ',', '.')); ?></td>
                                        <td class="text-right">Rp <?php echo e(number_format($detail->budget, 0, ',', '.')); ?></td>
                                        <td>
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="text" 
                                                    name="items[<?php echo e($detail->id_rab_detail); ?>][nilai_disetujui]" 
                                                    class="form-control nilai-disetujui" 
                                                    value="<?php echo e($detail->nilai_disetujui ? number_format($detail->nilai_disetujui, 0, ',', '.') : ''); ?>">
                                            </div>
                                        </td>
                                        <td>
                                            <!-- Progress bar -->
                                            <div class="progress mb-2 position-relative" style="height: 20px;">
                                                ...
                                                <div class="progress-bar bg-success d-flex align-items-center justify-content-center"
                                                    ...
                                                    aria-valuemin="0"
                                                    aria-valuemax="100">
                                                    <small class="text-white fw-bold"><?php echo e(number_format($percentage, 2)); ?>%</small>
                                                </div>
                                            </div>

                                            <span class="me-2 fw-semibold">Terpakai: Rp</span>
                                            <span class="me-2 fw-semibold realisasi-text"><?php echo e(number_format($detail->realisasi_pemakaian, 0, ',', '.')); ?></span>
                                            <span class="me-2 fw-bold"> / </span>
                                            <span class="text-muted sisa-text">Sisa: Rp <?php echo e(number_format(($detail->nilai_disetujui ?? 0) - $detail->realisasi_pemakaian, 0, ',', '.')); ?></span>
                                            ...
                                            <div class="form-row-action d-flex align-items-center mt-2">
                                                ...
                                                <button type="button" 
                                                        ...
                                                        data-detail-id="<?php echo e($detail->id_rab_detail); ?>">
                                        ...
                                        <td class="text-center">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" name="items[<?php echo e($detail->id_rab_detail); ?>][disetujui]" 
                                                    class="custom-control-input approve-check" 
                                                    id="check-<?php echo e($detail->id_rab_detail); ?>"
                                                    value="1"
                                                    <?php echo e($detail->disetujui ? 'checked' : ''); ?>>
                                                <label class="custom-control-label" for="check-<?php echo e($detail->id_rab_detail); ?>"></label>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <tfoot>
                                    <tr class="bg-light font-weight-bold">
                                        ...
                                        <th class="text-right">Rp <?php echo e(number_format($template->total_budget, 0, ',', '.')); ?></th>
                                        <th class="text-right" id="total-disetujui">Rp <?php echo e(number_format($template->total_nilai_disetujui, 0, ',', '.')); ?></th>
                                        <th class="text-right" id="total-realisasi">Rp <?php echo e(number_format($template->total_realisasi, 0, ',', '.')); ?></th>
                                        <th></th>
                                    </tr>
                                </tfoot>
                            </table>
                    ...
                    <div class="card mb-4 border shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                <?php if($template->details->whereNotNull('bukti_transfer')->count() > 0): ?>
                                    <div class="mb-3">
                                        <label class="font-weight-bold">Bukti Transfer Saat Ini:</label>
                                        <?php $__currentLoopData = $template->details->whereNotNull('bukti_transfer'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($loop->first): ?>
                                            <div class="mt-2 text-center bg-light p-3 rounded">
                                                ...
                                                <?php if(file_exists($fullPath)): ?>
                                                    <?php if(in_array(pathinfo($detail->bukti_transfer, PATHINFO_EXTENSION), ['jpg', 'jpeg', 'png', 'gif'])): ?>
                                                        <img src="<?php echo e(asset('storage/'.$filePath)); ?>" 
                                                            class="img-fluid mb-2" style="max-height: 200px;">
                                                    <?php else: ?>
                                                        <div class="file-preview">
                                                            <i data-feather="file" class="feather-large"></i>
                                                            <p class="mb-0"><?php echo e(basename($detail->bukti_transfer)); ?></p>
                                                        </div>
                                                    <?php endif; ?>
                                                ...
                                                <?php else: ?>
                                                    <p class="text-danger">File tidak ditemukan di: <?php echo e($fullPath); ?></p>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="sumber_dana" class="form-control">
                                            ...
                                            <option value="Tunai" <?php echo e($template->details->first()->sumber_dana == 'Tunai' ? 'selected' : ''); ?>>Tunai</option>
                                            <option value="BSI" <?php echo e($template->details->first()->sumber_dana == 'BSI' ? 'selected' : ''); ?>>BSI</option>
                                            <option value="BRI" <?php echo e($template->details->first()->sumber_dana == 'BRI' ? 'selected' : ''); ?>>BRI</option>
                                            <option value="Seabank" <?php echo e($template->details->first()->sumber_dana == 'Seabank' ? 'selected' : ''); ?>>Seabank</option>
                                            <option value="Mandiri" <?php echo e($template->details->first()->sumber_dana == 'Mandiri' ? 'selected' : ''); ?>>Mandiri</option>
                                            <option value="BCA" <?php echo e($template->details->first()->sumber_dana == 'BCA' ? 'selected' : ''); ?>>BCA</option>
                                        </select>
                                    </div>
                    ...
                    <div class="form-group d-flex justify-content-end">
                        <button type="button" class="btn btn-secondary mr-2" onclick="window.location.href='<?php echo e(route('rab_template.index')); ?>'">
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\rab_template\show.blade.php ENDPATH**/ ?>