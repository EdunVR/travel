...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Detail Mitra - ' . $affiliator->full_name]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Detail Mitra - ' . $affiliator->full_name)]); ?>
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-2xl font-bold tracking-tight text-slate-900"><?php echo e($affiliator->full_name); ?></h1>
        </div>
        <div class="flex gap-2">
            <?php if($affiliator->status === 'pending'): ?>
            <form action="<?php echo e(route('admin.inventaris.affiliate.approve', $affiliator)); ?>" method="POST">
            ...
            <?php elseif($affiliator->status === 'active'): ?>
            <form action="<?php echo e(route('admin.inventaris.affiliate.suspend', $affiliator)); ?>" method="POST">
                <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
    ...
    <div id="tab-dashboard" class="tab-content grid lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-4">
            <div class="bg-white rounded-xl border border-slate-200 shadow-card p-6">
                <div class="text-center mb-5">
                    ...
                    <h2 class="font-bold text-slate-900"><?php echo e($affiliator->full_name); ?></h2>
                    <p class="text-slate-500 text-sm"><?php echo e($affiliator->email); ?></p>
                    <div class="mt-2">
                        <?php if($affiliator->status === 'active'): ?>
                            <span class="bg-green-100 text-green-700 text-xs px-3 py-1 rounded-full font-medium">Aktif</span>
                        <?php elseif($affiliator->status === 'pending'): ?>
                ...
                <div class="border-t border-slate-100 pt-4 space-y-2.5">
                    <div class="flex justify-between text-sm">
                        ...
                        <code class="font-medium text-green-600 text-xs"><?php echo e($affiliator->username); ?></code>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-slate-500">No. HP</span>
                        <span class="font-medium text-slate-900"><?php echo e($affiliator->phone_number); ?></span>
                    </div>
                    <div class="text-sm">
                        ...
                        <div class="bg-slate-50 border border-slate-200 rounded-lg p-2 flex items-center gap-2">
                            <code class="text-green-600 text-xs flex-1 break-all"><?php echo e($affiliator->referral_link); ?></code>
                            <button onclick="copyReferralLink('<?php echo e($affiliator->referral_link); ?>', event)" 
                    ...
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="text-slate-700"><?php echo e($affiliator->created_at ? $affiliator->created_at->format('d M Y') : '-'); ?></span>
                    </div>
                    <?php if($affiliator->approved_at): ?>
                    <div class="flex justify-between text-sm">
                        <span class="text-slate-500">Diapprove</span>
                        <span class="text-slate-700"><?php echo e($affiliator->approved_at->format('d M Y')); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="mt-4 bg-blue-50 rounded-lg p-4 border border-blue-100">
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-bold text-blue-700">Rp <?php echo e(number_format($affiliator->ppc_commission, 0, ',', '.')); ?></span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-slate-600">Min Sale</span>
                            <span class="font-bold text-blue-700">Rp <?php echo e(number_format($affiliator->min_sale_commission, 0, ',', '.')); ?></span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-slate-600">Cookie Lifetime</span>
                            <span class="font-bold text-blue-700"><?php echo e($affiliator->cookie_lifetime ?? 30); ?> Hari</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4 bg-slate-50 rounded-lg p-3 border border-slate-100">
                    ...
                    <div class="text-sm font-medium text-slate-900"><?php echo e($affiliator->bank_name); ?></div>
                    <div class="text-sm font-bold text-slate-900"><?php echo e($affiliator->bank_account_number); ?></div>
                    <div class="text-xs text-slate-500"><?php echo e($affiliator->bank_account_name); ?></div>
                </div>
                <?php endif; ?>

                
                <?php if($affiliator->payment_proof): ?>
                <div class="mt-4 bg-slate-50 rounded-lg p-3 border border-slate-100">
                    <div class="text-xs font-semibold text-slate-500 mb-2">
                        <i class="fas fa-receipt mr-1"></i> Bukti Pembayaran
                    </div>
                    <div class="relative group">
                        <img src="<?php echo e(asset('storage/' . $affiliator->payment_proof)); ?>" 
                    ...
                    <div class="mt-2 flex gap-2">
                        <a href="<?php echo e(asset('storage/' . $affiliator->payment_proof)); ?>" 
                           target="_blank"
                ...
                <?php elseif($affiliator->partnershipProgram && $affiliator->partnershipProgram->registration_fee > 0): ?>
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                ?>
                <?php $__currentLoopData = $detailStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-xl border border-slate-200 shadow-card p-4 text-center">
                    <div class="text-lg font-bold <?php echo e($s['color']); ?>"><?php echo e($s['value']); ?></div>
                    <div class="text-xs text-slate-500 mt-1"><?php echo e($s['label']); ?></div>
                </div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-card p-4">
                ...
                <div class="grid grid-cols-3 gap-4 text-center">
                    <div>
                        <div class="text-xl font-bold text-amber-600"><?php echo e($referralStats['pending']); ?></div>
                        <div class="text-xs text-slate-500">Pending</div>
                    </div>
                    <div>
                        <div class="text-xl font-bold text-green-600"><?php echo e($referralStats['verified']); ?></div>
                        <div class="text-xs text-slate-500">Verified</div>
                    </div>
                    <div>
                        <div class="text-xl font-bold text-red-600"><?php echo e($referralStats['rejected']); ?></div>
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            <tr class="hover:bg-slate-50">
                                <td class="px-4 py-2.5">
                                    <div class="font-medium text-slate-900 text-xs"><?php echo e($ref->package->package_name ?? 'N/A'); ?></div>
                                    <div class="text-slate-400 text-xs"><?php echo e($ref->order_date ? $ref->order_date->format('d M Y') : '-'); ?></div>
                                </td>
                                <td class="px-4 py-2.5">
                                    <div class="font-medium text-slate-900 text-xs"><?php echo e($ref->booking->member->nama ?? $ref->booking->member->full_name ?? 'N/A'); ?></div>
                                    <div class="text-slate-400 text-xs"><?php echo e($ref->booking->member->telepon ?? ''); ?></div>
                                </td>
                                ...
                                <td class="px-4 py-2.5 text-center">
                                    <div class="flex flex-col gap-1 items-center">
                                        ...
                                        <?php if(!($ref->termin_1_released ?? false)): ?>
                                        <form action="<?php echo e(route('admin.inventaris.affiliate.referral.release-termin1', $ref)); ?>" method="POST">
                                            <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                        ...
                                        <?php if(($ref->termin_1_released ?? false) && !($ref->termin_2_released ?? false)): ?>
                                        <form action="<?php echo e(route('admin.inventaris.affiliate.referral.release-termin2', $ref)); ?>" method="POST">
                                            <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                        ...
                                        <?php if(!($ref->termin_2_released ?? false)): ?>
                                        <form action="<?php echo e(route('admin.inventaris.affiliate.referral.force-release', $ref)); ?>" method="POST"
                                        ...
                                        <button type="button" onclick="rejectReferral(<?php echo e($ref->id); ?>)"
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-card overflow-hidden" x-data="voucherManager(<?php echo e($affiliator->id); ?>)">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-50">
                    <?php $__empty_1 = true; $__currentLoopData = $recentReferrals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-slate-50">
                        <td class="px-4 py-2.5 text-xs text-slate-600"><?php echo e($ref->order_date ? $ref->order_date->format('d M Y H:i') : '-'); ?></td>
                        <td class="px-4 py-2.5">
                            <div class="font-medium text-slate-900 text-xs"><?php echo e($ref->package->package_name ?? 'N/A'); ?></div>
                            <div class="text-slate-400 text-xs">Order #<?php echo e($ref->id); ?></div>
                        </td>
                        <td class="px-4 py-2.5 text-right text-xs text-slate-600">
                            Rp <?php echo e(number_format($ref->order_amount, 0, ',', '.')); ?>
                        ...
                        <td class="px-4 py-2.5 text-right text-xs font-bold text-green-600">
                            ...
                            <div class="text-xs text-slate-400 font-normal mt-0.5">
                                T1: Rp <?php echo e(number_format($ref->termin_1_amount ?? $ref->commission_amount * 0.5, 0, ',', '.')); ?>

                                | T2: Rp <?php echo e(number_format($ref->termin_2_amount ?? $ref->commission_amount * 0.5, 0, ',', '.')); ?>
                        ...
                        <td class="px-4 py-2.5 text-center">
                            ...
                            <div class="mt-1 flex gap-1 justify-center">
                                <span class="text-xs px-1.5 py-0.5 rounded <?php echo e(($ref->termin_1_released ?? false) ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-400'); ?>">
                                    T1 <?php echo e(($ref->termin_1_released ?? false) ? '✓' : '○'); ?>

                                </span>
                                <span class="text-xs px-1.5 py-0.5 rounded <?php echo e(($ref->termin_2_released ?? false) ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-400'); ?>">
                                    T2 <?php echo e(($ref->termin_2_released ?? false) ? '✓' : '○'); ?>
                        ...
                        <td class="px-4 py-2.5 text-center">
                            <div class="flex flex-col gap-1 items-center">
                                ...
                                <?php elseif(!($ref->termin_2_released ?? false)): ?>
                                <form action="<?php echo e(route('admin.inventaris.affiliate.referral.release-termin2', $ref)); ?>" method="POST">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                ...
                                <?php endif; ?>
                                <?php if($ref->status === 'pending' && ($ref->termin_1_released ?? false)): ?>
                                <form action="<?php echo e(route('admin.inventaris.affiliate.referral.verify', $ref)); ?>" method="POST">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-card overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-50">
                    <?php $__empty_1 = true; $__currentLoopData = $affiliator->payouts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payout): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-slate-50">
                        <td class="px-4 py-2.5 text-xs text-slate-600"><?php echo e($payout->created_at ? $payout->created_at->format('d M Y H:i') : '-'); ?></td>
                        <td class="px-4 py-2.5 text-xs text-slate-900">
                            <div class="font-medium"><?php echo e($payout->payment_method ?? 'Transfer Bank'); ?></div>
                            <div class="text-slate-400"><?php echo e($payout->bank_name ?? '-'); ?></div>
                        </td>
                        <td class="px-4 py-2.5 text-right text-xs font-bold text-green-600">
                        ...
                        <td class="px-4 py-2.5 text-xs text-slate-600"><?php echo e($payout->notes ?? '-'); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
    ...
    <div class="space-y-4">
        <div class="grid grid-cols-3 gap-4">
            <div class="bg-white rounded-xl border border-slate-200 shadow-card p-6 text-center">
                <div class="text-2xl font-bold text-green-600">Rp <?php echo e(number_format($affiliator->available_balance, 0, ',', '.')); ?></div>
                <div class="text-xs text-slate-500 mt-1">Saldo Tersedia</div>
            </div>
            <div class="bg-white rounded-xl border border-slate-200 shadow-card p-6 text-center">
                <div class="text-2xl font-bold text-amber-600">Rp <?php echo e(number_format($affiliator->pending_balance, 0, ',', '.')); ?></div>
                <div class="text-xs text-slate-500 mt-1">Pending</div>
            </div>
            <div class="bg-white rounded-xl border border-slate-200 shadow-card p-6 text-center">
                <div class="text-2xl font-bold text-blue-600">Rp <?php echo e(number_format($affiliator->total_withdrawn, 0, ',', '.')); ?></div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50">
                            <td class="px-4 py-2.5 text-xs text-slate-600"><?php echo e(isset($trx['date']) && $trx['date'] ? $trx['date']->format('d M Y H:i') : '-'); ?></td>
                            <td class="px-4 py-2.5">
                            ...
                            <td class="px-4 py-2.5 text-xs text-slate-900"><?php echo e($trx['description']); ?></td>
                            <td class="px-4 py-2.5 text-right text-xs font-bold <?php echo e($trx['type'] == 'credit' ? 'text-green-600' : 'text-red-600'); ?>">
                                <?php echo e($trx['type'] == 'credit' ? '+' : '-'); ?> Rp <?php echo e(number_format($trx['amount'], 0, ',', '.')); ?>

                            </td>
                            <td class="px-4 py-2.5 text-right text-xs text-slate-600">
                                Rp <?php echo e(number_format($balance, 0, ',', '.')); ?>

                                <?php $balance = $trx['type'] == 'credit' ? $balance - $trx['amount'] : $balance + $trx['amount']; ?>
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-card p-6">
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <div class="text-sm font-medium text-slate-900"><?php echo e($affiliator->full_name); ?></div>
                </div>
                <div>
                    <label class="text-xs text-slate-500">Email</label>
                    <div class="text-sm font-medium text-slate-900"><?php echo e($affiliator->email); ?></div>
                </div>
                <div>
                    <label class="text-xs text-slate-500">No. HP</label>
                    <div class="text-sm font-medium text-slate-900"><?php echo e($affiliator->phone_number); ?></div>
                </div>
                <div>
                    <label class="text-xs text-slate-500">Username</label>
                    <div class="text-sm font-medium text-green-600"><?php echo e($affiliator->username); ?></div>
                </div>
                <div>
                    <label class="text-xs text-slate-500">Tanggal Daftar</label>
                    <div class="text-sm font-medium text-slate-900"><?php echo e($affiliator->created_at ? $affiliator->created_at->format('d M Y H:i') : '-'); ?></div>
                </div>
                <?php if($affiliator->approved_at): ?>
                <div>
                    <label class="text-xs text-slate-500">Tanggal Diapprove</label>
                    <div class="text-sm font-medium text-slate-900"><?php echo e($affiliator->approved_at->format('d M Y H:i')); ?></div>
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-card p-6">
            ...
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <div class="text-sm font-medium text-slate-900"><?php echo e($affiliator->bank_account_number); ?></div>
                </div>
                <div>
                    <label class="text-xs text-slate-500">Atas Nama</label>
                    <div class="text-sm font-medium text-slate-900"><?php echo e($affiliator->bank_account_name); ?></div>
                </div>
            </div>
            <?php else: ?>
        ...
        <div class="space-y-4">
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <div class="flex items-center gap-2">
                    <code class="flex-1 bg-white border border-blue-200 rounded px-3 py-2 text-xs text-blue-600 break-all"><?php echo e($affiliator->referral_link); ?></code>
                    <button onclick="copyReferralLink('<?php echo e($affiliator->referral_link); ?>', event)" 
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="border border-slate-200 rounded-lg p-4">
                    <div class="font-medium text-slate-900 text-sm mb-2"><?php echo e($package->package_name); ?></div>
                    <div class="text-xs text-slate-500 mb-3">Rp <?php echo e(number_format($package->price, 0, ',', '.')); ?></div>
                    <div class="flex items-center gap-2">
                        <input type="text" readonly 
                               value="<?php echo e(route('public.paket.show', $package->id)); ?>?ref=<?php echo e($affiliator->username); ?>"
                               class="flex-1 px-2 py-1 border border-slate-200 rounded text-xs bg-slate-50">
                        <button onclick="copyReferralLink('<?php echo e(route('public.paket.show', $package->id)); ?>?ref=<?php echo e($affiliator->username); ?>', event)" 
    ...
    <div class="space-y-4">
        <div class="grid grid-cols-4 gap-4">
            <div class="bg-white rounded-xl border border-slate-200 shadow-card p-4 text-center">
                <div class="text-xl font-bold text-blue-600"><?php echo e(number_format($affiliator->total_clicks)); ?></div>
                <div class="text-xs text-slate-500 mt-1">Total Klik</div>
            </div>
            <div class="bg-white rounded-xl border border-slate-200 shadow-card p-4 text-center">
                <div class="text-xl font-bold text-green-600"><?php echo e(number_format($affiliator->total_sales)); ?></div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-card p-4 text-center">
                ...
                ?>
                <div class="text-xl font-bold text-purple-600"><?php echo e(number_format($conversionRate, 2)); ?>%</div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-card p-4 text-center">
                ...
                ?>
                <div class="text-xl font-bold text-green-600">Rp <?php echo e(number_format($totalEarnings, 0, ',', '.')); ?></div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50">
                            <td class="px-4 py-2.5 text-xs text-slate-600"><?php echo e($click->clicked_at ? $click->clicked_at->format('d M Y H:i') : '-'); ?></td>
                            <td class="px-4 py-2.5 text-xs text-slate-900"><?php echo e($click->ip_address); ?></td>
                            <td class="px-4 py-2.5 text-xs text-slate-600"><?php echo e(Str::limit($click->user_agent, 50)); ?></td>
                            <td class="px-4 py-2.5 text-xs text-slate-600"><?php echo e(Str::limit($click->referrer_url ?? '-', 40)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
    ...
    <div id="tab-leaderboard" class="tab-content hidden">
        <?php echo $__env->make('admin.affiliate.leaderboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
...
<div id="editCommissionModal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/40">
    <div class="bg-white rounded-2xl shadow-float w-full max-w-md mx-4 p-6">
        ...
        <p class="text-sm text-slate-600 mb-4"><?php echo e($affiliator->full_name); ?></p>
        
        <form action="<?php echo e(route('admin.inventaris.affiliate.update-commission', $affiliator)); ?>" method="POST">
            <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="ppc_commission" value="<?php echo e($affiliator->ppc_commission); ?>" required min="0" step="1"
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 text-sm">Rp</span>
                        <input type="number" name="min_sale_commission" value="<?php echo e($affiliator->min_sale_commission); ?>" required min="0" step="1000"
                               class="w-full pl-10 pr-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-300"
                               placeholder="500000">
                    </div>
                ...
                <div>
                    ...
                    <input type="number" name="cookie_lifetime" value="<?php echo e($affiliator->cookie_lifetime ?? 30); ?>" required min="1" max="365" step="1"
                           class="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-300"
                           placeholder="30">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php $__currentLoopData = $feeDists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-slate-50">
                        <td class="px-4 py-2 font-medium text-slate-800 text-xs"><?php echo e($fd->fromAffiliator?->full_name); ?></td>
                        <td class="px-4 py-2 text-center">
                            <span class="text-xs px-2 py-0.5 rounded-full <?php echo e($fd->termin === 'termin_1' ? 'bg-blue-100 text-blue-700' : 'bg-purple-100 text-purple-700'); ?>">
                                <?php echo e($fd->termin === 'termin_1' ? 'T1' : 'T2'); ?>

                            </span>
                        </td>
                        <td class="px-4 py-2 text-right font-medium text-green-700 text-xs">Rp <?php echo e(number_format($fd->amount, 0, ',', '.')); ?></td>
                        <td class="px-4 py-2 text-center">
                            <span class="text-xs px-2 py-0.5 rounded-full <?php echo e($fd->status === 'released' ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'); ?>">
                                <?php echo e($fd->status === 'released' ? 'Cair' : ucfirst($fd->status)); ?>
...
<script src="<?php echo e(asset('js/affiliate-tree.js')); ?>?v=<?php echo e(filemtime(public_path('js/affiliate-tree.js'))); ?>"></script>
<script>
...
(function() {
    ...
    const J_NODES = <?php echo json_encode($jNodes, 15, 512) ?>;
    const J_EDGES = <?php echo json_encode($jEdges, 15, 512) ?>;
    let jRendered = false;
        ...
        jBtn.addEventListener('click', () => {
            ...
            setTimeout(() => {
                ...
                const tree = new AffiliateTree(svg, J_NODES, J_EDGES, {
                    ...
                    feeUrl:     '<?php echo e(route("admin.inventaris.affiliate.hierarchy.fee.save")); ?>',
                    viewBase:   '<?php echo e(url("admin/inventaris/affiliate")); ?>',
                    updateBase: '<?php echo e(url("admin/inventaris/affiliate")); ?>',
                });
                tree.render();
                ...
                document.addEventListener('affTree:editNode', ({ detail: { node } }) => {
                    ...
                    document.getElementById('jtab-edit-form').action =
                        `<?php echo e(url("admin/inventaris/affiliate")); ?>/${node.id}/update-hierarchy`;
...
function openEditJenjangModal() {
    ...
    form.action = '<?php echo e(route("admin.inventaris.affiliate.update-hierarchy", $affiliator)); ?>';
    document.getElementById('jtab-edit-subtitle').textContent = '<?php echo e($affiliator->full_name); ?>';
    document.getElementById('jtab-edit-master').value  = '<?php echo e($affiliator->upline_master_id ?? ""); ?>';
    document.getElementById('jtab-edit-leader').value  = '<?php echo e($affiliator->upline_leader_id ?? ""); ?>';
    document.getElementById('jtab-edit-partner').value = '<?php echo e($affiliator->upline_partner_id ?? ""); ?>';
    document.getElementById('jtab-modal-edit').classList.remove('hidden');
}
</script>
        ...
        <form id="jtab-edit-form" method="POST" class="p-6 space-y-4">
            ...
            <div>
                ...
                <select name="upline_master_id" id="jtab-edit-master"
                    ...
                    <?php $__currentLoopData = \App\Models\Affiliator::active()->whereHas('partnershipProgram', fn($q) => $q->where('slug','hm-master'))->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($m->id); ?>"><?php echo e($m->full_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
                ...
                <select name="upline_leader_id" id="jtab-edit-leader"
                    ...
                    <?php $__currentLoopData = \App\Models\Affiliator::active()->whereHas('partnershipProgram', fn($q) => $q->where('slug','hm-leader'))->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($l->id); ?>"><?php echo e($l->full_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
                ...
                <select name="upline_partner_id" id="jtab-edit-partner"
                    class="w-full h-10 px-3 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300">
                    <option value="">— Tidak Ada —</option>
                    <?php $__currentLoopData = \App\Models\Affiliator::active()->whereHas('partnershipProgram', fn($q) => $q->where('slug','hm-partner'))->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($p->id); ?>"><?php echo e($p->full_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
...
function rejectReferral(id) {
    document.getElementById('rejectReferralForm').action = '<?php echo e(url("admin/inventaris/affiliate/referral")); ?>/' + id + '/reject';
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\affiliate\show.blade.php ENDPATH**/ ?>