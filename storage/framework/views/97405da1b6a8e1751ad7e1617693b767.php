...
<body>
    <div class="header">
        ...
        <?php if(isset($filters['outlet_name'])): ?>
            <p><?php echo e($filters['outlet_name']); ?></p>
        <?php endif; ?>
    </div>

    <?php if(!empty($filters) && (isset($filters['date_from']) || isset($filters['status']) || isset($filters['category']))): ?>
    <div class="filter-info">
        ...
        <?php elseif(isset($filters['date_from'])): ?>
            <p>• Dari Tanggal: <?php echo e(\Carbon\Carbon::parse($filters['date_from'])->format('d/m/Y')); ?></p>
        <?php elseif(isset($filters['date_to'])): ?>
            <p>• Sampai Tanggal: <?php echo e(\Carbon\Carbon::parse($filters['date_to'])->format('d/m/Y')); ?></p>
        <?php endif; ?>
    ...
    <table>
        ...
        <tbody>
            <?php
                $totalAmount = 0;
            ?>
            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td>
                        ...
                        ?>
                        <span class="category-badge <?php echo e($categoryClass); ?>"><?php echo e($categoryName); ?></span>
                    </td>
                    <td><?php echo e($expense->account_code); ?></td>
                    <td><?php echo e($expense->account_name); ?></td>
                    ...
                    <td class="text-center">
                        <span class="status-badge status-<?php echo e($expense->status); ?>">
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-right amount" style="padding: 10px;">
                    <strong>Rp <?php echo e(number_format($totalAmount, 0, ',', '.')); ?></strong>
                </td>
                <td></td>
            </tr>
        </tfoot>
    ...
    <div class="summary">
        <div class="summary-row">
            ...
            <span class="amount">Rp <?php echo e(number_format($totalAmount, 0, ',', '.')); ?></span>
        </div>
        <div class="summary-row">
            <span>Jumlah Transaksi:</span>
            <span><?php echo e(count($data)); ?> transaksi</span>
        </div>
    </div>
    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\finance\biaya\pdf.blade.php ENDPATH**/ ?>