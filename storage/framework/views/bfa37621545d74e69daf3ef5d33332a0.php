...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Master Sparepart <?php $__env->endSlot(); ?>
    ...
    <div x-data="sparepartData()" x-init="init()" class="space-y-4">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex gap-2">
                <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'inventaris.sparepart.create')): ?>
    ...
    <script>
        ...
        window.sparepartRoutes = {
            data: '<?php echo e(route('admin.inventaris.sparepart.data')); ?>',
            store: '<?php echo e(route('admin.inventaris.sparepart.store')); ?>',
            show: '<?php echo e(route('admin.inventaris.sparepart.show', ':id')); ?>',
            update: '<?php echo e(route('admin.inventaris.sparepart.update', ':id')); ?>',
            destroy: '<?php echo e(route('admin.inventaris.sparepart.destroy', ':id')); ?>',
            generateKode: '<?php echo e(route('admin.inventaris.sparepart.generate-kode')); ?>',
            adjust: '<?php echo e(route('admin.inventaris.sparepart.adjust', ':id')); ?>',
            adjustPrice: '<?php echo e(route('admin.inventaris.sparepart.adjust-price', ':id')); ?>',
            logs: '<?php echo e(route('admin.inventaris.sparepart.logs', ':id')); ?>',
            export: '<?php echo e(route('admin.inventaris.sparepart.export')); ?>',
            bulkDelete: '<?php echo e(route('admin.inventaris.sparepart.bulk-delete')); ?>',
            searchKaryawan: '<?php echo e(route('admin.inventaris.sparepart.search-karyawan')); ?>'
        };
    ...
    <script src="<?php echo e(asset('js/sparepart.js')); ?>?v=<?php echo e(time()); ?>"></script>
    
    <!-- Load emergency fix as backup -->
    <script src="<?php echo e(asset('js/sparepart-emergency-fix.js')); ?>?v=<?php echo e(time()); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\inventaris\sparepart\index.blade.php ENDPATH**/ ?>