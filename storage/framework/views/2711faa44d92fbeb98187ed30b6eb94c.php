    ...
    return {
        ...
        async searchProducts(index, query) {
            ...
            this.searchTimeout = setTimeout(async () => {
                try {
                    ...
                    const response = await fetch(`<?php echo e(route('admin.supply-chain.permintaan-barang.search.products')); ?>?${params}`);
        ...
        async searchMaterials(index, query) {
            ...
            this.searchTimeout = setTimeout(async () => {
                try {
                    ...
                    const response = await fetch(`<?php echo e(route('admin.supply-chain.permintaan-barang.search.materials')); ?>?${params}`);
                    const results = await response.json();
        ...
        async submitForm(status = 'draft') {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route('admin.supply-chain.permintaan-barang.store')); ?>', {
                    method: 'POST',
                    headers: {
...
</script><?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\supply-chain\permintaan-barang\modals\create.blade.php ENDPATH**/ ?>