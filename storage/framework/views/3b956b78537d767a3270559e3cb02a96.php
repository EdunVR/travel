...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Dashboard Finance']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Dashboard Finance')]); ?>
  <style>
  ...
  <div x-data="financeDashboard()" x-init="init()" class="space-y-6 overflow-x-hidden">
    ...
    <section class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-card">
        <div class="flex items-center justify-between mb-4">
          ...
          <a :href="`<?php echo e(route('finance.piutang.index')); ?>`" class="text-xs text-primary-600 hover:underline">
            Lihat Detail →
          </a>
        </div>
        <div class="space-y-2">
      ...
      <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-card">
        <div class="flex items-center justify-between mb-4">
          ...
          <a :href="`<?php echo e(route('finance.hutang.index')); ?>`" class="text-xs text-primary-600 hover:underline">
            Lihat Detail →
          </a>
        </div>
        <div class="space-y-2">
    ...
    <section class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-card">
        <div class="flex items-center justify-between mb-4">
          ...
          <a :href="`<?php echo e(route('finance.labarugi.index')); ?>`" class="text-xs text-primary-600 hover:underline">
            Lihat Detail →
          </a>
        </div>
        <div class="space-y-3">
      ...
      <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-card">
        <div class="flex items-center justify-between mb-4">
          ...
          <a :href="`<?php echo e(route('finance.cashflow.index')); ?>`" class="text-xs text-primary-600 hover:underline">
            Lihat Detail →
          </a>
        </div>
        <div class="space-y-3">
    ...
    <section class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-card">
        <div class="flex items-center justify-between mb-4">
          ...
          <a :href="`<?php echo e(route('finance.neraca.index')); ?>`" class="text-xs text-primary-600 hover:underline">
            Lihat Detail →
          </a>
        </div>
        <div class="space-y-3">
    ...
    <section class="rounded-2xl border border-slate-200 bg-white p-0 shadow-card">
      <div class="p-4 flex items-center justify-between border-b border-slate-200">
        ...
        <a :href="`<?php echo e(route('finance.jurnal.index')); ?>`" 
      ...
      return {
        ...
        async loadData(){
          ...
          try {
            ...
            const response = await fetch(`<?php echo e(route('finance.dashboard.data')); ?>?${params}`, {
              headers: {
        ...
        exportPdf(){
          ...
          window.open(`<?php echo e(route('finance.dashboard.export-pdf')); ?>?${params}`, '_blank');
        },
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\finance\index.blade.php ENDPATH**/ ?>