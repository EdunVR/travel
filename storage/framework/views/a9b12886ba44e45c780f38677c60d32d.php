...
<?php $__env->startSection('title', 'Peta Keseluruhan Prospek'); ?>
                ...
                <div class="card-header px-4 py-3" 
                    ...
                    <div class="card-header-container">
                        <div class="card-header-top">
                            <a href="<?php echo e(route('prospek.index')); ?>" class="btn btn-danger">
                                Kembali
                            </a>
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                        ...
                        <div class="legend d-flex flex-wrap justify-content-center">
                            <div class="legend-item prospek mr-3 mb-1 mb-md-0">
                                <span class="legend-icon" style="background-image: url('<?php echo e(asset('img/map_prospek.png')); ?>')"></span>
                                <span class="legend-text small">Prospek</span>
                            </div>
                            <div class="legend-item followup mr-3 mb-1 mb-md-0">
                                <span class="legend-icon" style="background-image: url('<?php echo e(asset('img/map_followup.png')); ?>')"></span>
                                <span class="legend-text small">Follow Up</span>
                            </div>
                            <div class="legend-item negosiasi mr-3 mb-1 mb-md-0">
                                <span class="legend-icon" style="background-image: url('<?php echo e(asset('img/map_negosiasi.png')); ?>')"></span>
                                <span class="legend-text small">Negosiasi</span>
                            </div>
                            <div class="legend-item deposit mr-3 mb-1 mb-md-0">
                                <span class="legend-icon" style="background-image: url('<?php echo e(asset('img/map_deposit.png')); ?>')"></span>
                                <span class="legend-text small">Deposit</span>
                            </div>
                            <div class="legend-item closing mr-3 mb-1 mb-md-0">
                                <span class="legend-icon" style="background-image: url('<?php echo e(asset('img/map_closing.png')); ?>')"></span>
                                <span class="legend-text small">Closing</span>
                            </div>
                            <div class="legend-item gagal">
                                <span class="legend-icon" style="background-image: url('<?php echo e(asset('img/map_gagal.png')); ?>')"></span>
...
<script>
    ...
    function initMap() {
        ...
        setTimeout(function() {
            var prospeks = <?php echo json_encode($prospeks, 15, 512) ?>;
    ...
    function saveSearchedLocation() {
        ...
        Swal.fire({
            ...
            preConfirm: (namaLokasi) => {
                return $.ajax({
                    url: '<?php echo e(route("prospek.searchAndSave")); ?>',
                    method: 'POST',
                    data: {
    ...
    function loadMapUmumMarkers() {
        $.get('<?php echo e(route("prospek.getLocations")); ?>', function(data) {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\crm\prospek\map.blade.php ENDPATH**/ ?>