<div class="modal fade" id="addAccountModal" tabindex="-1" role="dialog" aria-labelledby="addAccountModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('irp.investor.account.store', $investor->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="account_number">Nomor Rekening*</label>
                        <input type="text" class="form-control" id="account_number" name="account_number" 
                            value="GTS-<?php echo e(time()); ?>" readonly required>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\irp\investor\partials\account_modal.blade.php ENDPATH**/ ?>