    ...
    <div class="page-main">
        ...
        <div class="info-section">
            ...
            <table>
                ...
                ?>
                <?php if(!empty($familyMembersPreview) && is_array($familyMembersPreview)): ?>
                <tr>
                    <td colspan="4" style="padding-top: 5px; border-top: 1px solid #ddd;">
                        <strong>Anggota Keluarga:</strong>
                        <?php echo e(implode(', ', array_map(fn($fm) => ($fm['nama'] ?? '') . ($fm['hubungan'] ? ' (' . $fm['hubungan'] . ')' : ''), $familyMembersPreview))); ?>
            ...
            <table>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <?php if($booking->travelPackage->flightDeparture): ?>
                            ...
                            — <?php echo e($booking->travelPackage->flightDeparture->departure_airport ?? ''); ?> - <?php echo e($booking->travelPackage->flightDeparture->arrival_airport ?? ''); ?>
                    ...
                    <td colspan="2">
                        ...
                        <?php if($booking->travelPackage->flightReturn): ?>
                            ...
                            — <?php echo e($booking->travelPackage->flightReturn->departure_airport ?? ''); ?> - <?php echo e($booking->travelPackage->flightReturn->arrival_airport ?? ''); ?>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        ?>
                        <?php if($hotelMakkahPrev): ?>
                            <?php echo e($hotelMakkahPrev->hotel->hotel_name ?? '-'); ?>

                            <?php if($hotelMakkahPrev->room_type): ?> (<?php echo e(ucfirst($hotelMakkahPrev->room_type)); ?>)<?php endif; ?>
                            <?php if(!$hotelMakkahPrev->is_charged): ?> <small style="color:#28a745;">Include Paket</small><?php else: ?> <small style="color:#dc3545;">Charge</small><?php endif; ?>
                    ...
                    <td colspan="2">
                        ...
                        ?>
                        <?php if($hotelMadinahPrev): ?>
                            <?php echo e($hotelMadinahPrev->hotel->hotel_name ?? '-'); ?>

                            <?php if($hotelMadinahPrev->room_type): ?> (<?php echo e(ucfirst($hotelMadinahPrev->room_type)); ?>)<?php endif; ?>
                            <?php if(!$hotelMadinahPrev->is_charged): ?> <small style="color:#28a745;">Include Paket</small><?php else: ?> <small style="color:#dc3545;">Charge</small><?php endif; ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br><small style="color:#555;">Termasuk: <?php echo e($booking->jamaah->nama); ?><?php $__currentLoopData = $familyNormal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>, <?php echo e($fn['nama']); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></small>
                        <?php endif; ?>
                    </td>
                ...
                <tr>
                    <td class="text-center"><?php echo e($itemNo++); ?></td>
                    <td><strong>Perlengkapan Tambahan</strong><?php if($booking->equipment_notes): ?><br><small><?php echo e($booking->equipment_notes); ?></small><?php endif; ?></td>
                ...
                <tr>
                    <td class="text-center"><?php echo e($itemNo++); ?></td>
                    <td><strong>Upgrade</strong><?php if($booking->upgrade_notes): ?><br><small><?php echo e($booking->upgrade_notes); ?></small><?php endif; ?></td>
                    <td class="text-center">1</td>
                ...
                <?php if($booking->hotelBookings && $booking->hotelBookings->where('is_charged', true)->count() > 0): ?>
                <?php $__currentLoopData = $booking->hotelBookings->where('is_charged', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="text-center"><?php echo e($itemNo++); ?></td>
                    <td>
        ...
        <div class="info-section">
            ...
            <div style="font-size: 9px; line-height: 1.3; white-space: pre-wrap;"><?php echo e($termsConditions); ?></div>
        </div>
        <?php endif; ?>
                ...
                <tr>
                    ...
                    <td style="width: 33%; text-align: center;">
                        ...
                        <div class="signature-box" style="position: relative; display: inline-block;">
                            ...
                            <img src="<?php echo e(public_path(auth()->user()->signature_path)); ?>" 
                                 alt="Tanda Tangan" 
                        ...
                        <!-- ( <?php echo e($invoice->user->name ?? auth()->user()->name ?? 'System'); ?> ) -->
        ...
        <div class="footer">
            <p style="text-align: center; margin-top: 10px;">
                Preview Invoice - <?php echo e(now()->format('d F Y H:i:s')); ?>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\travel\payment\jamaah-invoice-preview-pdf.blade.php ENDPATH**/ ?>