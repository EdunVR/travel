...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Laporan Margin']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Laporan Margin')]); ?>
      ...
      return {
        ...
        async loadData() {
          ...
          try {
            ...
            const response = await fetch(`<?php echo e(route('admin.penjualan.margin.data')); ?>?${params}`, {
              headers: {
        ...
        exportPdf() {
          ...
          const url = `<?php echo e(route('admin.penjualan.margin.export-pdf')); ?>?${params}`;
          this.pdfUrl = url;
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\penjualan\margin\index.blade.php ENDPATH**/ ?>