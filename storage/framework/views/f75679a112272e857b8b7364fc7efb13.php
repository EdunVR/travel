...
<?php $__env->startSection('title', 'Daftar Investor'); ?>
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('irp.investor.create')); ?>" class="btn btn-sm btn-primary">
...
$(document).ready(function() {
    ...
    var table = $('#investors-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('irp.investor.index')); ?>",
            type: "GET"
        },
        columns: [
            {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\irp\investor\index.blade.php ENDPATH**/ ?>