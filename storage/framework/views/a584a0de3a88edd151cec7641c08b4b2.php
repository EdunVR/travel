    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl p-8 border border-green-100 shadow-sm">
            ...
            <div class="text-center mt-6 pt-6 border-t border-green-100">
                <a href="<?php echo e(url('/legalitas')); ?>" 
...
<section class="section-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-content relative">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="https://www.google.com/search?q=<?php echo e(urlencode($hotel['name'] . ' ' . $hotel['city'] . ' Saudi Arabia')); ?>" 
               ...
               class="block card-hover rounded-2xl overflow-hidden border border-green-100 shadow-sm group bg-white">
                ...
                <div class="p-4">
                    <h3 class="font-semibold text-gray-900 text-sm break-words"><?php echo e($hotel['name']); ?></h3>
        ...
        <div class="text-center mt-10">
            <a href="<?php echo e(url('/hotel-partner')); ?>" 
               class="inline-flex items-center gap-2 border-2 border-green-brand text-green-brand hover:bg-green-pale px-6 py-3 rounded-full text-sm font-semibold transition-all">
