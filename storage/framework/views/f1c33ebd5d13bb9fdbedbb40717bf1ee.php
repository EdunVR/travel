...
<?php $component->withAttributes([]); ?>
    <div class="p-6">
        ...
        function changeOutlet(outletId) {
            window.location.href = '<?php echo e(route("sdm.kontrak.index")); ?>?outlet_id=' + outletId;
        }
        </script>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-blue-600"><?php echo e($stats['total_kontrak_aktif']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-yellow-600"><?php echo e($stats['kontrak_akan_habis']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-red-600"><?php echo e($stats['total_sp_aktif']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600"><?php echo e($stats['total_dokumen']); ?></p>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <!-- Kontrak Kerja -->
            <a href="<?php echo e(route('sdm.kontrak.kontrak.index')); ?>" class="bg-white rounded-lg shadow hover:shadow-lg transition p-6 group">
            ...
            <a href="<?php echo e(route('sdm.kontrak.perpanjangan.index')); ?>" class="bg-white rounded-lg shadow hover:shadow-lg transition p-6 group">
                <div class="flex items-start justify-between mb-4">
            ...
            <a href="<?php echo e(route('sdm.kontrak.monitoring')); ?>" class="bg-white rounded-lg shadow hover:shadow-lg transition p-6 group">
                <div class="flex items-start justify-between mb-4">
            ...
            <!-- Surat Peringatan -->
            <a href="<?php echo e(route('sdm.kontrak.sp.index')); ?>" class="bg-white rounded-lg shadow hover:shadow-lg transition p-6 group">
                <div class="flex items-start justify-between mb-4">
            ...
            <!-- Dokumen HR -->
            <a href="<?php echo e(route('sdm.kontrak.dokumen.index')); ?>" class="bg-white rounded-lg shadow hover:shadow-lg transition p-6 group">
                <div class="flex items-start justify-between mb-4">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\sdm\kontrak\index.blade.php ENDPATH**/ ?>