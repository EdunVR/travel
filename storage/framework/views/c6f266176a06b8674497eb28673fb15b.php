...
<button type="submit" id="btnPesanKonfirmasi"
...
<i class="fab fa-whatsapp text-lg" id="btnPesanIcon"></i> <span id="btnPesanText">PESAN & KONFIRMASI</span>
</button>
</form>
...
function prepareFormSubmit(event) {
  ...
  var btnPesanIcon = document.getElementById('btnPesanIcon');
  var btnPesanText = document.getElementById('btnPesanText');
  if (btnPesan) {
    btnPesan.disabled = true;
    btnPesan.style.opacity = '0.6';
    btnPesan.style.cursor = 'not-allowed';
    if (btnPesanIcon) { btnPesanIcon.className = 'fas fa-spinner fa-spin text-lg'; }
    if (btnPesanText) { btnPesanText.textContent = 'MEMPROSES...'; }
  }
  ...
  .then(data => {
    if (data.success) {
      ...
      if (btnPesan) {
        ...
        btnPesan.style.cursor = 'pointer';
        if (btnPesanIcon) { btnPesanIcon.className = 'fab fa-whatsapp text-lg'; }
        if (btnPesanText) { btnPesanText.textContent = 'PESAN & KONFIRMASI'; }
      }
    }
  })
  .catch(error => {
