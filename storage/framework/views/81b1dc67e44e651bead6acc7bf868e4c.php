            ...
            return {
                ...
                async fetchData() {
                    ...
                    try {
                        ...
                        const response = await fetch(`<?php echo e(route('admin.service.ongkir.data')); ?>?${params}`);
                ...
                async openEdit(item) {
                    try {
                        const response = await fetch(`<?php echo e(route('admin.service.ongkir.index')); ?>/${item.id}`);
                        const data = await response.json();
                ...
                async submitForm() {
                    ...
                    try {
                        const url = this.form.id 
                            ? `<?php echo e(route('admin.service.ongkir.index')); ?>/${this.form.id}`
                            : '<?php echo e(route('admin.service.ongkir.store')); ?>';
                ...
                async deleteNow() {
                    ...
                    this.deleting = true;
                    try {
                        const response = await fetch(`<?php echo e(route('admin.service.ongkir.index')); ?>/${this.toDelete.id}`, {
                            method: 'DELETE',
                            headers: {
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                            }
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\service\ongkir\index-always-show.blade.php ENDPATH**/ ?>