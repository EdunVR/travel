...
<?php $component->withAttributes([]); ?>
    <div class="p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('sdm.kontrak.dokumen.create')); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
        ...
        <div class="bg-white rounded-lg shadow p-4 mb-6">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="jenis_dokumen" value="<?php echo e(request('jenis_dokumen')); ?>" class="w-full border-gray-300 rounded-lg" placeholder="Cari jenis...">
                </div>
                <div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $dokumen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($item->nomor_dokumen); ?></td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($item->tanggal_terbit->format('d/m/Y')); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php if($item->memiliki_masa_berlaku): ?>
                                    <?php echo e($item->tanggal_berlaku ? $item->tanggal_berlaku->format('d/m/Y') : '-'); ?> - 
                                    <?php echo e($item->tanggal_berakhir ? $item->tanggal_berakhir->format('d/m/Y') : '-'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <div class="flex gap-2 items-center">
                                    <!-- Print PDF Button -->
                                    <button onclick="openPrintModal(<?php echo e($item->id); ?>, '<?php echo e(addslashes($item->nomor_dokumen)); ?>')" 
                                    ...
                                    <?php endif; ?>
                                    <a href="<?php echo e(route('sdm.kontrak.dokumen.edit', $item->id)); ?>" class="text-yellow-600 hover:text-yellow-800" title="Edit"><i class="fas fa-edit"></i></a>
                                    <form action="<?php echo e(route('sdm.kontrak.dokumen.destroy', $item->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus?')">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="mt-4"><?php echo e($dokumen->links()); ?></div>
    </div>
    ...
    <script>
        function openPrintModal(dokumenId, nomorDokumen) {
            ...
            const pdfUrl = '<?php echo e(route("sdm.kontrak.dokumen.print", ":id")); ?>'.replace(':id', dokumenId);
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\sdm\kontrak\dokumen-index.blade.php ENDPATH**/ ?>