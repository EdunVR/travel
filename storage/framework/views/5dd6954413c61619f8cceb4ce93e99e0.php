...
<?php if (isset($component)) { $__componentOriginal779cfb57a4715917f75d0803dbe155a7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal779cfb57a4715917f75d0803dbe155a7 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin-with-tabs','data' => ['title' => 'Dashboard']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('layouts.admin-with-tabs'); ?>
...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Dashboard')]); ?>
    <div x-data="dashboardData(<?php echo e(json_encode($userOutlets->pluck('id_outlet')->toArray())); ?>, <?php echo e($defaultOutlet); ?>)" x-init="init()">
        ...
        <section class="mb-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="text-xs text-slate-500 bg-slate-100 px-3 py-1 rounded-full">
                    <?php echo e(count($availableModules)); ?> modules available
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <?php if($module['module'] === 'inventaris'): ?>
                <div @click="openModuleInTab('<?php echo e(route($module['route'])); ?>', '<?php echo e($module['name']); ?>', 'bx-package')" 
                    ...
                    <div class="relative z-10">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-white/80 group-hover:text-white/70 transition-colors">
                                Integrated <?php echo e(strtolower($module['name'])); ?> management
                            </p>
                        </div>
                ...
                <?php elseif($module['module'] === 'crm'): ?>
                <div @click="openModuleInTab('<?php echo e(route($module['route'])); ?>', '<?php echo e($module['name']); ?>', 'bx-group')" 
                ...
                <?php elseif($module['module'] === 'finance'): ?>
                <div @click="openModuleInTab('<?php echo e(route($module['route'])); ?>', '<?php echo e($module['name']); ?>', 'bx-wallet')" 
                ...
                <?php elseif($module['module'] === 'sales'): ?>
                <div @click="openModuleInTab('<?php echo e(route($module['route'])); ?>', '<?php echo e($module['name']); ?>', 'bx-receipt')" 
                ...
                <?php elseif($module['module'] === 'procurement'): ?>
                <div @click="openModuleInTab('<?php echo e(route($module['route'])); ?>', '<?php echo e($module['name']); ?>', 'bx-truck')" 
                ...
                <?php elseif($module['module'] === 'production'): ?>
                <div @click="openModuleInTab('<?php echo e(route($module['route'])); ?>', '<?php echo e($module['name']); ?>', 'bx-cog')" 
                ...
                <?php elseif($module['module'] === 'supply-chain'): ?>
                <div @click="openModuleInTab('<?php echo e(route($module['route'])); ?>', '<?php echo e($module['name']); ?>', 'bx-network-chart')" 
                ...
                <?php elseif($module['module'] === 'hrm'): ?>
                <div @click="openModuleInTab('<?php echo e(route($module['route'])); ?>', '<?php echo e($module['name']); ?>', 'bx-id-card')" 
                ...
                <?php elseif($module['module'] === 'service'): ?>
                <div @click="openModuleInTab('<?php echo e(route($module['route'])); ?>', '<?php echo e($module['name']); ?>', 'bx-wrench')" 
                ...
                <?php elseif($module['module'] === 'investor'): ?>
                <div @click="openModuleInTab('<?php echo e(route($module['route'])); ?>', '<?php echo e($module['name']); ?>', 'bx-dollar-circle')" 
        ...
        function dashboardData(availableOutlets, defaultOutlet) {
            return {
                ...
                async loadOverviewStats() {
                    try {
                        const response = await fetch('<?php echo e(route("admin.dashboard.overview")); ?>' + this.getOutletParams());
                ...
                async loadSalesTrend() {
                    try {
                        const response = await fetch('<?php echo e(route("admin.dashboard.sales-trend")); ?>' + this.getOutletParams());
                ...
                async loadInventoryStatus() {
                    try {
                        const response = await fetch('<?php echo e(route("admin.dashboard.inventory-status")); ?>' + this.getOutletParams());
                ...
                async loadProductionEfficiency() {
                    try {
                        const response = await fetch('<?php echo e(route("admin.dashboard.production-efficiency")); ?>' + this.getOutletParams());
                ...
                async loadEmployeePerformance() {
                    try {
                        const response = await fetch('<?php echo e(route("admin.dashboard.employee-performance")); ?>' + this.getOutletParams());
                ...
                async loadInsights() {
                    try {
                        const response = await fetch('<?php echo e(route("admin.dashboard.insights")); ?>' + this.getOutletParams());
...
<?php endif; ?>
<?php if (isset($__attributesOriginal779cfb57a4715917f75d0803dbe155a7)): ?>
<?php $attributes = $__attributesOriginal779cfb57a4715917f75d0803dbe155a7; ?>
<?php unset($__attributesOriginal779cfb57a4715917f75d0803dbe155a7); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal779cfb57a4715917f75d0803dbe155a7)): ?>
<?php $component = $__componentOriginal779cfb57a4715917f75d0803dbe155a7; ?>
<?php unset($__componentOriginal779cfb57a4715917f75d0803dbe155a7); ?>
<?php endif; ?><?php /**PATH C:\xampp\htdocs\hm\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>