...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Manajemen Pelanggan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Manajemen Pelanggan')]); ?>
  <div x-data="customerManagement()" x-init="init()" class="space-y-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'crm.pelanggan.create')): ?>
        ...
        <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'crm.pelanggan.import')): ?>
        ...
        <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'crm.pelanggan.export')): ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-card">
        <div class="flex items-center gap-3">
          ...
          <div>
            <div class="text-2xl font-bold text-green-600"><?php echo e($outlets->count()); ?></div>
      ...
      <template x-for="customer in customers" :key="customer.id_member">
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-card hover:shadow-lg transition-shadow">
          ...
          <div class="flex gap-2 pt-3 border-t border-slate-100">
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'crm.pelanggan.update')): ?>
            ...
            <?php endif; ?>
            <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'crm.pelanggan.delete')): ?>
  ...
  <script>
    function customerManagement() {
      return {
        ...
        selectedOutlets: [<?php echo e($outlets->first()->id_outlet ?? ''); ?>],
        ...
        loadTipes() {
          ...
          fetch(`<?php echo e(route('admin.crm.pelanggan.tipes-by-outlets')); ?>?${params}`)
            .then(res => res.json())
            .then(data => {
              if (data.success) {
        ...
        loadData() {
          ...
          fetch(`<?php echo e(route("admin.crm.pelanggan.data")); ?>?${params}`)
            .then(res => res.json())
            .then(data => {
              if (data.data) {
        ...
        loadStatistics() {
          ...
          fetch(`<?php echo e(route('admin.crm.pelanggan.statistics')); ?>?${params}`)
            .then(res => res.json())
            .then(data => {
              if (data.success) {
        ...
        async onModalOutletChange() {
          ...
          try {
            ...
            const response = await fetch(`<?php echo e(route('admin.crm.pelanggan.tipes-by-outlets')); ?>?${params}`);
        ...
        async loadCustomerData(id) {
          try {
            const response = await fetch(`<?php echo e(url('admin/crm/pelanggan')); ?>/${id}`);
            const data = await response.json();
            ...
            if (data.success) {
              ...
              this.formData = {
                ...
                pas_foto: null,
                pas_foto_preview: data.data.pas_foto ? `<?php echo e(url('storage')); ?>/${data.data.pas_foto}` : null,
                ktp_foto: null,
                ktp_foto_preview: data.data.ktp_foto ? `<?php echo e(url('storage')); ?>/${data.data.ktp_foto}` : null,
                ...
                passport_foto: null,
                passport_foto_preview: data.data.passport_foto ? `<?php echo e(url('storage')); ?>/${data.data.passport_foto}` : null,
                ...
                akta_lahir: null,
                akta_lahir_preview: data.data.akta_lahir_foto ? `<?php echo e(url('storage')); ?>/${data.data.akta_lahir_foto}` : null,
                akta_lahir_foto_path: data.data.akta_lahir_foto || null,
                kartu_keluarga: null,
                kartu_keluarga_preview: data.data.kartu_keluarga_foto ? `<?php echo e(url('storage')); ?>/${data.data.kartu_keluarga_foto}` : null,
                kartu_keluarga_foto_path: data.data.kartu_keluarga_foto || null,
                buku_nikah: null,
                buku_nikah_preview: data.data.buku_nikah_foto ? `<?php echo e(url('storage')); ?>/${data.data.buku_nikah_foto}` : null,
                buku_nikah_foto_path: data.data.buku_nikah_foto || null,
                vaksin: null,
                vaksin_preview: data.data.vaksin_foto ? `<?php echo e(url('storage')); ?>/${data.data.vaksin_foto}` : null,
                vaksin_foto_path: data.data.vaksin_foto || null,
                bpjs: null,
                bpjs_preview: data.data.bpjs_foto ? `<?php echo e(url('storage')); ?>/${data.data.bpjs_foto}` : null,
        ...
        submitForm() {
          ...
          const url = this.editMode 
            ? `<?php echo e(url('admin/crm/pelanggan')); ?>/${this.editId}`
            : '<?php echo e(route("admin.crm.pelanggan.store")); ?>';
        ...
        async processKtpOcr(file) {
          ...
          try {
            const response = await fetch('<?php echo e(route("admin.crm.pelanggan.ocr.ktp")); ?>', {
              method: 'POST',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
              },
        ...
        async processPassportOcr(file) {
          ...
          try {
            const response = await fetch('<?php echo e(route("admin.crm.pelanggan.ocr.passport")); ?>', {
              method: 'POST',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
              },
        ...
        async processVisaOcr(file) {
          ...
          try {
            const response = await fetch('<?php echo e(route("admin.crm.pelanggan.ocr.visa")); ?>', {
              method: 'POST',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
              },
        ...
        async processSertifikatKesehatanOcr(file) {
          ...
          try {
            const response = await fetch('<?php echo e(route("admin.crm.pelanggan.ocr.sertifikat-kesehatan")); ?>', {
              method: 'POST',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
              },
        ...
        viewCustomer(id) {
          fetch(`<?php echo e(url('admin/crm/pelanggan')); ?>/${id}`)
            .then(res => res.json())
            .then(data => {
              if (data.success) {
        ...
        async uploadAdminDocument(docType, file) {
          ...
          try {
            const res = await fetch(`<?php echo e(url('admin/crm/pelanggan')); ?>/${this.editId}/upload-doc`, {
              method: 'POST',
        ...
        async deleteAdminDocument(docType) {
          ...
          try {
            const res = await fetch(`<?php echo e(url('admin/crm/pelanggan')); ?>/${this.editId}/delete-doc`, {
              method: 'DELETE',
              headers: {
        ...
        exportExcel() {
          ...
          window.location.href = `<?php echo e(route('admin.crm.pelanggan.export.excel')); ?>?${params}`;
        },
        ...
        exportPdf() {
          ...
          window.location.href = `<?php echo e(route('admin.crm.pelanggan.export.pdf')); ?>?${params}`;
        },
        ...
        importExcel(event) {
          ...
          fetch('<?php echo e(route("admin.crm.pelanggan.import.excel")); ?>', {
            method: 'POST',
            headers: {
              'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            },
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views/admin/crm/pelanggan/index.blade.php ENDPATH**/ ?>