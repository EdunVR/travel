...
<body>
        ...
        <table>
            <tr>
                ...
                <td style="width: 60%; text-align: center;">
                    <span style="font-size: 16px; font-weight: bold;">TELP: <?php echo e(strtoupper($setting->telepon)); ?></span><br>
                    <span><?php echo e(session('isBon') === 'true' ? 'BON PENJUALAN' : 'NOTA PEMBELIAN'); ?></span>
                </td>
                <!-- Kolom Kanan: Barcode -->
            ...
            <tr>
                ...
                <td style="width: 50%;">
                    <table class="date-trxid">
                        <tr>
                            <td>Tanggal</td>
                            <td>: <?php echo e(tanggal_indonesia($penjualan->created_at)); ?></td>
                        </tr>
                        <tr>
                            <td>Nama Customer</td>
                ...
                <td style="width: 50%;">
                    <table class="date-trxid">
                        <tr>
                            <td>TrxID</td>
                            <td>: TRX00<?php echo e($penjualan->id_penjualan); ?></td>
                        </tr>
                        <tr>
                            <td>Operator</td>
                        ...
                        <tr>
                            <td>Keterangan</td>
                            <td>: <?php echo e(session('isBon') === 'true' ? 'BON' : 'LUNAS'); ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
    ...
    <div class="total-section">
        <table>
            ...
            <?php endif; ?>
            <?php if(session('isCheckedIngatkan') === 'true'): ?>
            <tr>
                <td colspan="5" class="text-center"><b>Catatan Hutang : <?php echo e(format_uang(session('piutang'))); ?></b></td>
            </tr>
            <?php endif; ?>
        </table>
    </div>
    ...
    <div class="footer">
        <table>
            <tr>
                ...
                <td style="width: 33%;">
                    <b>Tanda Terima</b><br>
                    ( <?php echo e($penjualan->member->nama ?? 'Customer Umum'); ?> )
                </td>
                <!-- Kolom Tengah: Pesan -->
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\penjualan\nota_besar.blade.php ENDPATH**/ ?>