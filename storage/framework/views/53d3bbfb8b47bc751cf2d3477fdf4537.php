...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Rekonsiliasi Bank']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Rekonsiliasi Bank')]); ?>
  <div x-data="bankReconciliationManagement()" x-init="init()" class="space-y-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="flex flex-wrap gap-2">
        <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'finance.rekonsiliasi.create')): ?>
              ...
              <tr class="hover:bg-slate-50 transition-colors">
                ...
                <td class="px-4 py-3 text-center">
                  <div class="flex items-center justify-center gap-2">
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'finance.rekonsiliasi.edit')): ?>
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'finance.rekonsiliasi.delete')): ?>
    ...
    function bankReconciliationManagement() {
      return {
        routes: {
          ...
          reconciliationData: '<?php echo e(route("finance.rekonsiliasi.data")); ?>',
          reconciliationStore: '<?php echo e(route("finance.rekonsiliasi.store")); ?>',
          reconciliationUpdate: '<?php echo e(route("finance.rekonsiliasi.update", ":id")); ?>',
          reconciliationShow: '<?php echo e(route("finance.rekonsiliasi.show", ":id")); ?>',
          reconciliationComplete: '<?php echo e(route("finance.rekonsiliasi.complete", ":id")); ?>',
          reconciliationApprove: '<?php echo e(route("finance.rekonsiliasi.approve", ":id")); ?>',
          reconciliationDelete: '<?php echo e(route("finance.rekonsiliasi.destroy", ":id")); ?>',
          reconciliationExportPdf: '<?php echo e(route("finance.rekonsiliasi.export-pdf", ":id")); ?>',
          bankAccountsData: '<?php echo e(route("finance.rekonsiliasi.bank-accounts")); ?>',
          statisticsData: '<?php echo e(route("finance.rekonsiliasi.statistics")); ?>',
          unreconciledTransactions: '<?php echo e(route("finance.rekonsiliasi.unreconciled-transactions")); ?>'
        },
        filters: {
          outlet_id: '',
          status: 'all',
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\finance\rekonsiliasi\index.blade.php ENDPATH**/ ?>