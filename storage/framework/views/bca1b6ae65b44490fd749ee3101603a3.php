...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Travel / Customer Communication']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Travel / Customer Communication')]); ?>
      ...
      <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div>
            ...
            <?php endif; ?>
            <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'travel.communication.create')): ?>
  ...
  <script>
    $(document).ready(function() {
      ...
      const table = $('#communications-table').DataTable({
        ...
        serverSide: true,
        ajax: {
          url: '<?php echo e(route("travel.communication.data")); ?>',
          data: function(d) {
      ...
      $('#communication-form').on('submit', function(e) {
        ...
        const url = id ? `/travel/communication/${id}` : '<?php echo e(route("travel.communication.store")); ?>';
      ...
      $('#btn-view-followups').on('click', function() {
        $.get('<?php echo e(route("travel.communication.pending-followups")); ?>', function(response) {
          if (response.success) {
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\travel\communication\index.blade.php ENDPATH**/ ?>