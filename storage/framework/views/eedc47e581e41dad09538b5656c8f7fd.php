...
<?php $__env->startSection('title'); ?>
    Input Laporan Manual - <?php echo e($agen->nama); ?>
    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Input Laporan Penjualan Manual - <?php echo e($agen->nama); ?></h3>
                <a href="<?php echo e(route('agen_laporan.index', $agen->id_member)); ?>" class="btn btn-default btn-xs">
            ...
            <div class="box-body">
                <form id="form-laporan">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="id_gerobak" id="id_gerobak" class="form-control" required>
                                    ...
                                    <?php $__currentLoopData = $gerobaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gerobak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($gerobak->id_gerobak); ?>"><?php echo e($gerobak->nama_gerobak); ?></option>
                    ...
                    <div class="form-group" style="margin-top: 20px;">
                        ...
                        <a href="<?php echo e(route('agen_laporan.index', $agen->id_member)); ?>" class="btn btn-default">Batal</a>
                    </div>
                </form>
            </div>
        </div>
...
function loadProdukByGerobak(gerobakId) {
    $.get('<?php echo e(url("agen_laporan/get-produk")); ?>/' + gerobakId)
...
$('#form-laporan').on('submit', function(e) {
    ...
    $.ajax({
        url: '<?php echo e(route("agen_laporan.store", $agen->id_member)); ?>',
        type: 'POST',
        data: $(this).serialize(),
        success: function(response) {
            if (response.success) {
                alert(response.message);
                window.location.href = '<?php echo e(route("agen_laporan.index", $agen->id_member)); ?>';
            } else {
                alert(response.message);
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\agen_laporan\create.blade.php ENDPATH**/ ?>