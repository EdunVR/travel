...
<aside class="main-sidebar">
    ...
    <div class="user-panel">
        <div class="image">
            <img src="<?php echo e(url($setting->path_logo) ?? Auth::user()->foto); ?>" alt="User Image">
        </div>
        <div class="infox">
    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if(in_array('Dashboard', Auth::user()->akses ?? [])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>" onclick="window.location.href='<?php echo e(route('dashboard')); ?>'">
        ...
        <?php if(hasAnyAccess(['Outlet', 'Kategori', 'Satuan', 'Produk', 'Bahan', 'Inventori', 'Gudang'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('inventory*') ? 'active' : ''); ?>" onclick="handleMenuClick('inventory')">
            <div class="icon-container">
        ...
        <?php if(hasAnyAccess(['Investor', 'Profit Management', 'Withdrawal Management'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('irp*') ? 'active' : ''); ?>" onclick="handleMenuClick('irp')">
            <div class="icon-container">
        ...
        <?php if(hasAnyAccess(['Customer', 'Prospek', 'Tipe'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('customer-service*') ? 'active' : ''); ?>" onclick="handleMenuClick('customer-service')">
            <div class="icon-container">
                <i data-feather="user-check"></i>
            </div>
        ...
        <!-- Card untuk POS -->
        <?php if(hasAnyAccess(['Transaksi', 'Kontra Bon'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('pos*') ? 'active' : ''); ?>" onclick="handleMenuClick('pos')">
            <div class="icon-container">
        ...
        <?php if(hasAnyAccess(['Pengeluaran', 'Pembelian', 'Penjualan', 'Hutang', 'Piutang', 'RAB', 'Akun dan Buku', 'Jurnal', 'Aktiva Tetap', 'Buku Besar', 'Neraca Lajur', 'Laba Rugi', 'Perubahan Modal', 'Neraca', 'Arus Kas', 'SPT Tahunan', 'Pelaporan Keuangan'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('finance*') ? 'active' : ''); ?>" onclick="handleMenuClick('finance')">
            <div class="icon-container">
        ...
        <?php if(hasAnyAccess(['User', 'Pengaturan', 'Rekrutmen', 'Payroll', 'Kinerja', 'Pelatihan', 'Absensi'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('hrm*') ? 'active' : ''); ?>" onclick="handleMenuClick('hrm')">
            <div class="icon-container">
        ...
        <?php if(hasAnyAccess(['Penjualan', 'Laporan Penjualan', 'Agen', 'Halaman Agen', 'Invoice Penjualan'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('sales*') ? 'active' : ''); ?>" onclick="handleMenuClick('sales')">
            <div class="icon-container">
        ...
        <?php if(hasAnyAccess(['Pembelian', 'Supplier'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('procurement*') ? 'active' : ''); ?>" onclick="handleMenuClick('procurement')">
            <div class="icon-container">
        ...
        <?php if(hasAnyAccess(['Produksi'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('production*') ? 'active' : ''); ?>" onclick="handleMenuClick('production')">
            <div class="icon-container">
        ...
        <?php if(hasAnyAccess(['Gudang']) || hasPermission('supply-chain.permintaan-barang.view')): ?>
        <div class="menu-card <?php echo e(request()->routeIs('supply-chain*') ? 'active' : ''); ?>" onclick="handleMenuClick('supply-chain')">
            <div class="icon-container">
        ...
        <?php if(hasAnyAccess(['Ongkir Service', 'Mesin Customer', 'Invoice Service', 'History Service'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('services*') ? 'active' : ''); ?>" onclick="handleMenuClick('services')">
            <div class="icon-container">
        ...
        <?php if(hasAnyAccess(['Project Management'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('project-management*') ? 'active' : ''); ?>" onclick="handleMenuClick('project-management')">
            <div class="icon-container">
        ...
        <?php if(hasAnyAccess(['Flight', 'Hotel', 'Travel Package', 'Keberangkatan', 'Task Management'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('travel*') || request()->routeIs('admin.inventaris.flight.*') || request()->routeIs('admin.inventaris.hotel.*') ? 'active' : ''); ?>" onclick="handleMenuClick('travel')">
            <div class="icon-container">
        ...
        <?php if(hasAnyAccess(['Laporan', 'Laporan Penjualan'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('analytics*') ? 'active' : ''); ?>" onclick="handleMenuClick('analytics')">
            <div class="icon-container">
        ...
        <?php if(hasAnyAccess(['User', 'Pengaturan'])): ?>
        <div class="menu-card <?php echo e(request()->routeIs('system*') ? 'active' : ''); ?>" onclick="handleMenuClick('system')">
            <div class="icon-container">
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\sidebar.blade.php ENDPATH**/ ?>