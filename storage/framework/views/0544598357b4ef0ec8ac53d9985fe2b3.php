    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-green-600 to-emerald-600 text-white p-8 text-center">
                ...
                ?>
                <?php if($logoExists): ?>
                    <img src="<?php echo e(asset('images/hm-tour-logo.png')); ?>" alt="HM Tour" class="h-20 mx-auto mb-4 brightness-0 invert">
                <?php else: ?>
            ...
            <div class="p-8">
                ...
                <div class="flex justify-between items-start mb-6 pb-6 border-b-2 border-gray-200">
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900"><?php echo e($receiptNumber); ?></p>
                    </div>
                    <div class="text-right">
                        <p class="text-sm text-gray-500">Tanggal</p>
                        <p class="text-lg font-bold text-gray-900"><?php echo e(now()->format('d F Y')); ?></p>
                    </div>
                </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        <table class="w-full text-sm">
                            <tr>
                                ...
                                <td class="py-2 font-medium text-gray-900">: <?php echo e($affiliator->full_name); ?></td>
                            </tr>
                            <tr>
                                <td class="py-2 text-gray-600">Username</td>
                                <td class="py-2 font-medium text-gray-900">: <?php echo e($affiliator->username); ?></td>
                            </tr>
                            <tr>
                                <td class="py-2 text-gray-600">No. HP</td>
                                <td class="py-2 font-medium text-gray-900">: <?php echo e($affiliator->phone_number); ?></td>
                            </tr>
                            <tr>
                                <td class="py-2 text-gray-600">Email</td>
                                <td class="py-2 font-medium text-gray-900">: <?php echo e($affiliator->email); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        <table class="w-full text-sm">
                            <tr>
                                ...
                                <td class="py-2 font-medium text-gray-900">: <?php echo e($program->name); ?></td>
                            </tr>
                            <tr>
                                <td class="py-2 text-gray-600">Deskripsi</td>
                                <td class="py-2 text-gray-900">: <?php echo e($program->description); ?></td>
                            </tr>
                            <tr>
                                <td class="py-2 text-gray-600">Target</td>
                                <td class="py-2 text-gray-900">: <?php echo e($program->target_audience); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-lg p-6 mb-6">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-4xl font-bold text-green-600"><?php echo e($program->formatted_fee); ?></p>
                            <p class="text-xs text-gray-500 mt-2 italic"><?php echo e($amountInWords); ?></p>
                        </div>
                        <div class="text-right">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <p class="text-lg font-bold text-blue-900">Rp <?php echo e(number_format($affiliator->ppc_commission, 0, ',', '.')); ?></p>
                        </div>
                        <div>
                            <p class="text-blue-600">Komisi Minimal (Per Penjualan)</p>
                            <p class="text-lg font-bold text-blue-900">Rp <?php echo e(number_format($affiliator->min_sale_commission, 0, ',', '.')); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4 mb-6">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="text" readonly value="<?php echo e($affiliator->referral_link); ?>" id="referralLink"
                ...
                <div class="text-center text-sm text-gray-500 pt-6 border-t border-gray-200">
                    ...
                    <p class="mt-1">Untuk informasi lebih lanjut, hubungi: <strong><?php echo e(env('COMPANY_PHONE', '08976688800')); ?></strong></p>
                </div>
        ...
        <div class="max-w-3xl mx-auto mt-6 flex gap-4 justify-center no-print">
            ...
            <a href="<?php echo e(route('affiliate.login')); ?>" class="px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition">
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\affiliate\receipt.blade.php ENDPATH**/ ?>