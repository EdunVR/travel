    ...
    <div x-data="historyData()" x-init="init()" class="space-y-4">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <?php if(auth()->check()): ?> 
                <a href="<?php echo e(route('admin.service.invoice.index')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-primary-600 text-white px-4 py-2 hover:bg-primary-700">
    ...
    <script>
        function historyData() {
            return {
                ...
                outletFilter: <?php echo e($selectedOutlet); ?>,
                startDate: '',
                endDate: '',
                ...
                async loadStatusCounts() {
                    try {
                        const response = await fetch(`<?php echo e(route('admin.service.status-counts')); ?>?outlet_id=${this.outletFilter}`);
                ...
                changeOutlet() {
                    window.location.href = `<?php echo e(route('admin.service.history.index')); ?>?outlet_id=${this.outletFilter}&status=${this.currentStatus}`;
                },
                ...
                async checkDueSoonInvoices() {
                    try {
                        const response = await fetch(`<?php echo e(url('/admin/service/invoice/due-soon')); ?>?outlet_id=${this.outletFilter}`);
                        const result = await response.json();
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\service\history\index-always-show.blade.php ENDPATH**/ ?>