...
<?php $__env->startSection('title'); ?>
    Laporan Penjualan - <?php echo e($agen->nama); ?>
    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Laporan Penjualan - <?php echo e($agen->nama); ?></h3>
                <div class="btn-group">
                    <button onclick="tambahLaporan()" class="btn btn-success btn-xs btn-flat">
                        <i class="fa fa-plus"></i> Input Laporan Manual
                    </button>
                    <a href="<?php echo e(route('agen_gerobak.index')); ?>" class="btn btn-default btn-xs btn-flat">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" id="start_date" class="form-control" value="<?php echo e(date('Y-m-01')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="end_date">Sampai Tanggal</label>
                            <input type="date" id="end_date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
...
function filterLaporan() {
    ...
    tableLaporan.ajax.url('<?php echo e(route("agen_laporan.data", $agen->id_member)); ?>?start_date=' + startDate + '&end_date=' + endDate).load();
}
...
function tambahLaporan() {
    window.location.href = '<?php echo e(route("agen_laporan.create", $agen->id_member)); ?>';
}
...
$(function () {
    tableLaporan = $('.table-laporan').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo e(route("agen_laporan.data", $agen->id_member)); ?>',
            data: function (d) {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\agen_laporan\index.blade.php ENDPATH**/ ?>