<div class="row mt-3">
    <div class="col-md-12">
        <form id="identitasForm" action="<?php echo e(route('jemaah.updateIdentitas', $member->id_member)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="image-upload-container">
                            <img src="<?php echo e($member->jemaahData->first()?->ktp_path ? asset('storage/'.$member->jemaahData->first()->ktp_path) : asset('img/placeholder-ktp.jpg')); ?>" 
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="image-upload-container">
                            <img src="<?php echo e(asset('img/placeholder-passport.jpg')); ?>" class="img-thumbnail img-preview" id="passport-preview" style="width: 100%; height: 200px; object-fit: cover;">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="image-upload-container">
                            <img src="<?php echo e(asset('img/placeholder-visa.jpg')); ?>" class="img-thumbnail img-preview" id="visa-preview" style="width: 100%; height: 200px; object-fit: cover;">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="image-upload-container">
                            <img src="<?php echo e(asset('img/placeholder-photo.jpg')); ?>" class="img-thumbnail img-preview" id="photo-preview" style="width: 100%; height: 200px; object-fit: cover;">
            ...
            <div class="row mt-3">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_lengkap" value="<?php echo e($member->jemaahData->first()?->nama_lengkap ?? $member->nama); ?>">
                    </div>
                    
                    <div class="form-group">
                        <label>Jenis Kelamin</label>
                        <select class="form-control" name="jenis_kelamin">
                            <option value="L" <?php echo e(($member->jemaahData->first()?->jenis_kelamin ?? '') == 'L' ? 'selected' : ''); ?>>Laki-laki</option>
                            <option value="P" <?php echo e(($member->jemaahData->first()?->jenis_kelamin ?? '') == 'P' ? 'selected' : ''); ?>>Perempuan</option>
                        </select>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tempat_lahir" value="<?php echo e($member->jemaahData->first()?->tempat_lahir ?? ''); ?>">
                    </div>
                    
                    <div class="form-group">
                        <label>Tanggal Lahir</label>
                        <input type="date" class="form-control" name="tanggal_lahir" value="<?php echo e($member->jemaahData->first()?->tanggal_lahir ?? ''); ?>">
                    </div>
                    
                    <div class="form-group">
                        <label>No. KTP</label>
                        <input type="text" class="form-control" name="no_ktp" value="<?php echo e($member->jemaahData->first()?->no_ktp ?? ''); ?>">
                    </div>
                    
                    <div class="form-group">
                        <label>No. Telepon</label>
                        <input type="text" class="form-control" name="no_telepon" value="<?php echo e($member->telepon); ?>">
                    </div>
                </div>
            </div>
...
$(function() {
    ...
    $('#ktp-input').change(function(e) {
        if (e.target.files.length > 0) {
            ...
            $.ajax({
                url: '<?php echo e(route("jemaah.processKtp")); ?>',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\jemaah\tabs\identitas.blade.php ENDPATH**/ ?>