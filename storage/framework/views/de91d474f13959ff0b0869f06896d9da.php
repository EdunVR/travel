                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select name="id_ongkir" id="id_ongkir" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $ongkosKirim; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ongkir): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($ongkir->id_ongkir); ?>"><?php echo e($ongkir->daerah); ?> - <?php echo e(number_format($ongkir->harga, 0, ',', '.')); ?></option>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-8 col-lg-offset-3">
                            ...
                            <?php if(isset($selectedProdukIds) && is_array($selectedProdukIds)): ?>
                                <?php $__currentLoopData = $selectedProdukIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produkId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <input type="hidden" name="produk[]" value="<?php echo e($produkId); ?>">
                                    <input type="hidden" name="biaya_service_produk[]" value="<?php echo e($selectedProdukBiaya[$produkId] ?? 0); ?>">
                                    <input type="hidden" name="closing_type_produk[]" value="<?php echo e($selectedProdukClosingTypes[$produkId] ?? 'jual_putus'); ?>">
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\service_management\mesin_customer\form.blade.php ENDPATH**/ ?>