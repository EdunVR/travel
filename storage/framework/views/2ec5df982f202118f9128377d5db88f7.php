...
>
    ...
    <template x-for="(message, index) in messages" :key="message.id">
        <div>
            ...
            <?php echo $__env->make('components.chat-message-bubble', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </template>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\components\chat-panel-messages.blade.php ENDPATH**/ ?>