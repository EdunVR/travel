...
<div 
    x-data="{
        ...
        async loadUnreadCount() {
            try {
                const url = window.chatConfig?.routes?.unreadCount || '<?php echo e(route('admin.chat.unread-count')); ?>';
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views/components/chat-button.blade.php ENDPATH**/ ?>