...
<?php $__env->startSection('title', 'Manajemen Prospek & Lead'); ?>
        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="<?php echo e(route('prospek.create')); ?>" class="btn btn-sm btn-primary">
                            <i data-feather="plus"></i> Tambah Prospek
                        </a>
                        <div class="btn-group" role="group">
                            <a href="<?php echo e(route('prospek.export-template')); ?>" class="btn btn-sm btn-success mr-2">
                                Download Template
                            </a>
                        ...
                        <a href="<?php echo e(route('prospek.map')); ?>" class="btn btn-sm btn-info mr-2">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="enhancedTable" width="100%" cellspacing="0">
                            ...
                            ?>
                            <?php $__currentLoopData = $prospeks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prospek): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(tanggal_indonesia($prospek->tanggal)); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge <?php echo e($badgeClass); ?>">
                                            <?php echo e(App\Models\Prospek::STATUSES[$prospek->current_status] ?? $prospek->current_status); ?>

                                        </span>
                                        <br>
                                        <button class="btn btn-sm btn-outline-primary mt-1 btn-timeline" 
                                                data-id="<?php echo e($prospek->id_prospek); ?>"
                                                data-toggle="modal" 
                                    ...
                                    <td>
                                        <?php if($prospek->latitude && $prospek->longitude): ?>
                                            <a href="#" class="btn-map btn btn-sm btn-info" data-lat="<?php echo e($prospek->latitude); ?>" data-lng="<?php echo e($prospek->longitude); ?>">
                                    ...
                                    <td><?php echo e($prospek->nama); ?></td>
                                    <td><?php echo e($prospek->nama_perusahaan); ?></td>
                                    <td><?php echo e($prospek->telepon); ?></td>
                                    <td><?php echo e($prospek->jenis ?? '-'); ?></td>
                                    <td><?php echo e(Str::limit($prospek->alamat, 30)); ?></td>
                                    <td><?php echo e($prospek->kapasitas_produksi ?? '-'); ?></td>
                                    <td><?php echo e($prospek->sistem_produksi ?? '-'); ?></td>
                                    <td><?php echo e($prospek->bahan_bakar ?? '-'); ?></td>
                                    <td>
                                    <?php if($prospek->informasi_perusahaan): ?>
                                        <div class="short-info">
                                            <?php echo e(Str::limit($prospek->informasi_perusahaan, 50)); ?>

                                            <?php if(strlen($prospek->informasi_perusahaan) > 50): ?>
                                                <span class="toggle-info">Selengkapnya</span>
                                            <?php endif; ?>
                                        </div>
                                        <div class="full-info">
                                            <?php echo e($prospek->informasi_perusahaan); ?>
                                    ...
                                    <td>
                                        <span class="badge badge-<?php echo e($prospek->menggunakan_boiler ? 'success' : 'danger'); ?>">
                                            <?php echo e($prospek->menggunakan_boiler ? 'Ya' : 'Tidak'); ?>

                                        </span>
                                    </td>
                                    <td><?php echo e($prospek->recruitment->name ?? '-'); ?></td>
                                    <td>
                                        <div class="d-flex">
                                            <a href="<?php echo e(route('prospek.edit', $prospek->id_prospek)); ?>" class="btn btn-sm btn-warning mr-2" title="Edit">
                                                <i data-feather="edit"></i>
                                            </a>
                                            <form action="<?php echo e(route('prospek.destroy', $prospek->id_prospek)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('prospek.import')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">
                            Format file harus sesuai dengan template. <a href="<?php echo e(route('prospek.export-template')); ?>">Download template</a>
                        </small>
                    </div>
                </div>
                <div class="modal-footer">
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\crm\prospek\index.blade.php ENDPATH**/ ?>