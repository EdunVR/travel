...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Travel / Maskapai']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Travel / Maskapai')]); ?>
  ...
  function airlineCrud() {
    return {
      ...
      async fetchData() {
        this.loading = true;
        try {
          const res = await fetch(`<?php echo e(route('admin.inventaris.airline.data')); ?>?search=${encodeURIComponent(this.search)}`);
      ...
      async submitForm() {
        ...
        try {
          const url = this.form.id
            ? `<?php echo e(url('admin/inventaris/airline')); ?>/${this.form.id}`
            : `<?php echo e(route('admin.inventaris.airline.store')); ?>`;
      ...
      async deleteNow() {
        this.deleting = true;
        try {
          await fetch(`<?php echo e(url('admin/inventaris/airline')); ?>/${this.toDelete.id}`, {
            method: 'DELETE',
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views/admin/inventaris/airline/index.blade.php ENDPATH**/ ?>