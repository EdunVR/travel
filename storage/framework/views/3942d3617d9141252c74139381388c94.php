    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <?php endif; ?>
                <button onclick="addForm('<?php echo e(route('tipe.store')); ?>')"
            ...
            <div class="box-body table-responsive">
                <table class="table table-stiped table-bordered">
                    ...
                    <!-- <tbody>
                        <?php $__currentLoopData = $tipe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($index + 1); ?></td>
                                <td><?php echo e($item->nama_tipe); ?></td>
                                <td>
                                    <ul>
                                        <?php $__currentLoopData = $item->produkTipe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produkTipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><?php echo e($produkTipe->produk->nama_produk); ?> - <?php echo e($produkTipe->diskon); ?>%</li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </td>
                                <td>
                                    <div class="btn-group">
                                        <button onclick="editForm('<?php echo e(route('tipe.update', $item->id_tipe)); ?>')" class="btn btn-xs btn-info btn-flat"><i class="fa fa-pencil"></i></button>
                                        <button onclick="deleteData('<?php echo e(route('tipe.destroy', $item->id_tipe)); ?>')" class="btn btn-xs btn-danger btn-flat"><i class="fa fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php if ($__env->exists('tipe.form')) echo $__env->make('tipe.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php $__env->stopSection(); ?>

    <script>
        console.log('Route URL:', '<?php echo e(route('tipe.data')); ?>');
    </script>
        ...
        <script>
            ...
            $(function () {
                table = $('.table').DataTable({
                    ...
                    autoWidth: false,
                    ajax: {
                        url: '<?php echo e(route('tipe.data')); ?>',
                        data: function (d) {
                ...
                document.getElementById('add-produk').addEventListener('click', function() {
                    const userOutlets = <?php echo json_encode($userOutlets ?? [], 15, 512) ?>;
                    let idOutlet;
            ...
            function addProdukRow(id_outlet = null, produkId = '', diskon = '', hargaJual = '') {
                ...
                <?php $__currentLoopData = $produk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    if ('<?php echo e($item->id_outlet); ?>' == id_outlet) {
                        options += `<option value="<?php echo e($item->id_produk); ?>" ${produkId == '<?php echo e($item->id_produk); ?>' ? 'selected' : ''}>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\tipe\index.blade.php ENDPATH**/ ?>