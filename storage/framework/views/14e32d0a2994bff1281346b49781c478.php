...
<div class="container-fluid">
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('financial.annual-tax-report.store')); ?>" method="POST" enctype="multipart/form-data" id="sptForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="text-center">
                    <a href="<?php echo e(route('financial.annual-tax-report.index')); ?>" class="btn btn-secondary mr-2">
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\financial\annual-tax-report\create.blade.php ENDPATH**/ ?>