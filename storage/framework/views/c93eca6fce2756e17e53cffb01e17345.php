    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div style="margin-bottom: 10px;">
                <img src="<?php echo e($companySettings['logo_url']); ?>" alt="Company Logo" style="width: 50px; height: auto;">
            </div>
            <?php endif; ?>
            <div style="margin-bottom: 10px;">
                <strong><?php echo e($companySettings['company_name'] ?? 'Nama Perusahaan'); ?></strong>
                <?php if($companySettings['company_address']): ?>
                <br><small><?php echo e($companySettings['company_address']); ?></small>
                <?php endif; ?>
            ...
            <h1><?php echo e($documentTitle); ?></h1>
            <div class="document-info">
                <div class="document-number"><?php echo e($printNumber); ?></div>
                <div class="status-badge"><?php echo e(strtoupper($purchaseOrder->status)); ?></div>
            </div>
        </div>
        ...
        <div class="info-card">
            <h3>Keterangan</h3>
            <div><?php echo e($purchaseOrder->keterangan); ?></div>
        </div>
        <?php endif; ?>

        <!-- Footer -->
        <div class="footer">
            <p>Dokumen ini adalah draft dan belum final. Dicetak pada: <?php echo e(date('d/m/Y H:i:s')); ?></p>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\pembelian\purchase-order\print-draft.blade.php ENDPATH**/ ?>