...
<body>
    ...
    <?php if($penjualan->count() > 0): ?>
        ...
        <?php $__currentLoopData = $penjualan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($current_page_height > $max_page_height && $index > 0): ?>
                </div><div class="page-container">
                <?php $current_page_height = $transaction_height; ?>
            ...
            <div class="penjualan-item">
                <div class="penjualan-header">
                    <table style="border: none;">
                        <tr>
                            ...
                            <td style="border: none; width: 35%;">#<?php echo e($item->id_penjualan); ?></td>
                            <td style="border: none; width: 15%;"><strong>Tanggal:</strong></td>
                            <td style="border: none; width: 35%;"><?php echo e(\Carbon\Carbon::parse($item->created_at)->format('d/m/Y H:i')); ?></td>
                        </tr>
                        <tr>
                            <td style="border: none;"><strong>Outlet:</strong></td>
                            <td style="border: none;"><?php echo e($item->outlet->nama_outlet ?? '-'); ?></td>
                            <td style="border: none;"><strong>Customer:</strong></td>
                            <td style="border: none;"><?php echo e($item->member->nama ?? 'Customer Umum'); ?></td>
                        </tr>
                        <tr>
                            <td style="border: none;"><strong>Kasir:</strong></td>
                            <td style="border: none;"><?php echo e($item->user->name ?? '-'); ?></td>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">Rp <?php echo e(number_format($detail->harga_jual, 0, ',', '.')); ?></td>
                            <td class="text-center"><?php echo e($detail->jumlah); ?></td>
                            <td class="text-right">Rp <?php echo e(number_format($detail->harga_jual * $detail->jumlah, 0, ',', '.')); ?></td>
                        ...
                        <tr class="total-row">
                            ...
                            <td class="text-center"><strong><?php echo e($total_item_transaksi); ?></strong></td>
                            <td colspan="2" class="text-right"><strong>Rp <?php echo e(number_format($item->total_harga, 0, ',', '.')); ?></strong></td>
                            <td class="text-center"><strong><?php echo e($item->diskon); ?>%</strong></td>
                            <td class="text-right"><strong>Rp <?php echo e(number_format($item->bayar, 0, ',', '.')); ?></strong></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div style="margin-top: 5px; font-size: 9px;">
                    ...
                    Diterima: Rp <?php echo e(number_format($item->diterima, 0, ',', '.')); ?> | 
                    Kembali: Rp <?php echo e(number_format($item->diterima - $item->bayar, 0, ',', '.')); ?>
        ...
        <div class="summary-section">
            ...
            <table class="summary-table">
                <tr>
                    ...
                    <td width="40%" class="text-right"><strong><?php echo e($grand_total_item); ?> item</strong></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="text-right"><strong><?php echo e($penjualan->count()); ?> transaksi</strong></td>
                </tr>
            </table>
        </div>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\penjualan\cetak_detail.blade.php ENDPATH**/ ?>