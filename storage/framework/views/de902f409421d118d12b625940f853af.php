    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-16">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                ?>
                <?php $__currentLoopData = $makkahHotels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hotel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="https://www.google.com/search?q=<?php echo e(urlencode($hotel['name'] . ' Makkah Saudi Arabia')); ?>" 
                   target="_blank" 
                   ...
                   class="block card-hover rounded-2xl overflow-hidden border border-green-100 shadow-sm group bg-white">
                    ...
                    <div class="p-5">
                        <h3 class="font-bold text-gray-900 text-base mb-2 break-words"><?php echo e($hotel['name']); ?></h3>
                        <p class="text-green-brand text-sm font-medium mb-1">
                            <i class="fas fa-map-marker-alt mr-1"></i>Makkah
                        </p>
                        <p class="text-gray-500 text-xs">
                            <i class="fas fa-walking mr-1"></i><?php echo e($hotel['distance']); ?>
        ...
        <div>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                ?>
                <?php $__currentLoopData = $madinahHotels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hotel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="https://www.google.com/search?q=<?php echo e(urlencode($hotel['name'] . ' Madinah Saudi Arabia')); ?>" 
                   target="_blank" 
                   rel="noopener noreferrer"
                   class="block card-hover rounded-2xl overflow-hidden border border-green-100 shadow-sm group bg-white">
                    <div class="relative h-48 overflow-hidden">
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views/public/hotel-partner.blade.php ENDPATH**/ ?>