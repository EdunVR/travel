                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo e(url(auth()->user()->foto ?? '')); ?>" class="user-image img-profil" 
                            alt="User Image">
                        <span class="hidden-xs"> <?php echo e(auth()->user()->name ?? 'User'); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            ...
                            <p>
                                <?php echo e(auth()->user()->name ?? 'User'); ?> - <?php echo e(auth()->user()->role ?? 'POSHAN Crew'); ?>

                                <small><?php echo e(auth()->user()->email ?? 'email'); ?></small>
                            </p>
                        </li>
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo e(route('admin.user.profil')); ?>" class="btn btn-default btn-flat">Profil</a>
                            </div>
...
<form action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;" id="logout-form" class="d-none">
    <?php echo csrf_field(); ?>
</form>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\header.blade.php ENDPATH**/ ?>