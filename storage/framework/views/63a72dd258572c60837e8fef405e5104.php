    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <?php endif; ?>
                <div class="btn-group">
                    <button onclick="addForm('<?php echo e(route('inventori.store')); ?>')" class="btn btn-success btn-xs btn-flat"><i class="fa fa-plus-circle"></i> Tambah</button>
                    <!-- <button onclick="cetakLaporan('<?php echo e(route('inventori.cetak_laporan')); ?>')" class="btn btn-info btn-xs btn-flat"><i class="fa fa-print"></i> Cetak Laporan</button> -->
                </div>
            </div>
...
<?php if ($__env->exists('inventori.form')) echo $__env->make('inventori.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if ($__env->exists('inventori.detail')) echo $__env->make('inventori.detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<script>
    ...
    $(function () {
        table = $('.table-inventori').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?php echo e(route('inventori.data')); ?>',
                data: function (d) {
    ...
    function showDetail(url) {
        ...
        $.get(url, function(data) {
            if (data && data.nama_barang) {
                ...
                $('#form-pinjam').attr('action', '<?php echo e(url('inventori')); ?>/' + data.id_inventori + '/pinjam');
            } else {
    ...
    function editForm(url) {
        ...
        $.get(url)
            .done((response) => {
                ...
                $('#modal-form form').attr('action', "<?php echo e(url('inventori')); ?>/" + response.id_inventori);
            })
            .fail((errors) => {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\inventori\index.blade.php ENDPATH**/ ?>