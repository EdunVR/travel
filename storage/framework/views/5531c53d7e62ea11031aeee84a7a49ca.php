...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Buku Besar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Buku Besar')]); ?>
    ...
    function generalLedgerManagement() {
      return {
        ...
        routes: {
            ...
            generalLedgerData: '<?php echo e(route("finance.general-ledger.data")); ?>',
            jurnalIndex: '<?php echo e(route("finance.jurnal.index")); ?>',
            exportXLSX: '<?php echo e(route("finance.general-ledger.export.xlsx")); ?>',
            exportPDF: '<?php echo e(route("finance.general-ledger.export.pdf")); ?>'
        },
        filters: {
          outlet_id: '',
          period: 'monthly',
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\finance\buku-besar\index.blade.php ENDPATH**/ ?>