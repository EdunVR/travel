...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Detail Keberangkatan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Detail Keberangkatan')]); ?>
  <div x-data="keberangkatanDetail()" x-init="init()" class="space-y-4 self-start w-full">
    <!-- Header -->
    <div class="flex items-center justify-between">
      <div>
        <div class="flex items-center gap-2">
          <a href="<?php echo e(route('admin.inventaris.travel.keberangkatan.index')); ?>" class="p-2 hover:bg-slate-100 rounded-lg">
    ...
    <div x-show="!loading" class="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <div class="space-y-4">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-card p-5">
          ...
          <div class="space-y-2">
            <a :href="`<?php echo e(url('/admin/inventaris/travel/keberangkatan')); ?>/${keberangkatan.id}/logistics`"
            ...
            <a href="javascript:void(0)"
               @click="window.open(`<?php echo e(url('/admin/inventaris/travel/keberangkatan')); ?>/${keberangkatan.id}/manifest`, '_blank')"
            ...
            <a href="javascript:void(0)"
               @click="window.open(`<?php echo e(url('/admin/inventaris/travel/keberangkatan')); ?>/${keberangkatan.id}/siskopatuh`, '_blank')"
               class="flex items-center gap-3 p-3 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors cursor-pointer">
            ...
            <a href="javascript:void(0)"
               @click="window.open(`<?php echo e(url('/admin/inventaris/travel/keberangkatan')); ?>/${keberangkatan.id}/roomlist`, '_blank')"
               class="flex items-center gap-3 p-3 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors cursor-pointer">
            ...
            <a href="javascript:void(0)"
               @click="window.open(`<?php echo e(url('/admin/inventaris/travel/keberangkatan')); ?>/${keberangkatan.id}/roomlist-stream`, '_blank')"
               class="flex items-center gap-3 p-3 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors cursor-pointer">
            ...
            <a href="<?php echo e(route('admin.inventaris.document.manage-room-position', $keberangkatan->id)); ?>"
               class="flex items-center gap-3 p-3 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors cursor-pointer">
    ...
    <?php echo $__env->make('admin.travel.keberangkatan.jamaah-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    function keberangkatanDetail() {
      return {
        ...
        async fetchFlightBookings() {
          ...
          try {
            const response = await fetch(`<?php echo e(route('admin.inventaris.flight-booking.getByKeberangkatan', '')); ?>/${this.keberangkatan.id}`);
            const result = await response.json();
            if (result.success) {
        ...
        async fetchAvailableFlights() {
          try {
            const response = await fetch('<?php echo e(route('admin.inventaris.flight-booking.getAvailableFlights')); ?>');
            const result = await response.json();
            if (result.success) {
        ...
        async submitFlightBooking() {
          ...
          try {
            const response = await fetch('<?php echo e(route('admin.inventaris.flight-booking.store')); ?>', {
              method: 'POST',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json'
        ...
        async submitEditFlightBooking() {
          ...
          try {
            const response = await fetch(`<?php echo e(route('admin.inventaris.flight-booking.updateStatus', '')); ?>/${this.editFlightForm.id}`, {
              method: 'PUT',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json'
        ...
        async submitTicketUpload() {
          ...
          try {
            ...
            const response = await fetch(`<?php echo e(route('admin.inventaris.flight-booking.uploadTicket', '')); ?>/${this.currentFlightBooking.id}`, {
              method: 'POST',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
              },
        ...
        async deleteFlightBooking(id) {
          ...
          try {
            const response = await fetch(`<?php echo e(route('admin.inventaris.flight-booking.destroy', '')); ?>/${id}`, {
              method: 'DELETE',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json'
        ...
        async fetchHotelBookings() {
          ...
          try {
            const response = await fetch(`<?php echo e(url('/admin/inventaris/travel/hotel-booking/keberangkatan')); ?>/${this.keberangkatan.id}`);
            const result = await response.json();
            if (result.success) {
        ...
        async fetchAvailableHotels() {
          try {
            const response = await fetch('<?php echo e(url('/admin/inventaris/travel/hotel-booking/hotels/available')); ?>');
            const result = await response.json();
            if (result.success) {
        ...
        async submitHotelBooking() {
          ...
          try {
            const response = await fetch('<?php echo e(url('/admin/inventaris/travel/hotel-booking')); ?>', {
              method: 'POST',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json'
        ...
        async submitEditHotelBooking() {
          ...
          try {
            const response = await fetch(`<?php echo e(url('/admin/inventaris/travel/hotel-booking')); ?>/${this.editHotelForm.id}/status`, {
              method: 'PUT',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json'
        ...
        async showRoomAssignmentModal(booking) {
          ...
          try {
            const url = `<?php echo e(url('/admin/inventaris/travel/hotel-booking')); ?>/${booking.id}/assignments`;
        ...
        async submitRoomAssignments() {
          ...
          try {
            ...
            const response = await fetch(`<?php echo e(url('/admin/inventaris/travel/hotel-booking')); ?>/${this.currentHotelBooking.id}/assign-rooms`, {
              method: 'POST',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json'
        ...
        downloadRoomlist(bookingId) {
          window.location.href = `<?php echo e(url('/admin/inventaris/travel/hotel-booking')); ?>/${bookingId}/roomlist`;
        },
        ...
        async deleteHotelBooking(id) {
          ...
          try {
            const response = await fetch(`<?php echo e(url('/admin/inventaris/travel/hotel-booking')); ?>/${id}`, {
              method: 'DELETE',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json'
        ...
        async fetchVisas() {
          ...
          try {
            const res = await fetch(`<?php echo e(url('')); ?>/admin/inventaris/travel/keberangkatan/${this.keberangkatanId}/visas`, {
        ...
        async submitVisaForm() {
          ...
          try {
            ...
            const url = isEdit
              ? `<?php echo e(url('')); ?>/admin/travel/keberangkatan/${this.keberangkatanId}/visas/${this.visaForm.id}`
              : `<?php echo e(url('')); ?>/admin/travel/keberangkatan/${this.keberangkatanId}/visas`;
        ...
        async deleteVisaNow() {
          ...
          try {
            const res = await fetch(`<?php echo e(url('')); ?>/admin/travel/keberangkatan/${this.keberangkatanId}/visas/${this.toDeleteVisa.id}`, {
              method: 'DELETE',
        ...
        async sendReminderNow() {
          ...
          try {
            const res = await fetch(`<?php echo e(url('')); ?>/admin/inventaris/travel/keberangkatan/${this.keberangkatanId}/send-reminders`, {
              method: 'POST',
              headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' }
            });
            const result = await res.json();
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\travel\keberangkatan\show.blade.php ENDPATH**/ ?>