...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Travel / Edit Paket Perjalanan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Travel / Edit Paket Perjalanan')]); ?>
  <div x-data="packageEdit()" x-init="init()" class="space-y-4 self-start w-full">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-slate-600 text-sm">Edit paket <?php echo e($package->package_name); ?></p>
      </div>
    </div>
            ...
            <div class="mb-3 border border-slate-200 rounded-lg p-3 bg-slate-50">
              ...
              <div class="relative bg-white rounded-lg overflow-hidden" style="width: 100%; max-width: 400px; aspect-ratio: 16/9;">
                ...
                <img src="<?php echo e(asset('storage/' . $package->image_path)); ?>" 
                     ...
                     data-crop='<?php echo json_encode($cropData, 15, 512) ?>'
                     style="width: 100%; height: 100%; object-fit: cover;"
                     onload="applyCropToPreview(this)">
                <?php else: ?>
                <img src="<?php echo e(asset('storage/' . $package->image_path)); ?>" alt="Current image" class="w-full h-full object-cover">
                <?php endif; ?>
              </div>
              <div class="mt-2 flex items-center justify-between">
                <p class="text-xs text-slate-500">Gambar saat ini <?php echo e($cropData ? '(dengan crop settings)' : ''); ?></p>
  ...
  <script>
    function packageEdit() {
      return {
        ...
        cropper: null,
        form: {
          package_code: '<?php echo e($package->package_code); ?>',
          package_name: '<?php echo e($package->package_name); ?>',
          package_type: '<?php echo e($package->package_type ?? 'umrah'); ?>',
          package_subtype: '<?php echo e($package->package_subtype ?? ''); ?>',
          description: `<?php echo e($package->description ?? ''); ?>`,
          ustadz_name: '<?php echo e($package->ustadz_name ?? ''); ?>',
          inclusions: `<?php echo e($package->inclusions ?? ''); ?>`,
          duration_days: <?php echo e($package->duration_days); ?>,
          ...
          // Flight Information
          flight_group_code: '',
          id_flight_departure: <?php echo e($package->id_flight_departure ?? 'null'); ?>,
          departure_datetime: '<?php echo e($package->departure_datetime ? $package->departure_datetime->format('Y-m-d\TH:i') : ''); ?>',
          id_flight_return: <?php echo e($package->id_flight_return ?? 'null'); ?>,
          return_datetime: '<?php echo e($package->return_datetime ? $package->return_datetime->format('Y-m-d\TH:i') : ''); ?>',
          // Hotel Makkah
          id_hotel_makkah: <?php echo e($package->id_hotel_makkah ?? 'null'); ?>,
          id_hotel_room_type_makkah: <?php echo e($package->id_hotel_room_type_makkah ?? 'null'); ?>,
          makkah_check_in: '<?php echo e($package->makkah_check_in ? $package->makkah_check_in->format('Y-m-d') : ''); ?>',
          makkah_check_out: '<?php echo e($package->makkah_check_out ? $package->makkah_check_out->format('Y-m-d') : ''); ?>',
          // Hotel Madinah
          id_hotel_madinah: <?php echo e($package->id_hotel_madinah ?? 'null'); ?>,
          id_hotel_room_type_madinah: <?php echo e($package->id_hotel_room_type_madinah ?? 'null'); ?>,
          madinah_check_in: '<?php echo e($package->madinah_check_in ? $package->madinah_check_in->format('Y-m-d') : ''); ?>',
          madinah_check_out: '<?php echo e($package->madinah_check_out ? $package->madinah_check_out->format('Y-m-d') : ''); ?>',
          // Saudi Transport
          id_saudi_transport: <?php echo e($package->id_saudi_transport ?? 'null'); ?>,
          saudi_transports: (function() {
            try {
              const raw = <?php echo json_encode($package->saudi_transports ?? null, 15, 512) ?>;
          ...
          hotels: (function() {
            try {
              const raw = <?php echo json_encode($package->hotels ?? null, 15, 512) ?>;
          ...
          // Other fields
          capacity: <?php echo e($package->capacity); ?>,
          price: <?php echo e($package->price); ?>,
          status: '<?php echo e($package->status); ?>',
          is_promo: <?php echo e($package->is_promo ? 'true' : 'false'); ?>,
          is_best_seller: <?php echo e($package->is_best_seller ? 'true' : 'false'); ?>,
          id_outlet: <?php echo e($package->id_outlet); ?>,
          image: null,
          thumbnail_crop: <?php echo json_encode($package->thumbnail_crop_settings ?? ['x' => 0, 'y' => 0, 'width' => 0, 'height' => 0, 'rotate' => 0, 'scaleX' => 1, 'scaleY' => 1]); ?>,
          price_packages: (function() {
            try {
              const raw = <?php echo json_encode($package->price_packages ?? null, 15, 512) ?>;
        ...
        editExistingCrop() {
          ...
          const existingImagePath = '<?php echo e($package->image_path ?? ''); ?>';
          ...
          this.imagePreviewUrl = '<?php echo e(asset('storage/' . ($package->image_path ?? ''))); ?>';
        ...
        async submitForm() {
          ...
          try {
            ...
            const response = await fetch('<?php echo e(route('admin.inventaris.travel.package.update', $package->id)); ?>', {
              method: 'POST',
              headers: {
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views/admin/travel/package/edit.blade.php ENDPATH**/ ?>