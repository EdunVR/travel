            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="tanggal_tempo" name="tanggal_tempo" 
                           value="<?php echo e(date('Y-m-d', strtotime('+1 week'))); ?>" min="<?php echo e(date('Y-m-d')); ?>">
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\penjualan_detail\due_date_modal.blade.php ENDPATH**/ ?>