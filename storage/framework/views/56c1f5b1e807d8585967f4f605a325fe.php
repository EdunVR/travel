<div class="w-64 bg-green-700 text-white shadow-lg">
    ...
    <nav class="mt-4">
        <a href="<?php echo e(route('investor.dashboard')); ?>" class="flex items-center px-4 py-3 text-sm text-green-100 hover:bg-green-600">
            <i class="fas fa-chart-line w-6 text-center mr-3"></i>
            <span>Dashboard</span>
        </a>
        <a href="<?php echo e(route('investor.investments')); ?>" class="flex items-center px-4 py-3 text-sm bg-green-800 text-white">
            <i class="fas fa-wallet w-6 text-center mr-3"></i>
            <span>Investasi Saya</span>
            <span class="ml-auto w-1 h-6 bg-white rounded-l"></span>
        </a>
        <a href="<?php echo e(route('investor.profits')); ?>" class="flex items-center px-4 py-3 text-sm text-green-100 hover:bg-green-600">
            <i class="fas fa-hand-holding-usd w-6 text-center mr-3"></i>
            <span>Bagi Hasil</span>
        </a>
        <a href="<?php echo e(route('investor.withdrawals')); ?>" class="flex items-center px-4 py-3 text-sm text-green-100 hover:bg-green-600">
            <i class="fas fa-money-bill-wave w-6 text-center mr-3"></i>
            <span>Pencairan</span>
        </a>
        <a href="<?php echo e(route('investor.documents')); ?>" class="flex items-center px-4 py-3 text-sm text-green-100 hover:bg-green-600">
            <i class="fas fa-file-alt w-6 text-center mr-3"></i>
            <span>Dokumen</span>
        </a>
        <a href="<?php echo e(route('investor.profile')); ?>" class="flex items-center px-4 py-3 text-sm text-green-100 hover:bg-green-600">
            <i class="fas fa-user w-6 text-center mr-3"></i>
            <span>Profil Saya</span>
        </a>
    </nav>
</div>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\investor\partials\sidebar.blade.php ENDPATH**/ ?>