...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Pembelian / Purchase Order']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Pembelian / Purchase Order')]); ?>
  <div x-data="purchaseOrder()" x-init="init()" class="space-y-5 overflow-x-hidden">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="flex flex-wrap gap-2">
        <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'procurement.purchase-order.create')): ?>
        ...
        <div class="group rounded-2xl border border-slate-200 bg-white shadow-card hover:shadow-[0_14px_40px_rgba(15,23,42,.08)] transition overflow-hidden">
          ...
          <div class="p-4 border-t border-slate-100">
            <div class="flex flex-wrap gap-2">
                ...
                <!-- Edit button -->
                <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'procurement.purchase-order.update')): ?>
    ...
    <div x-show="showPOModal" x-transition.opacity class="fixed inset-0 z-50 flex items-start justify-center bg-black/40 p-3 overflow-y-auto">
      <div @click.outside="closePOModal()" class="w-full max-w-6xl bg-white rounded-2xl shadow-float my-4 flex flex-col">
                                ...
                                <div class="flex-1 grid grid-cols-1 gap-2">
                                    ...
                                    <div class="grid grid-cols-3 gap-2">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-xs text-blue-600 mt-1" x-show="item.harga > 0" 
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-xs text-blue-600 mt-1" x-show="item.diskon > 0" 
                                               x-text="'≈ ' + formatCurrency(item.diskon)"></p>
                                        </div>
                                    </div>
    ...
    <div x-show="showPOSettingModal" x-transition.opacity class="fixed inset-0 z-50 flex items-start justify-center bg-black/40 p-3 pt-20">
      <div @click.outside="closePOSettingModal()" class="w-full max-w-lg bg-white rounded-2xl shadow-float">
        <div class="px-4 sm:px-5 py-3 border-b border-slate-100 flex items-center justify-between">
    ...
    <div x-show="supplierModal.show" x-transition.opacity class="fixed inset-0 z-50 flex items-start justify-center bg-black/40 p-3 overflow-y-auto">
        <div @click.outside="closeSupplierModal()" class="w-full max-w-6xl bg-white rounded-2xl shadow-float my-4 flex flex-col">
            <div class="px-4 sm:px-5 py-3 border-b border-slate-100 flex items-center justify-between">
            ...
            <div class="px-4 sm:px-5 py-4 overflow-y-auto flex-1">
                ...
                <div x-show="supplierModal.loading" class="text-center py-8">
                    <i class='bx bx-loader-alt bx-spin text-2xl text-primary-600'></i>
                    <div class="text-sm text-slate-600 mt-2">Memuat data supplier...</div>
                </div>

                
                <div x-show="!supplierModal.loading" class="overflow-x-auto">
                    <table class="w-full text-sm">
                        <thead class="bg-slate-50">
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr x-show="supplierModal.suppliers.length === 0">
                                <td colspan="6" class="px-4 py-8 text-center text-slate-500">
                                    <i class='bx bx-user-circle text-3xl mb-2 text-slate-300'></i>
                                    <div>Tidak ada data supplier untuk outlet ini</div>
                                    <div class="text-xs text-slate-400 mt-1">Klik "Tambah Supplier" untuk menambah supplier baru</div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <div x-show="supplierModal.showCreateModal" x-transition.opacity class="fixed inset-0 z-50 flex items-start justify-center bg-black/40 p-3 overflow-y-auto">
        <div @click.outside="closeSupplierCreateModal()" class="w-full max-w-3xl bg-white rounded-2xl shadow-float my-4 flex flex-col">
            <div class="px-4 sm:px-5 py-3 border-b border-slate-100 flex items-center justify-between">
    ...
    <div x-show="showQuotationModal" x-transition.opacity class="fixed inset-0 z-50 flex items-start justify-center bg-black/40 p-3 pt-20">
        <div @click.outside="closeQuotationModal()" class="w-full max-w-lg bg-white rounded-2xl shadow-float">
            <div class="px-4 sm:px-5 py-3 border-b border-slate-100 flex items-center justify-between">
    ...
    <div x-show="showPenerimaanModal" x-transition.opacity class="fixed inset-0 z-50 flex items-start justify-center bg-black/40 p-3 pt-20">
        <div @click.outside="closePenerimaanModal()" class="w-full max-w-lg bg-white rounded-2xl shadow-float">
            <div class="px-4 sm:px-5 py-3 border-b border-slate-100 flex items-center justify-between">
    ...
    <div x-show="showVendorBillModal" x-transition.opacity class="fixed inset-0 z-50 flex items-start justify-center bg-black/40 p-3 pt-20">
        <div @click.outside="closeVendorBillModal()" class="w-full max-w-lg bg-white rounded-2xl shadow-float">
            <div class="px-4 sm:px-5 py-3 border-b border-slate-100 flex items-center justify-between">
    ...
    <div x-show="showStatusModal" x-transition.opacity class="fixed inset-0 z-50 flex items-start justify-center bg-black/40 p-3 pt-20">
        <div @click.outside="closeStatusModal()" class="w-full max-w-lg bg-white rounded-2xl shadow-float">
            <div class="px-5 py-4">
    ...
    <div x-show="invoiceModal.show" x-transition.opacity class="fixed inset-0 z-[60] flex items-start justify-center bg-black/40 p-3 overflow-y-auto">
        <div @click.outside="closeInvoiceModal()" class="w-full max-w-7xl bg-white rounded-2xl shadow-float my-4 flex flex-col">
            ...
            <div class="flex-1 flex flex-col md:flex-row overflow-hidden">
                ...
                <div class="w-full md:w-96 border-r border-slate-200 bg-slate-50 overflow-y-auto flex-shrink-0">
    ...
    <div x-show="showPaymentProofViewer" x-transition.opacity class="fixed inset-0 z-[70] flex items-center justify-center bg-black/40 p-3 modal-overlay">
        <div @click.outside="showPaymentProofViewer = false" class="w-full max-w-2xl bg-white rounded-2xl shadow-float modal-scroll-container">
            <!-- Header - Fixed -->
            <div class="px-4 sm:px-5 py-3 border-b border-slate-100 flex items-center justify-between modal-header">
            ...
            <!-- Content - Scrollable -->
            <div class="px-4 sm:px-5 py-4 modal-content">
            ...
            <!-- Footer - Fixed -->
            <div class="px-4 sm:px-5 pb-3 pt-2 border-t border-slate-100 flex items-center justify-end modal-footer">
    ...
    <div x-show="showPaymentModal" x-transition.opacity class="fixed inset-0 z-50 flex items-start justify-center bg-black/40 p-3 modal-overlay overflow-y-auto">
        <div @click.outside="closePaymentModal()" class="w-full max-w-3xl bg-white rounded-2xl shadow-float modal-scroll-container my-4">
            <!-- Header - Fixed -->
            <div class="px-4 sm:px-5 py-3 border-b border-slate-100 flex items-center justify-between modal-header">
            ...
            <!-- Content - Scrollable -->
            <div class="px-4 sm:px-5 py-4 space-y-4 modal-content">
            ...
            <!-- Footer - Fixed -->
            <div class="px-4 sm:px-5 pb-3 pt-2 border-t border-slate-100 flex items-center justify-end gap-2 modal-footer">
    ...
    <div x-show="showPaymentHistoryModal" x-transition.opacity class="fixed inset-0 z-50 flex items-start justify-center bg-black/40 p-3 modal-overlay overflow-y-auto">
        <div @click.outside="closePaymentHistoryModal()" class="w-full max-w-5xl bg-white rounded-2xl shadow-float modal-scroll-container my-4">
            <!-- Header - Fixed -->
            <div class="px-4 sm:px-5 py-3 border-b border-slate-100 flex items-center justify-between modal-header">
    ...
    <div x-show="showBuktiModal" x-transition.opacity class="fixed inset-0 z-50 flex items-start justify-center bg-black/40 p-3 modal-overlay overflow-y-auto">
        <div @click.outside="closeBuktiModal()" class="w-full max-w-4xl bg-white rounded-2xl shadow-float modal-scroll-container my-4">
            <!-- Header - Fixed -->
            <div class="px-4 sm:px-5 py-3 border-b border-slate-100 flex items-center justify-between modal-header">
            ...
            <!-- Footer - Fixed -->
            <div class="px-4 sm:px-5 pb-3 pt-2 border-t border-slate-100 flex items-center justify-between modal-footer">
    ...
    function purchaseOrder() {
      return {
        ...
        async init() {
          ...
          // Set default outlet with proper validation
          const userOutlets = <?php echo json_encode(auth()->user()->akses_outlet ?? [], 15, 512) ?>;
          let defaultOutletId = null;
          
          if (userOutlets && userOutlets.length > 0) {
            // Check if user outlet exists in available outlets
            const validUserOutlet = this.outlets.find(outlet => 
              userOutlets.includes(outlet.id_outlet)
            );
            if (validUserOutlet) {
              defaultOutletId = validUserOutlet.id_outlet;
            }
          }
          
          // If no valid user outlet, use OutletHelper or first available outlet
          if (!defaultOutletId) {
          ...
          if (defaultOutletId) {
            ...
            console.log('Purchase Order: Using outlet ID:', defaultOutletId);
          } else {
            console.error('Purchase Order: No valid outlet found');
          }
        ...
        async loadStats() {
            try {
                ...
                const response = await fetch(`<?php echo e(route("pembelian.purchase-order.counts")); ?>?${params}`);
        ...
        async loadSuppliers() {
            try {
                const response = await fetch(`<?php echo e(route('pembelian.suppliers')); ?>?outlet_id=${this.selectedOutlet}`);
                const data = await response.json();
                if (data.success) {
        ...
        async loadOutlets() {
          try {
            const response = await fetch('<?php echo e(route("pembelian.outlets")); ?>');
            const data = await response.json();
            if (data.success) {
              this.outlets = data.outlets;
              console.log('Purchase Order: Loaded outlets:', this.outlets.map(o => `${o.nama_outlet} (ID: ${o.id_outlet})`));
            } else {
              console.error('Purchase Order: Failed to load outlets:', data);
            }
          } catch (error) {
        ...
        async loadProducts() {
          try {
            const response = await fetch('<?php echo e(route("pembelian.produk.pembelian")); ?>');
            const data = await response.json();
            if (data.success) {
        ...
        async loadBahan() {
            try {
                const response = await fetch('<?php echo e(route("pembelian.bahan.pembelian")); ?>');
                const data = await response.json();
                if (data.success) {
        ...
        async loadPurchaseOrders() {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('pembelian.purchase-order.data')); ?>?${params}`);
                const data = await response.json();
        ...
        async searchSuppliers() {
            ...
            try {
                const response = await fetch(`<?php echo e(route('pembelian.suppliers')); ?>?search=${this.supplierSearch}&outlet_id=${selectedOutlet}`);
                const data = await response.json();
        ...
        async searchProducts(item, index) {
            ...
            try {
                const response = await fetch(`<?php echo e(route("pembelian.produk.pembelian")); ?>?search=${item.product_search}&outlet_id=${selectedOutlet}`);
                const data = await response.json();
        ...
        async searchBahan(item, index) {
            ...
            try {
                const response = await fetch(`<?php echo e(route("pembelian.bahan.pembelian")); ?>?search=${item.bahan_search}&outlet_id=${selectedOutlet}`);
                const data = await response.json();
        ...
        async submitPurchaseOrder() {
            ...
            try {
                ...
                const url = isEdit 
                    ? `<?php echo e(route('pembelian.purchase-order.update', '')); ?>/${this.poForm.id_purchase_order}`
                    : '<?php echo e(route("pembelian.purchase-order.store")); ?>';
        ...
        async editPurchaseOrder(po) {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('pembelian.purchase-order.show', '')); ?>/${po.id_purchase_order}`);
                const result = await response.json();
        ...
        async updatePOStatus(poId, status) {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('pembelian.purchase-order.update-status', '')); ?>/${poId}`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
        ...
        async confirmStatusUpdate() {
            try {
                const response = await fetch(`<?php echo e(route('pembelian.purchase-order.update-status', '')); ?>/${this.statusForm.po_id}`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
        ...
        async confirmDelete() {
          ...
          try {
            const response = await fetch(`<?php echo e(route('pembelian.purchase-order.destroy', '')); ?>/${this.poToDelete.id_purchase_order}`, {
              method: 'DELETE',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json'
        ...
        async openPOSetting() {
            ...
            try {
                ModalLoader.show();
                const response = await fetch(`<?php echo e(route("pembelian.purchase-order.setting")); ?>?outlet_id=${this.selectedOutlet}`);
                const data = await response.json();
        ...
        async updatePOSetting() {
          try {
            const response = await fetch('<?php echo e(route("pembelian.purchase-order.setting.update")); ?>', {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
        ...
        refreshPreview() {
            if (this.currentPrintPO) {
                ...
                this.previewUrl = `<?php echo e(route('pembelian.purchase-order.print', ':id')); ?>?template=${this.selectedTemplate}&preview=true&t=${Date.now()}`.replace(':id', this.currentPrintPO.id_purchase_order);
            }
        },
        ...
        generatePreviewUrl(poId, template) {
            ...
            return `<?php echo e(route('pembelian.purchase-order.print', ':id')); ?>?template=${template}&preview=true&document_number=${encodeURIComponent(documentNumber)}&_=${timestamp}`.replace(':id', poId);
        },
        ...
        printPO(poId) {
            ...
            if (po) {
                ...
                this.previewUrl = `<?php echo e(route('pembelian.purchase-order.print-document', ':id')); ?>?template=${this.selectedTemplate}&preview=true&_=${Date.now()}`.replace(':id', poId);
        ...
        downloadPDF() {
            if (this.currentPrintPO) {
                const downloadUrl = `<?php echo e(route('pembelian.purchase-order.print', ':id')); ?>?template=${this.selectedTemplate}&download=true`.replace(':id', this.currentPrintPO.id_purchase_order);
        ...
        exportExcel() {
          ...
          window.open(`<?php echo e(route('pembelian.purchase-order.export.excel')); ?>?${params}`, '_blank');
        ...
        exportPdf() {
          ...
          window.open(`<?php echo e(route('pembelian.purchase-order.export.pdf')); ?>?${params}`, '_blank');
          this.exportMenuOpen = false;
        },
        ...
        async fetchPOData(poId) {
            try {
                const response = await fetch(`<?php echo e(route('pembelian.purchase-order.show', '')); ?>/${poId}`);
                const result = await response.json();
        ...
        async openCoaModal() {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route("pembelian.coa-setting")); ?>?outlet_id=${this.selectedOutlet}`);
        ...
        async submitCoaSettingPurchase() {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route("pembelian.coa-setting.update")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
        ...
        async openSupplierModal() {
            try {
                ...
                this.supplierModal.show = true; // Show modal first
                
                console.log('Loading suppliers for outlet:', this.selectedOutlet);
                
                const response = await fetch(`<?php echo e(route("pembelian.supplier-management")); ?>?outlet_id=${this.selectedOutlet}`);
                const result = await response.json();
                
                console.log('Supplier management response:', result);
                ...
                if (result.success) {
                    ...
                    console.log('Loaded suppliers:', this.supplierModal.suppliers.length);
                    
                    if (this.supplierModal.suppliers.length === 0) {
                        this.showToastMessage('Tidak ada supplier untuk outlet ini', 'info');
                    }
                } else {
                    this.showToastMessage(result.message || 'Gagal memuat data supplier', 'error');
                    console.error('Supplier management error:', result);
                }
            } catch (error) {
                console.error('Error loading suppliers:', error);
                this.showToastMessage('Gagal memuat data supplier: ' + error.message, 'error');
            } finally {
        ...
        openCreateSupplier() {
            this.supplierModal.form = {
                ...
                alamat: '',
                email: '',
                id_outlet: this.selectedOutlet, // Set default outlet
                is_active: true,
                bank: '',
                no_rekening: '',
                atas_nama: ''
            ...
            console.log('Opening create supplier form with outlet:', this.selectedOutlet);
        },
        ...
        async editSupplier(supplier) {
            try {
                console.log('Editing supplier:', supplier.id_supplier);
                
                const response = await fetch(`<?php echo e(route('pembelian.supplier.show', '')); ?>/${supplier.id_supplier}`);
                const result = await response.json();
        ...
        async deleteSupplier(supplier) {
            ...
            try {
                console.log('Deleting supplier:', supplier.id_supplier);
                
                const response = await fetch(`<?php echo e(route('pembelian.supplier.destroy', '')); ?>/${supplier.id_supplier}`, {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                        'Content-Type': 'application/json'
                ...
                if (result.success) {
                    ...
                    // Reload supplier data and also refresh dropdown
                    await Promise.all([
                        this.loadSupplierModalData(),
                        this.loadSuppliers() // Refresh dropdown filter
                    ]);
                } else {
                ...
                this.showToastMessage('Gagal menghapus supplier: ' + error.message, 'error');
            }
        },
        ...
        async submitSupplier() {
            ...
            try {
                console.log('Submitting supplier:', this.supplierModal.form);
                
                const response = await fetch('<?php echo e(route("pembelian.supplier.store")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                ...
                const result = await response.json();
                console.log('Supplier save response:', result);
        ...
        async loadSupplierModalData() {
            try {
                ...
                if (result.success) {
                    ...
                    console.log('Reloaded suppliers:', this.supplierModal.suppliers.length);
                }
            } catch (error) {
        ...
        async markAsPaid() {
            ...
            try {
                const response = await fetch(`<?php echo e(route('pembelian.purchase-order.update-status', '')); ?>/${this.invoiceModal.poData.id_purchase_order}`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
        ...
        async openInvoiceModal(po) {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('pembelian.purchase-order.invoice-data', '')); ?>/${po.id_purchase_order}`);
                const result = await response.json();
        ...
        async generateInvoicePDF() {
            ...
            try {
                ...
                this.invoiceModal.previewUrl = `<?php echo e(route('pembelian.purchase-order.invoice-preview')); ?>?data=${encodedData}&t=${timestamp}`;
        ...
        async confirmPayment() {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route("pembelian.purchase-invoice.create")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
        ...
        async confirmPaymentWithProof() {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('pembelian.payment.upload-proof', '')); ?>/${invoice.id_purchase_invoice}`, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                    },
        ...
        async previewCoaJournalByTab(status) {
            ...
            try {
                const response = await fetch(`<?php echo e(route("pembelian.coa-setting.preview-journal")); ?>?outlet_id=${this.coaModal.form.outlet_id}&status=${status}`);
                const result = await response.json();
        ...
        async submitPayment() {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route("pembelian.purchase-order.payment")); ?>', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                        'Accept': 'application/json'
        ...
        async viewPaymentHistory(po) {
            ...
            try {
                const response = await fetch(`<?php echo e(url('pembelian/purchase-order')); ?>/${po.id_purchase_order}/payment-history`, {
                    headers: {
                        'Accept': 'application/json'
                    }
                });
        ...
        async viewBuktiPembayaran(paymentId) {
            ...
            try {
                const response = await fetch(`<?php echo e(url('pembelian/purchase-order/payment')); ?>/${paymentId}/download-bukti`, {
                    headers: {
                        'Accept': 'application/json'
                    }
                });
        ...
        async downloadBukti() {
            ...
            try {
                const response = await fetch(`<?php echo e(route('pembelian.purchase-order.download-bukti', '')); ?>/${this.buktiModal.paymentId}`);
        ...
        async submitPaymentProof() {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('pembelian.payment.upload-proof', '')); ?>/${this.paymentProofForm.id_purchase_invoice}`, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                    },
        ...
        async checkPaymentProof() {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('pembelian.payment.check-proof', '')); ?>/${invoiceId}`);
                const result = await response.json();
        ...
        async viewPaymentProof(po = null) {
            try {
                ...
                const response = await fetch(`<?php echo e(route('pembelian.payment.get-proof', '')); ?>/${invoiceId}`);
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\pembelian\purchase-order\index.blade.php ENDPATH**/ ?>