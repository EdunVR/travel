...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Neraca (Balance Sheet)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Neraca (Balance Sheet)')]); ?>
      ...
      return {
        ...
        async loadNeracaData() {
          ...
          try {
            ...
            const response = await fetch(`<?php echo e(route('finance.neraca.data')); ?>?${params}`);
            const result = await response.json();
        ...
        async viewAccountDetails(accountId) {
          ...
          try {
            ...
            const response = await fetch(`<?php echo e(url('finance/neraca/account-details')); ?>/${accountId}?${params}`);
            const result = await response.json();
        ...
        async exportToXLSX() {
          ...
          window.location.href = `<?php echo e(route('finance.neraca.export.xlsx')); ?>?${params}`;
        },
        ...
        async exportToPDF() {
          ...
          window.location.href = `<?php echo e(route('finance.neraca.export.pdf')); ?>?${params}`;
        },
