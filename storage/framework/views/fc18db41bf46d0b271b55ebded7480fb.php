            ...
            <div class="modal-body">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p><strong>Nama Buku:</strong><br><?php echo e($book->name); ?></p>
                                <p><strong>Periode:</strong><br>
                                    <?php echo e($book->start_date->format('d/m/Y')); ?> - <?php echo e($book->end_date->format('d/m/Y')); ?>

                                </p>
                            </div>
                            <div class="col-md-6">
                                <p><strong>Mata Uang:</strong><br><?php echo e($book->currency); ?></p>
                                <p><strong>Status:</strong><br>
                                    <span class="badge bg-success"><?php echo e(ucfirst($book->status)); ?></span>
                                </p>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\financial\book\close_confirmation_modal.blade.php ENDPATH**/ ?>