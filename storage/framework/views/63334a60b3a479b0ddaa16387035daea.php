...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Dashboard Pembelian']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Dashboard Pembelian')]); ?>
  ...
  <script>
    function purchasesDashboard(){
      return {
        ...
        async loadOutlets() {
          try {
            const response = await fetch('<?php echo e(route("pembelian.dashboard.outlets")); ?>');
        ...
        async applyFilters() {
          ...
          try {
            ...
            const response = await fetch(`<?php echo e(route('pembelian.dashboard.data')); ?>?${params}`);
            const result = await response.json();
...
${statusInfo}`
        ...
        printPO(poId) {
          window.open(`<?php echo e(route('pembelian.purchase-order.print', '')); ?>/${poId}`, '_blank');
        },
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\pembelian\index.blade.php ENDPATH**/ ?>