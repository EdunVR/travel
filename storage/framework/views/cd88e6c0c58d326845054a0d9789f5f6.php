    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            historyTable = $('#history-table').DataTable({
                ...
                scrollCollapse: true,
                ajax: {
                    url: '<?php echo e(route('admin.penjualan.inter-outlet.history.data')); ?>',
                    data: function(d) {
        ...
        function viewDetail(id) {
            fetch(`<?php echo e(route('admin.penjualan.inter-outlet.show', '')); ?>/${id}`)
        ...
        function approveTransaction(id) {
            if (confirm('Apakah Anda yakin ingin menyetujui transaksi ini?')) {
                fetch(`<?php echo e(route('admin.penjualan.inter-outlet.approve', '')); ?>/${id}`, {
                    method: 'POST',
                    headers: {
...
</html><?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\penjualan\inter-outlet\history.blade.php ENDPATH**/ ?>