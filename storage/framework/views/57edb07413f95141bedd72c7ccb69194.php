    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header text-white">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('financial.annual-tax-report.create')); ?>" class="btn btn-success btn-sm">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center font-weight-bold"><?php echo e($report->report_year); ?></td>
                            <td><?php echo e($report->accountingBook->name); ?></td>
                            <td><?php echo e($report->npwp); ?></td>
                            <td><?php echo e($report->taxpayer_name); ?></td>
                            <td>
                                <?php
                                    $businessTypes = [
                                        'service' => 'Jasa',
                                ...
                                ?>
                                <?php echo e($businessTypes[$report->business_type] ?? $report->business_type); ?>

                            </td>
                            <td class="text-center">
                                <span class="badge badge-<?php echo e($report->is_completed ? 'success' : 'warning'); ?> py-1 px-2">
                                    <?php echo e($report->is_completed ? 'Lengkap' : 'Draft'); ?>
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group">
                                    <button class="btn btn-sm btn-primary edit-btn" 
                                            ...
                                            data-edit-url="<?php echo e(route('financial.annual-tax-report.edit', $report->id)); ?>"
                                            data-update-url="<?php echo e(route('financial.annual-tax-report.update', $report->id)); ?>"
                                            title="Edit">
                                    ...
                                    <button class="btn btn-sm btn-info show-pdf-btn ml-1"
                                            data-id="<?php echo e($report->id); ?>"
                                            data-show-url="<?php echo e(route('financial.annual-tax-report.show', $report->id)); ?>"
                                            title="Lihat PDF">
                                        <i data-feather="file" class="feather-icon-xs"></i>
                                    </button>
                                    
                                    <form action="<?php echo e(route('financial.annual-tax-report.destroy', $report->id)); ?>" method="POST" class="d-inline ml-1">
                                        <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="report_year" class="form-control" 
                                            value="<?php echo e(date('Y')); ?>" min="2000" max="<?php echo e(date('Y')+1); ?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <table class="table table-bordered" id="taxRateTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <select name="tax_rates[<?php echo e($i); ?>][level]" class="form-control" required>
                                                    <option value="I" <?php echo e($i == 0 ? 'selected' : ''); ?>>I</option>
                                                    <option value="II" <?php echo e($i == 1 ? 'selected' : ''); ?>>II</option>
                                                    <option value="III" <?php echo e($i == 2 ? 'selected' : ''); ?>>III</option>
                                                    <option value="IV" <?php echo e($i == 3 ? 'selected' : ''); ?>>IV</option>
                                                    <option value="V" <?php echo e($i == 4 ? 'selected' : ''); ?>>V</option>
                                                </select>
                                            </td>
                                            <td>
                                                <input type="number" name="tax_rates[<?php echo e($i); ?>][lower_limit]" 
                                                    class="form-control" value="<?php echo e($i == 0 ? 0 : ''); ?>" required>
                                            </td>
                                            <td>< PKP ≤</td>
                                            <td>
                                                <input type="number" name="tax_rates[<?php echo e($i); ?>][upper_limit]" 
                                                    class="form-control" <?php echo e($i == 4 ? 'readonly' : ''); ?> 
                                                    value="<?php echo e($i == 4 ? '' : ''); ?>">
                                            </td>
                                            <td>
                                                <input type="number" name="tax_rates[<?php echo e($i); ?>][rate]" 
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\financial\annual-tax-report\index.blade.php ENDPATH**/ ?>