                ...
                <form id="poForm">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_po" id="no_po" class="form-control" 
                                       value="<?php echo e($noPO); ?>" readonly required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_member" id="id_member" class="form-control" required>
                                    ...
                                    <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($member->id_member); ?>">
                                            <?php echo e($member->nama); ?> - <?php echo e($member->telepon); ?>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <a href="<?php echo e(route('po-penjualan.index')); ?>" class="btn btn-default">Batal</a>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <table class="table table-bordered table-striped" id="productTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e(format_uang($item->harga_jual)); ?></td>
                                <td><?php echo e($item->stok); ?></td>
                                <td>
                                    <button class="btn btn-primary btn-sm select-product" 
                                            data-id="<?php echo e($item->id_produk); ?>"
                                            data-kode="<?php echo e($item->kode_produk); ?>"
                                            data-nama="<?php echo e($item->nama_produk); ?>"
                                            data-harga="<?php echo e($item->harga_jual); ?>"
                                            data-diskon="<?php echo e($item->diskon); ?>"
                                            data-stok="<?php echo e($item->stok); ?>">
                                        Pilih
                                    </button>
                                </td>
                            </tr>
...
function savePO() {
    ...
    $.ajax({
        url: '<?php echo e(route("po-penjualan.store")); ?>',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\po_penjualan\create.blade.php ENDPATH**/ ?>