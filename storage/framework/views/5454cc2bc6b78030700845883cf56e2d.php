        ...
        <div class="mb-3 space-y-2 flex-grow">
            ...
            <div class="flex items-center gap-2 bg-blue-50 rounded-lg px-3 py-2">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs font-semibold text-gray-900 truncate"><?php echo e($package->flightDeparture->airline_name ?? 'N/A'); ?></p>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <div class="flex items-start gap-2 bg-amber-50 rounded-lg px-2 py-2">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs font-semibold text-gray-900 truncate leading-tight"><?php echo e($package->hotelMakkah->hotel_name ?? 'N/A'); ?></p>
                        <?php if($package->hotelMakkah && $package->hotelMakkah->star_rating): ?>
                        <div class="flex gap-0.5 mt-0.5">
                            <?php for($i = 0; $i < $package->hotelMakkah->star_rating; $i++): ?>
                ...
                <div class="flex items-start gap-2 bg-emerald-50 rounded-lg px-2 py-2">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs font-semibold text-gray-900 truncate leading-tight"><?php echo e($package->hotelMadinah->hotel_name ?? 'N/A'); ?></p>
                        <?php if($package->hotelMadinah && $package->hotelMadinah->star_rating): ?>
                        <div class="flex gap-0.5 mt-0.5">
                            <?php for($i = 0; $i < $package->hotelMadinah->star_rating; $i++): ?>
                            <i class="fas fa-star text-yellow-400" style="font-size: 8px;"></i>
                            <?php endfor; ?>
                        </div>
                        <?php endif; ?>
            ...
            <div class="mt-2 space-y-1">
                ...
                <div class="flex items-start gap-2 bg-purple-50 rounded-lg px-2 py-2">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs font-semibold text-gray-900 truncate leading-tight"><?php echo e($additionalHotel['hotel_name'] ?? 'N/A'); ?></p>
                        <?php if(isset($additionalHotel['star_rating']) && $additionalHotel['star_rating']): ?>
                        <div class="flex gap-0.5 mt-0.5">
                            <?php for($i = 0; $i < $additionalHotel['star_rating']; $i++): ?>
                            <i class="fas fa-star text-yellow-400" style="font-size: 8px;"></i>
                            <?php endfor; ?>
                        </div>
                        <?php endif; ?>
