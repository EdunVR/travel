...
<head>
    ...
    <script src="<?php echo e(asset('js/datatable-helper.js')); ?>"></script>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <script defer src="https://unpkg.com/@alpinejs/collapse@3.x.x/dist/cdn.min.js"></script>
    <script src="<?php echo e(asset('js/emergency-alpine-datatable-fix.js')); ?>"></script>
    <script src="<?php echo e(asset('js/inter-outlet.js')); ?>"></script>
    <script src="<?php echo e(asset('js/pos.js')); ?>"></script>
    <script defer src="https://unpkg.com/alpinejs@3.x.x/dist/cdn.min.js"></script>
    <script src="<?php echo e(asset('js/outlet-helper.js')); ?>"></script>
    <script src="<?php echo e(asset('js/finance-components.js')); ?>"></script>
    <script src="<?php echo e(asset('js/date-helper.js')); ?>"></script>
    <script src="<?php echo e(asset('js/lazy-loading.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('js/force-24hour-format.js?v=1769175062')); ?>?v=<?php echo e(time()); ?>"></script>
...
<body class="h-full text-ink-900 overflow-x-hidden" x-data="{ loading: true }" x-init="window.addEventListener('load', () => loading = false)">
    ...
    <div id="global-loading" class="fixed inset-0 flex flex-col items-center justify-center bg-white/80 backdrop-blur-md z-[9999] transition-opacity duration-700 opacity-100">
        <div class="relative">
            <img src="<?php echo e(url(asset('img/logo_xx.png'))); ?>" class="w-20 h-20 animate-bounce drop-shadow-lg" />
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views/components/layouts/admin.blade.php ENDPATH**/ ?>