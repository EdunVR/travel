                ...
                <form id="form-setting">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="year" id="year" class="form-control" 
                               value="<?php echo e($currentYear); ?>" min="2020" max="2030" required>
                    </div>
                    ...
                    <a href="<?php echo e(route('sales.invoice.history')); ?>" class="btn btn-default">
...
<script>
    $(function () {
        ...
        $('#form-setting').submit(function(e) {
            ...
            $.post('<?php echo e(route("sales.invoice.update-setting")); ?>', formData, function(response) {
                if (response.success) {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\sales_management\invoice\setting.blade.php ENDPATH**/ ?>