...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Service / History Invoice']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Service / History Invoice']); ?>
    <div x-data="historyData()" x-init="init()" class="space-y-4">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'service.invoice.create')): ?>
                <a href="<?php echo e(route('admin.service.invoice.index')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-blue-600 text-white px-4 py-2 hover:bg-blue-700 shadow-md border border-blue-600">
    ...
    <script>
        function historyData() {
            return {
                ...
                currentStatus: '<?php echo e($status); ?>',
                selectedOutlets: [<?php echo e($selectedOutlet); ?>],
                ...
                async init() {
                    console.log('🚀 Initializing Service History with outlets:', this.selectedOutlets);
                    ...
                    // Load data with the selected outlets
                    await Promise.all([
                        this.fetchData(),
                        this.loadStatusCounts()
                    ]);
                    
                    console.log('✅ Service History initialized with outlets:', this.selectedOutlets);
                ...
                async fetchData() {
                    this.loading = true;
                    console.log('📊 Fetching data with outlets:', this.selectedOutlets, 'status:', this.currentStatus);
                    ...
                    try {
                        ...
                        const response = await fetch(`<?php echo e(route('admin.service.history.data')); ?>?${params}`);
                        const result = await response.json();
                        
                        console.log('📈 Data fetched:', result.data?.length || 0, 'invoices for outlets:', this.selectedOutlets);
                ...
                async loadStatusCounts() {
                    console.log('📊 Loading status counts for outlets:', this.selectedOutlets);
                    ...
                    try {
                        ...
                        const response = await fetch(`<?php echo e(route('admin.service.status-counts')); ?>?${params}`);
                        const data = await response.json();
                        
                        console.log('📈 Status counts loaded:', data);
                ...
                viewPdf(invoiceId) {
                    this.pdfUrl = `<?php echo e(url('/admin/service/invoice')); ?>/${invoiceId}/print`;
                ...
                async submitStatus() {
                    this.saving = true;
                    try {
                        const response = await fetch(`<?php echo e(url('/admin/service/invoice/status')); ?>/${this.statusForm.invoice_id}`, {
                            method: 'POST',
                            headers: {
                ...
                async deleteNow() {
                    ...
                    this.deleting = true;
                    try {
                        const response = await fetch(`<?php echo e(url('/admin/service/invoice')); ?>/${this.toDelete.id}`, {
                            method: 'DELETE',
                            headers: {
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                            }
                ...
                exportData() {
                    ...
                    window.location.href = `<?php echo e(route('admin.service.history.export')); ?>?${params}`;
                },
                ...
                exportPdf() {
                    ...
                    window.open(`<?php echo e(route('admin.service.history.export-pdf')); ?>?${params}`, '_blank');
                },
                ...
                async checkDueSoonInvoices() {
                    try {
                        ...
                        const response = await fetch(`<?php echo e(url('/admin/service/invoice/due-soon')); ?>?${params}`);
                        const result = await response.json();
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\service\history\index.blade.php ENDPATH**/ ?>