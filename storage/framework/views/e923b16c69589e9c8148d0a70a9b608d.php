                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-5">
                            <div class="input-group">
                                <input type="text" class="form-control" id="nama_member" placeholder="Cari Customer..." value="<?php echo e(!empty($memberSelected->nama) ? $memberSelected->nama : ''); ?>">
                    ...
                    <div class="col-lg-4">
                        <form action="<?php echo e(route('transaksi.simpan')); ?>" class="form-penjualan" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" id="piutang" class="form-control" value="<?php echo e($memberSelected->piutang ?? 0); ?>" readonly>
                                    <div class="checkbox">
                                        <label>
...
<?php if ($__env->exists('penjualan_detail.detail')) echo $__env->make('penjualan_detail.detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php if ($__env->exists('penjualan_detail.edit_jumlah')) echo $__env->make('penjualan_detail.edit_jumlah', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if ($__env->exists('penjualan_detail.due_date_modal')) echo $__env->make('penjualan_detail.due_date_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<script>
    ...
    $(function () {
        ...
        const allMembers = <?php echo json_encode($member, 15, 512) ?>; 
        const allProduk = <?php echo json_encode($produk, 15, 512) ?>; 
    ...
    function tambahProduk() {
        ...
        $.post('<?php echo e(route('transaksi.store')); ?>', {
    ...
    function pilihMember(id, nama, piutang, tipe_id) {
        ...
        $.ajax({
            url: '<?php echo e(route('transaksi.index')); ?>', // Ganti dengan route yang sesuai
        ...
        $.ajax({
            url: '<?php echo e(route('hapus.produk')); ?>',
            type: 'POST',
            data: {
    ...
    function loadForm(diskon = 0, diterima = 0) {
        ...
        $.get(`<?php echo e(url('/transaksi/loadform')); ?>/${diskon}/${total}/${diterima}/${piutang}/${isChecked}/${isCheckedIngatkan}`)
            .done(response => {
    ...
    function simpanEditJumlah() {
        ...
        $.ajax({
            url: '<?php echo e(route('transaksi.updateJumlah')); ?>', // Route untuk update jumlah
            type: 'POST',
            data: {
    ...
    function saveTransaction(isChecked, isCheckedIngatkan, piutang, tanggalTempo = null) {
        ...
        $.post('<?php echo e(route('transaksi.updatePiutang')); ?>', formData)
            .done(response => {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\penjualan_detail\index.blade.php ENDPATH**/ ?>