...
<?php $__env->startSection('title', 'Daftar Akun Buku'); ?>
...
$(document).ready(function() {
    ...
    $('#addAccountForm').submit(function(e) {
        e.preventDefault();
        submitAccountForm($(this).serialize(), "<?php echo e(route('financial.book.store_account')); ?>");
    });
    ...
    $(document).on('click', '.delete-account-btn', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo e(route('financial.book.delete_account', '')); ?>/" + code,
                    type: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
    ...
    function generateAccountCode(parentCode, targetSelector) {
        if (!parentCode) {
            ...
            $.get("<?php echo e(route('financial.book.generate_code')); ?>", function(response) {
            ...
            $.get("<?php echo e(route('financial.book.generate_code')); ?>", { 
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\financial\book\accounts.blade.php ENDPATH**/ ?>