...
<?php $__env->startSection('title', 'Profil Investor - Portal Investor'); ?>
    ...
    <main class="p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow p-6 border-l-4 border-green-500 lg:col-span-2">
                ...
                <form action="<?php echo e(route('investor.profile.update')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" value="<?php echo e(auth()->guard('investor')->user()->name); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500">
                        </div>
                        
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Email</label>
                            <input type="email" value="<?php echo e(auth()->guard('investor')->user()->email); ?>"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="phone" value="<?php echo e(auth()->guard('investor')->user()->phone); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500">
                        </div>
                        
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Tanggal Lahir</label>
                            <input type="date" name="birth_date" value="<?php echo e(auth()->guard('investor')->user()->birth_date); ?>"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="address" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"><?php echo e(auth()->guard('investor')->user()->address); ?></textarea>
                    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-purple-500">
                    ...
                    <!-- <a href="<?php echo e(route('investor.password.change')); ?>" class="block w-full px-4 py-2 bg-purple-600 text-white text-center rounded-md hover:bg-purple-700 transition-colors mb-3">
                        <i class="fas fa-key mr-2"></i> Ubah Password
                    </a> -->
                    <form method="POST" action="<?php echo e(route('investor.logout')); ?>" class="w-full">
                        <?php echo csrf_field(); ?>
        ...
        document.getElementById('photo-upload').addEventListener('change', function(e) {
            if (this.files && this.files[0]) {
                ...
                reader.onload = function(event) {
                    ...
                    form.method = 'POST';
                    form.action = "<?php echo e(route('investor.profile.update-photo')); ?>";
...
<?php echo $__env->make('investor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\investor\profile\show.blade.php ENDPATH**/ ?>