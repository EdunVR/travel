...
<?php $__env->startSection('title', 'Login Investor'); ?>

<?php if(auth()->guard('investor')->check()): ?>
    <script>
        window.location.href = "<?php echo e(route('investor.dashboard')); ?>";
    </script>
<?php endif; ?>
...
<div class="auth-wrapper">
    <img class="logo" src="<?php echo e(asset('img/logo_2.png')); ?>" alt="Logo Investor">
    ...
    <div class="login-container">
        ...
        <form action="<?php echo e(route('investor.login')); ?>" method="POST" id="login-form">
            <?php echo csrf_field(); ?>
            ...
            <a href="<?php echo e(route('investor.password.request')); ?>" class="forgot-link">Lupa nomor telepon?</a>
    ...
    <p class="register-text">
        Belum memiliki akun? <a href="<?php echo e(route('investor.register')); ?>" class="register-link">Daftar sebagai investor</a>
    </p>
</div>
...
<?php echo $__env->make('investor.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\investor\auth\login.blade.php ENDPATH**/ ?>