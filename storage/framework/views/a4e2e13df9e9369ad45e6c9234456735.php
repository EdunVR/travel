...
<head>
    ...
    <title>Neraca - <?php echo e($accountingBook->name); ?></title>
    <style>
        body {
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="asset-account">
                        <td><?php echo e($asset['code']); ?> <?php echo e($asset['name']); ?></td>
                        <td class="text-right"><?php echo e(number_format($asset['amount'], 2)); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <tr class="summary-row">
                        <td class="text-center"><strong>TOTAL AKTIVA LANCAR</strong></td>
                        <td class="text-right"><?php echo e(number_format($balanceSheetData['assets']['total_current'], 2)); ?></td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    ...
                    <tr class="summary-row">
                        ...
                        <td class="text-right"><?php echo e(number_format($balanceSheetData['assets']['total_fixed'], 2)); ?></td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    ...
                    <tr class="summary-row">
                        ...
                        <td class="text-right"><?php echo e(number_format($balanceSheetData['assets']['total_other'], 2)); ?></td>
                    </tr>
                </tbody>
                <?php endif; ?>
                ...
                <tfoot>
                    <tr class="total-row">
                        ...
                        <td class="text-right"><?php echo e(number_format($balanceSheetData['assets']['total_assets'], 2)); ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="liability-account">
                        <td><?php echo e($liability['code']); ?> <?php echo e($liability['name']); ?></td>
                        <td class="text-right"><?php echo e(number_format($liability['amount'], 2)); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <tr class="summary-row">
                        <td class="text-center"><strong>TOTAL KEWAJIBAN LANCAR</strong></td>
                        <td class="text-right"><?php echo e(number_format($balanceSheetData['liabilities']['total_current'], 2)); ?></td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    ...
                    <tr class="summary-row">
                        ...
                        <td class="text-right"><?php echo e(number_format($balanceSheetData['liabilities']['total_long_term'], 2)); ?></td>
                    </tr>
                </tbody>
                ...
                <tr class="summary-row">
                    ...
                    <td class="text-right"><?php echo e(number_format($balanceSheetData['liabilities']['total_liabilities'], 2)); ?></td>
                </tr>
                ...
                <tbody>
                    ...
                    <tr class="equity-account">
                        <td><?php echo e($equity['code']); ?> <?php echo e($equity['name']); ?></td>
                        <td class="text-right"><?php echo e(number_format($equity['amount'], 2)); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <tr class="summary-row">
                        <td class="text-center"><strong>TOTAL MODAL</strong></td>
                        <td class="text-right"><?php echo e(number_format($balanceSheetData['equities']['total_equities'], 2)); ?></td>
                    </tr>
                </tbody>
                ...
                <tfoot>
                    <tr class="total-row">
                        ...
                        <td class="text-right"><?php echo e(number_format($balanceSheetData['total_liabilities_equities'], 2)); ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\financial\balance-sheet\export_pdf.blade.php ENDPATH**/ ?>