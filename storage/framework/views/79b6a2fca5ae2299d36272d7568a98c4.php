...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Pohon Jenjang Mitra']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Pohon Jenjang Mitra')]); ?>
...
<div class="flex items-center justify-between px-6 py-3 bg-white border-b border-slate-200 flex-shrink-0">
        ...
        <div class="flex gap-2">
            ...
            <a href="<?php echo e(route('admin.inventaris.affiliate.hierarchy.settings')); ?>"
...
const DATA_URL  = '<?php echo e(route("admin.inventaris.affiliate.hierarchy.tree.data")); ?>';
const FEE_URL   = '<?php echo e(route("admin.inventaris.affiliate.hierarchy.fee.save")); ?>';
const VIEW_BASE = '<?php echo e(url("admin/inventaris/affiliate")); ?>';
const UPD_BASE  = '<?php echo e(url("admin/inventaris/affiliate")); ?>';
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\affiliate\hierarchy-tree.blade.php ENDPATH**/ ?>