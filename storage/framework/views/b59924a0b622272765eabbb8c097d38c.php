...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Laporan Arus Kas']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Laporan Arus Kas')]); ?>
      ...
      return {
        ...
        async loadBooks() {
          ...
          try {
            ...
            const response = await fetch(`<?php echo e(route('finance.active-books.data')); ?>?${params}`);
            const result = await response.json();
            if (result.success) {
        ...
        async loadCashFlowData() {
            ...
            try {
                ...
                const response = await fetch(`<?php echo e(route('finance.cashflow.data')); ?>?${params}`);
                const result = await response.json();
        ...
        async showAccountTransactions(accountId, accountCode, accountName) {
          ...
          try {
            ...
            if (accountName && accountName.toLowerCase().includes('pembelian aset tetap')) {
              url = `<?php echo e(route('finance.cashflow.fixed-asset-purchases')); ?>?${params}`;
            } else {
              url = `<?php echo e(route('finance.cashflow.account-details', '')); ?>/${accountId}?${params}`;
            }
        ...
        exportPDF() {
          ...
          window.open(`<?php echo e(route('finance.cashflow.export.pdf')); ?>?${params}`, '_blank');
        },
        ...
        exportExcel() {
          ...
          window.location.href = `<?php echo e(route('finance.cashflow.export.xlsx')); ?>?${params}`;
        },
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\finance\cashflow\index.blade.php ENDPATH**/ ?>