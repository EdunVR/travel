                ...
                <tr>
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td class="text-center">
                            <div class="box">
                                <img src="<?php echo e(asset($setting->path_kartu_member)); ?>" alt="card" width="50%">
                                <div class="logo">
                                    <p><?php echo e($setting->nama_perusahaan); ?></p>
                                    <img src="<?php echo e(asset($setting->path_logo)); ?>" alt="logo">
                                </div>
                                <div class="nama"><?php echo e($item->nama); ?></div>
                                <div class="telepon"><?php echo e($item->telepon); ?></div>
                                <div class="barcode text-left">
                                    <img src="data:image/png;base64, <?php echo e(DNS2D::getBarcodePNG("$item->kode_member", 'QRCODE')); ?>"
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\member\cetak.blade.php ENDPATH**/ ?>