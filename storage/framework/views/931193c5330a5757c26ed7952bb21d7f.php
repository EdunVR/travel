...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Inventaris / Outlet']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Inventaris / Outlet')]); ?>
  <div x-data="outletCrud()" x-init="init()" class="space-y-4 overflow-x-hidden">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="flex flex-wrap gap-2">
        <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'inventaris.outlet.create')): ?>
        ...
        <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'inventaris.outlet.export')): ?>
        ...
        <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'inventaris.outlet.import')): ?>
        ...
        <template x-for="o in outlets" :key="o.id">
          <div class="rounded-2xl border border-slate-200 bg-white shadow-card hover:shadow-[0_14px_40px_rgba(15,23,42,.10)] transition p-4">
            ...
            <div class="mt-3 flex gap-2">
              <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'inventaris.outlet.edit')): ?>
              ...
              <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'inventaris.outlet.delete')): ?>
      ...
      return {
        ...
        async fetchData(){
          ...
          try {
            ...
            const response = await fetch(`<?php echo e(route('admin.inventaris.outlet.data')); ?>?${params}`);
        ...
        async fetchCities(){
          try {
            const response = await fetch('<?php echo e(route("admin.inventaris.outlet.cities")); ?>');
            const data = await response.json();
            this.cities = data;
          } catch (error) {
        ...
        async openCreate(){ 
          try {
              ModalLoader.show();
              const response = await fetch('<?php echo e(route("admin.inventaris.outlet.generate-kode")); ?>');
              const data = await response.json();
        ...
        async submitForm(){
          ...
          try {
            const url = this.form.id 
              ? `<?php echo e(route('admin.inventaris.outlet.update', '')); ?>/${this.form.id}`
              : '<?php echo e(route("admin.inventaris.outlet.store")); ?>';
        ...
        async deleteNow(){
          ...
          this.deleting = true;
          try {
            const response = await fetch(`<?php echo e(route('admin.inventaris.outlet.destroy', '')); ?>/${this.toDelete.id}`, {
              method: 'DELETE',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json'
        ...
        exportPdf(){
          ...
          window.open(`<?php echo e(route('admin.inventaris.outlet.export.pdf')); ?>?${params}`, '_blank');
        },
        ...
        exportExcel(){
          ...
          window.open(`<?php echo e(route('admin.inventaris.outlet.export.excel')); ?>?${params}`, '_blank');
        },
        ...
        async importExcel(event){
          ...
          try {
            const response = await fetch('<?php echo e(route("admin.inventaris.outlet.import.excel")); ?>', {
              method: 'POST',
              headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
              },
        ...
        downloadTemplate(){
          window.open('<?php echo e(route("admin.inventaris.outlet.download-template")); ?>', '_blank');
        },
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views/admin/inventaris/outlet/index.blade.php ENDPATH**/ ?>