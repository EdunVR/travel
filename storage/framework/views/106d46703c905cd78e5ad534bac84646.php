...
<head>
    <meta charset="utf-8">
    <title>Neraca Saldo - <?php echo e($outlet_name); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="info-section">
        ...
        <div class="info-row">
            ...
            <div class="info-value"><?php echo e($book_name); ?></div>
        </div>
        <div class="info-row">
    ...
    <table class="main-table">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $trialBalanceData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                ...
                <td class="text-right <?php echo e($account['opening_balance'] < 0 ? 'amount-negative' : ''); ?>">
                    <?php echo e(number_format($account['opening_balance'], 0, ',', '.')); ?>

                </td>
                <td class="text-right amount-debit">
                    <?php echo e(number_format($account['debit'], 0, ',', '.')); ?>

                </td>
                <td class="text-right amount-credit">
                    <?php echo e(number_format($account['credit'], 0, ',', '.')); ?>

                </td>
                <td class="text-right amount-balance <?php echo e($account['ending_balance'] < 0 ? 'amount-negative' : ''); ?>">
        ...
        <?php if(count($trialBalanceData) > 0): ?>
        <tfoot>
            <tr>
                <td colspan="4" style="text-align: right; font-weight: 700;">TOTAL</td>
                <td class="text-right"><?php echo e(number_format($summary['total_debit'], 0, ',', '.')); ?></td>
                <td class="text-right"><?php echo e(number_format($summary['total_credit'], 0, ',', '.')); ?></td>
                <td class="text-right"><?php echo e(number_format($summary['total_debit'] - $summary['total_credit'], 0, ',', '.')); ?></td>
            </tr>
        </tfoot>
        <?php endif; ?>
    </table>
        ...
        <div class="summary-left">
            <div class="summary-box">
                ...
                <div class="summary-item">
                    ...
                    <span class="summary-value amount-debit">Rp <?php echo e(number_format($summary['total_debit'], 0, ',', '.')); ?></span>
                </div>
                <div class="summary-item">
                    <span class="summary-label">Total Kredit:</span>
                    <span class="summary-value amount-credit">Rp <?php echo e(number_format($summary['total_credit'], 0, ',', '.')); ?></span>
                </div>
                <div class="summary-item">
                    <span class="summary-label">Selisih:</span>
                    <span class="summary-value <?php echo e($summary['is_balanced'] ? 'balanced' : 'unbalanced'); ?>">
                        Rp <?php echo e(number_format($summary['difference'], 0, ',', '.')); ?>
        ...
        <div class="summary-right">
            <div class="summary-box">
                ...
                <div class="summary-item">
                    ...
                    <span class="summary-value <?php echo e($summary['is_balanced'] ? 'balanced' : 'unbalanced'); ?>">
                        <?php echo e($summary['is_balanced'] ? '✓ Seimbang' : '⚠ Tidak Seimbang'); ?>

                    </span>
                </div>
                <div class="summary-item">
                    <span class="summary-label">Total Akun:</span>
                    <span class="summary-value"><?php echo e(count($trialBalanceData)); ?> Akun</span>
                </div>
                <div class="summary-item">
                    <span class="summary-label">Periode:</span>
                    <span class="summary-value"><?php echo e(\Carbon\Carbon::parse($start_date)->diffInDays(\Carbon\Carbon::parse($end_date)) + 1); ?> Hari</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Footer -->
    <div class="footer">
        <p><strong><?php echo e($companySettings['company_name'] ?? 'Nama Perusahaan'); ?></strong> - Neraca Saldo</p>
        <p>Dokumen ini dicetak secara otomatis oleh sistem pada <?php echo e($print_date); ?></p>
        <p>Halaman ini merupakan dokumen resmi dan sah untuk keperluan akuntansi</p>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\finance\neraca-saldo\pdf.blade.php ENDPATH**/ ?>