...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Kelola Room Position']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Kelola Room Position')]); ?>
  ...
  function roomManager() {
    return {
      ...
      async loadData() {
        this.loading = true;
        try {
          const res = await fetch(`<?php echo e(url('')); ?>/admin/inventaris/travel/document/${this.keberangkatanId}/room-assignments`, {
      ...
      async autoAssign(cityType) {
        this.loading = true;
        try {
          const res = await fetch(`<?php echo e(url('')); ?>/admin/inventaris/travel/document/${this.keberangkatanId}/room-assignments/auto`, {
            method: 'POST',
      ...
      exportPdf() {
        window.open(`<?php echo e(url('')); ?>/admin/inventaris/travel/keberangkatan/${this.keberangkatanId}/roomlist-stream`, '_blank');
      },
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views/admin/travel/document/manage-room-position.blade.php ENDPATH**/ ?>