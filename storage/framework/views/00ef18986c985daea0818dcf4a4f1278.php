...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Hutang']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Hutang')]); ?>
    ...
    function hutangManagement() {
      return {
        routes: {
          ...
          hutangData: '<?php echo e(route("finance.hutang.data")); ?>',
          hutangDetail: '<?php echo e(route("finance.hutang.detail", ":id")); ?>',
          poIndex: '<?php echo e(route("pembelian.purchase-order.index")); ?>',
          poPrint: '<?php echo e(route("pembelian.purchase-order.print", ":id")); ?>'
        },
        filters: {
          outlet_id: '',
          status: 'all',
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\finance\hutang\index.blade.php ENDPATH**/ ?>