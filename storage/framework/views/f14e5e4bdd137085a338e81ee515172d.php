        ...
        <div class="box">
            <div class="box-header with-border">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="product_type" id="product_type" class="form-control">
                            ...
                            <?php $__currentLoopData = $productTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="btn-group mt-3">
                    <a href="#" onclick="addForm('<?php echo e(route('produk.store')); ?>')"
                        class="btn btn-success btn-sm btn-flat">
                        <i data-feather="plus-circle"></i> Tambah
                    </a>
                    <button onclick="deleteSelected('<?php echo e(route('produk.delete_selected')); ?>')"
                        class="btn btn-danger btn-sm btn-flat">
                        <i data-feather="trash-2"></i> Hapus
                    </button>
                    <button onclick="cetakBarcode('<?php echo e(route('produk.cetak_barcode')); ?>')"
...
<?php if ($__env->exists('produk.detail')) echo $__env->make('produk.detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php if ($__env->exists('produk.form')) echo $__env->make('produk.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php if ($__env->exists('produk.form_hpp')) echo $__env->make('produk.form_hpp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php if ($__env->exists('produk.rab_form')) echo $__env->make('produk.rab_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php if ($__env->exists('produk.images_form')) echo $__env->make('produk.images_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php if ($__env->exists('produk.create-modal')) echo $__env->make('produk.create-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php $__env->stopSection(); ?>
                                        ...
                                        columns: [{
                                            ...
                                            },
                                            {
                                                ...
                                                render: function(data, type, full, meta) {
                                                    if (data) {
                                                        const imgUrl = `<?php echo e(asset('storage')); ?>/${data}`;
                                                        return `
                                                    ...
                                                    return `<img src="<?php echo e(asset('img/no-image.png')); ?>" alt="No Image" class="img-thumbnail" width="50">`;
                                                }
                                            },
                                            {
                                                data: 'kode_produk'
                    ...
                    `);
                                ...
                                function addFormHpp() {
                                    ...
                                    $('#modal-form-hpp form').attr('action',
                                        '<?php echo e(route('produk.store_hpp')); ?>');
                                    ...
                                    $.get(`${baseUrl}/produk/${productId}/images`)
                                        .done((images) => {
                                            ...
                                            images.forEach((image, index) => {
                                                ...
                                                const imgUrl = `<?php echo e(asset('storage')); ?>/${image.path}`;
                                                container.append(`
                                ...
                                function editForm_hpp(url) {
                                    ...
                                    $.get(url)
                                        .done((response) => {
                                            ...
                                            $('#modal-form-hpp form').attr('action',
                                                "<?php echo e(route('produk.update_hpp', '')); ?>/" +
                                                response.id_hpp);
                                            table.ajax.reload();
                                        })
                                        .fail((errors) => {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\produk\index.blade.php ENDPATH**/ ?>