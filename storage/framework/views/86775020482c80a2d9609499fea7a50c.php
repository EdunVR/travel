...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            ...
            <a href="<?php echo e(route('manajemen-gudang.daftar-permintaan')); ?>" class="btn btn-info">
                Lihat Daftar Permintaan 
                <span class="badge bg-danger"><?php echo e(\App\Models\PermintaanPengiriman::where('status', 'menunggu')->count()); ?></span>
            </a>
            </div>
            <div class="box-body">
                <div class="outlet-container">
                    ...
                    <div class="outlet-column">
                        ...
                        <select id="outlet-tujuan" class="form-control">
                            <?php $__currentLoopData = $outlet_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php if ($__env->exists('gudang.jumlah')) echo $__env->make('gudang.jumlah', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadItems(outletId, targetElement, target) {
                $.ajax({
                    url: '<?php echo e(route('manajemen-gudang.get-items')); ?>',
                    type: 'GET',
                    data: {
                        id_outlet: outletId,
                        target: target
            ...
            $('#btn-submit-jumlah').on('click', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('manajemen-gudang.buat-permintaan')); ?>',
                    type: 'POST',
                    data: data,
                    success: function(response) {
                        alert(response.message);
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\im\manajemen_stok\index.blade.php ENDPATH**/ ?>