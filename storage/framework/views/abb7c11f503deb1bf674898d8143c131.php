    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <?php endif; ?>
                <div class="btn-group">
                    <button onclick="addForm('<?php echo e(route('bahan.store')); ?>')"
                        class="btn-success btn-xs btn-flat"><i class="fa fa-plus-circle"></i> Tambah Bahan</button>
                    <button onclick="deleteSelected('<?php echo e(route('bahan.delete_selected')); ?>')"
...
<?php if ($__env->exists('bahan.detail')) echo $__env->make('bahan.detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if ($__env->exists('bahan.form')) echo $__env->make('bahan.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if ($__env->exists('bahan.form_harga')) echo $__env->make('bahan.form_harga', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php $__env->stopSection(); ?>
        ...
        <script>
            ...
            $(function () {
                table = $('.table-bahan').DataTable({
                    ...
                    autoWidth: false,
                    ajax: {
                        url: '<?php echo e(route('bahan.data')); ?>',
                        data: function (d) {
            ...
            function editForm(url) {
                ...
                $.get(url)
                    .done((response) => {
                        ...
                        $('#modal-formx form').attr('action', "<?php echo e(url('bahan')); ?>/" + response.id_bahan);
                    })
                    .fail((errors) => {
                ...
                $.get(url)
                    .done((response) => {
                        ...
                        $('#modal-form-harga .btn-primary').on('click', function(e) {
                            ...
                            $.ajax({
                                url: "<?php echo e(url('bahan_harga')); ?>/" + response.id,
                                method: 'PUT',
                                data: dataX,
                                headers: {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\bahan\index.blade.php ENDPATH**/ ?>