                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="produk-info">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <select name="id_satuan" id="id_satuan" class="form-control" required>
                                        ...
                                        <?php $__currentLoopData = $satuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>"><?php echo e($item); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <span class="help-block with-errors"></span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <textarea class="form-control" id="spesifikasi" name="spesifikasi" rows="3"><?php echo e(old('spesifikasi')); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="produk-images">
                            ...
                            <div class="row mt-3" id="image-preview-container">
                                <?php for($i = 0; $i < 4; $i++): ?>
                                <div class="col-md-3 mb-3 image-placeholder" data-index="<?php echo e($i); ?>">
                                    <input type="file" name="images[]" id="product-image-<?php echo e($i); ?>" 
                                        class="d-none" accept="image/*" data-index="<?php echo e($i); ?>">
                                    <div class="card h-100">
                                        <div class="card-body d-flex align-items-center justify-content-center bg-light" 
                                            style="min-height: 150px; cursor: pointer;" 
                                            onclick="triggerFileInput(<?php echo e($i); ?>)">
                        ...
                        <div role="tabpanel" class="tab-pane" id="variants">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="variant-table">
                                    ...
                                    <tbody>
                                        <?php if(isset($produk) && $produk->variants->count() > 0): ?>
                                            <?php $__currentLoopData = $produk->variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <input type="text" name="variants[<?php echo e($index); ?>][nama_varian]" 
                                                        class="form-control" value="<?php echo e($variant->nama_varian); ?>" required>
                                                </td>
                                                <td>
                                                    <textarea name="variants[<?php echo e($index); ?>][deskripsi]" 
                                                        class="form-control"><?php echo e($variant->deskripsi); ?></textarea>
                                                </td>
                                                <td>
                                                    <input type="text" name="variants[<?php echo e($index); ?>][harga]" 
                                                        class="form-control variant-price" 
                                                        value="<?php echo e(format_uang($variant->harga)); ?>"
                                                        <?php echo e($variant->is_default ? 'readonly' : ''); ?>>
                                                </td>
                                                <td class="text-center">
                                                    <input type="radio" name="is_default" value="<?php echo e($index); ?>" 
                                                        <?php echo e($variant->is_default ? 'checked' : ''); ?>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\produk\form.blade.php ENDPATH**/ ?>