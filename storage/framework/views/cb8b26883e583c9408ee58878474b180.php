...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Riwayat POS']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Riwayat POS')]); ?>
  ...
  return {
    ...
    initDataTable(){
      this.table = $('#posHistoryTable').DataTable({
        ...
        serverSide: true,
        ajax: {
          url: '<?php echo e(route("admin.penjualan.pos.history.data")); ?>',
          data: (d) => {
    ...
    async viewDetail(id){
      try {
        const response = await fetch(`<?php echo e(url('penjualan/pos')); ?>/${id}`);
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\penjualan\pos\history.blade.php ENDPATH**/ ?>