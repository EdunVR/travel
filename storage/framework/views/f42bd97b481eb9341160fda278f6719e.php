...
<head>
    <meta charset="utf-8">
    <title>Stiker Koper - <?php echo e($keberangkatan->keberangkatan_name); ?></title>
    <style>
...
<?php $__currentLoopData = $chunks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunkIdx => $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php $rows = array_chunk($chunk, 2); ?>

<div class="grid">
<?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowIdx => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="grid-row">
        <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="grid-cell">
            <div class="stiker">
                ...
                <div class="kop">
                    ...
                    <?php endif; ?>
                    <div class="kop-text">
                        <div class="kop-nama"><?php echo e(strtoupper($companyName)); ?></div>
                        <div class="kop-paket"><?php echo e($packageName); ?></div>
                    </div>
                ...
                <div class="footer-stiker">
                    <div class="footer-left">
                        ...
                        <div class="footer-val"><?php echo e($departure); ?></div>
                        <div class="footer-lbl" style="margin-top:1px;">Kembali</div>
                        <div class="footer-val"><?php echo e($return); ?></div>
                    </div>
                    <div class="footer-right">
                        <span class="badge badge-<?php echo e($packageType); ?>"><?php echo e(strtoupper($packageType)); ?></span><br>
                        <span class="room-badge"><?php echo e($j['room_type']); ?></span><br>
                        <div class="no-urut">No. <?php echo e($j['no']); ?> &nbsp;|&nbsp; <?php echo e($kode); ?></div>
                    </div>
                    <div class="clearfix"></div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\travel\document\stiker-koper-pdf.blade.php ENDPATH**/ ?>