    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <button onclick="addForm('<?php echo e(route('sales.customer-price.store')); ?>')" class="btn btn-success btn-xs btn-flat">
...
<?php if ($__env->exists('sales_management.customer_price.form')) echo $__env->make('sales_management.customer_price.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<script>
    ...
    $(function () {
        table = $('#table-customer-price').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('sales.customer-price.index')); ?>',
            },
            columns: [
    ...
    const editUrl = '<?php echo e(route("sales.customer-price.edit", ":id")); ?>'.replace(':id', id);
    ...
    function loadCustomersCustomerPrice(search = '', page = 1) {
        ...
        $.get('<?php echo e(route("sales.customer-price.get-customers")); ?>', { 
            search: search,
            page: page 
        }, function(response) {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\sales_management\customer_price\index.blade.php ENDPATH**/ ?>