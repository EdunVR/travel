            ...
            <form method="GET" class="form-inline float-right">
                <div class="form-group mr-2">
                    <select name="account" class="form-control form-control-sm">
                        ...
                        <?php $__currentLoopData = $investor->accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($acc->id); ?>" <?php echo e(request('account') == $acc->id ? 'selected' : ''); ?>>
                                <?php echo e($acc->bank_name); ?> - <?php echo e($acc->account_number); ?>
                ...
                <div class="form-group mr-2">
                    <select name="type" class="form-control form-control-sm">
                        ...
                        <option value="investment" <?php echo e(request('type') == 'investment' ? 'selected' : ''); ?>>Investasi</option>
                        <option value="deposit" <?php echo e(request('type') == 'deposit' ? 'selected' : ''); ?>>Bagi Hasil</option>
                        <option value="withdrawal" <?php echo e(request('type') == 'withdrawal' ? 'selected' : ''); ?>>Pencairan</option>
                        <option value="penarikan" <?php echo e(request('type') == 'penarikan' ? 'selected' : ''); ?>>Penarikan Modal</option>
                    </select>
                </div>
                <div class="form-group mr-2">
                    <input type="date" name="start_date" class="form-control form-control-sm" 
                           value="<?php echo e(request('start_date')); ?>" placeholder="Dari Tanggal">
                </div>
                <div class="form-group mr-2">
                    <input type="date" name="end_date" class="form-control form-control-sm" 
                           value="<?php echo e(request('end_date')); ?>" placeholder="Sampai Tanggal">
                </div>
                <button type="submit" class="btn btn-sm btn-info mr-2">
                    <i class="fas fa-filter"></i> Filter
                </button>
                <a href="<?php echo e(route('irp.investor.show', $investor->id)); ?>" class="btn btn-sm btn-secondary">
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo e($transaction->bank_name); ?><br>
                        <small><?php echo e($transaction->account_number); ?></small>
                    </td>
                    <td>
                    ...
                    <td class="text-right">
                        <?php if($transaction->type == 'investment' || $transaction->type == 'deposit'): ?>
                    ...
                    <td class="text-right">
                        <?php if($transaction->type == 'withdrawal' || $transaction->type == 'penarikan'): ?>
                            <?php echo e(format_uang($transaction->amount)); ?>
                    ...
                    <td class="text-right">
                        <?php if($transaction->type == 'investment' || $transaction->type == 'penarikan'): ?>
                    ...
                    <td class="text-right">
                        <?php if($transaction->type == 'deposit' || $transaction->type == 'withdrawal'): ?>
                    ...
                    <td>
                        <button class="btn btn-sm btn-warning edit-transaction" 
                                ...
                                data-account-id="<?php echo e($transaction->account_id); ?>"
                                data-toggle="modal" 
                                data-target="#editTransactionModal">
                            <i class="fas fa-edit"></i>
                        </button>
                        <form class="d-inline delete-form" 
                            action="<?php echo e(route('irp.investor.account.investment.destroy', [
...
<?php echo $__env->make('irp.investor.partials.profit_modal', ['investor' => $investor, 'accounts' => $investor->accounts], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div class="modal fade" id="addTransactionModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('irp.investor.account.investment.store', ['investor' => $investor->id, 'account' => ':accountId'])); ?>" id="addTransactionForm" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="account_id" class="form-control" required>
                            <?php $__currentLoopData = $investor->accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($account->id); ?>"><?php echo e($account->bank_name); ?> - <?php echo e($account->account_number); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Tanggal*</label>
                        <input type="date" name="date" class="form-control" required value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                    <div class="form-group">
...
$(document).ready(function() {
    ...
    $('.edit-transaction').click(function() {
        ...
        $.get("<?php echo e(route('irp.investor.account.investment.edit', [
            'investor' => $investor->id,
            'account' => ':accountId',
        ...
        function(data) {
            ...
            $('#editTransactionForm').attr('action', 
                "<?php echo e(url('irp/investor')); ?>/<?php echo e($investor->id); ?>/accounts/" + 
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\irp\investor\partials\profit_sharing.blade.php ENDPATH**/ ?>