...
<?php $__env->startSection('title', 'Manajemen Bagi Hasil'); ?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                    <a class="nav-link <?php echo e($activeTab === 'group' ? 'active' : ''); ?>" 
                       href="<?php echo e(route('irp.profit-management.index', ['tab' => 'group'])); ?>">
                       <i data-feather="users" class="icon-sm"></i> Bagi Hasil Kelompok
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e($activeTab === 'history' ? 'active' : ''); ?>" 
                       href="<?php echo e(route('irp.profit-management.index', ['tab' => 'history'])); ?>">
                       <i data-feather="clock" class="icon-sm"></i> History Bagi Hasil
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e($activeTab === 'category' ? 'active' : ''); ?>" 
                       href="<?php echo e(route('irp.profit-management.index', ['tab' => 'category'])); ?>">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card group-card h-100">
                        <div class="card-header group-card-header bg-primary text-white d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-1">
                                <span class="badge badge-light text-dark" title="Jumlah Investor">
                                    ...
                                    Jumlah Investor: <?php echo e($group->unique_investors_count); ?>
                                ...
                                <span class="badge badge-light text-dark" title="Jumlah Rekening Valid">
                                    ...
                                    Jumlah Rekening: <?php echo e($group->valid_accounts_count); ?>
                        ...
                        <div class="card-body group-card-body">
                            ...
                            <?php endif; ?>
                            <p><strong>Total Investasi:</strong> <?php echo e(format_uang($group->total_investment_fix)); ?></p>
                            <div class="mt-3">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover" id="historyTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($index + $histories->firstItem()); ?></td>
                            <td>
                                <?php if($history->group): ?>
                                    <div class="font-weight-bold"><?php echo e($history->group->name); ?></div>
                                    <?php if($history->group->product): ?>
                                    <small class="text-muted"><?php echo e($history->group->product->nama_produk); ?></small>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <span class="text-danger">Kelompok telah dihapus</span>
                                <?php endif; ?>
                            </td>
                            <td><?php echo e($history->period); ?></td>
                            <td class="text-right font-weight-bold">Rp <?php echo e(number_format($history->total_profit, 0, ',', '.')); ?></td>
                            <td class="text-right"><?php echo e($history->distributions->unique('investor_id')->count()); ?></td>
                            <td class="text-right"><?php echo e($history->distributions->whereNotNull('account_id')->count()); ?></td>
                            <td><?php echo e($history->distribution_date->format('d/m/Y')); ?></td>
                            <td>
                            ...
                            <td class="text-center">
                                <?php if($history->proof_file): ?>
                                    <a href="<?php echo e(asset('storage/'.$history->proof_file)); ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                            ...
                            <td>
                                <div class="d-flex justify-content-start gap-2">  <!-- Changed justify-content-center to justify-content-start -->
                                    <?php if($history->group): ?>
                                    <a href="<?php echo e(route('irp.profit-management.show-group-history', $history->id)); ?>" 
                                    ...
                                    <?php endif; ?>
                                    <?php if(in_array($history->status, ['processed', 'paid'])): ?>
                                    <form class="form-cancel-payment d-inline" action="<?php echo e(route('irp.profit-management.cancel-payment-group', $history->id)); ?>" 
                                        method="POST">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if($history->status !== 'paid'): ?>
                                    <form class="form-delete-history d-inline" action="<?php echo e(route('irp.profit-management.delete-history', $history->id)); ?>" 
                                        method="POST">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                ...
                <div class="mt-3">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="text-muted">
                            Menampilkan <?php echo e($histories->firstItem()); ?> sampai <?php echo e($histories->lastItem()); ?> dari <?php echo e($histories->total()); ?> entri
                        </div>
                        <nav>
                            <?php echo e($histories->onEachSide(1)->links('pagination::bootstrap-4')); ?>
...
<div class="modal fade" id="createGroupModal" tabindex="-1" role="dialog" aria-labelledby="createGroupModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="createGroupForm" action="<?php echo e(route('irp.profit-management.store-group')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php if ($__env->exists('irp.profit_management.edit_group_modal')) echo $__env->make('irp.profit_management.edit_group_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
$(document).ready(function() {
    ...
    const availableInvestors = <?php echo json_encode($investors->map(function($investor) {
        return [
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\irp\profit_management\index.blade.php ENDPATH**/ ?>