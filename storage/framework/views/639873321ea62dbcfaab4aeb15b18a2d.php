...
<?php if ($__env->exists('kontra_bon.form')) echo $__env->make('kontra_bon.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    function initializeDataTables() {
        tablePiutang = $('.table-piutang').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('kontra_bon.data')); ?>',
                data: function (d) {
        ...
        tableKontraBon = $('.table-kontrabon').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('kontra_bon.data_kontra_bon')); ?>',
                data: function (d) {
    ...
    function addForm() {
        window.location.href = '<?php echo e(route('kontra_bon.create')); ?>';
    }
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\kontra_bon\index.blade.php ENDPATH**/ ?>