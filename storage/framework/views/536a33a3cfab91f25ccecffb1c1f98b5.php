...
<body>
    <div class="header">
        <h2>ROOM LIST - <?php echo e(strtoupper($keberangkatan->keberangkatan_name)); ?></h2>
        <div class="sub">
            Keberangkatan: <?php echo e($keberangkatan->departure_date->format('d F Y')); ?>

            <?php if($keberangkatan->return_date): ?> &nbsp;|&nbsp; Kepulangan: <?php echo e($keberangkatan->return_date->format('d F Y')); ?> <?php endif; ?>
            &nbsp;|&nbsp; Paket: <?php echo e($keberangkatan->travelPackage->package_name ?? '-'); ?>
    ...
    <table style="width:100%; border-collapse:collapse; margin-top:8px; font-size:7.5pt;">
        <tr>
            <?php $__currentLoopData = ['madinah' => ['label'=>'RINGKASAN HOTEL MADINAH','bg'=>'#92D050'], 'makkah' => ['label'=>'RINGKASAN HOTEL MAKKAH','bg'=>'#F4B084']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ct => $cfg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <td style="width:50%; <?php echo e($ct === 'madinah' ? 'padding-right:4px;' : ''); ?> vertical-align:top;">
                <div style="border:1px solid #999;">
                    <div style="background:<?php echo e($cfg['bg']); ?>;color:#000;font-weight:bold;padding:3px 6px;text-align:center;"><?php echo e($cfg['label']); ?></div>
                    <?php if(!empty($summaryByHotel[$ct])): ?>
                        <?php $__currentLoopData = $summaryByHotel[$ct]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hotelName => $typeData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div style="background:#f8f8f8;padding:2px 5px;font-weight:bold;font-size:7pt;border-bottom:1px solid #ddd;"><?php echo e($hotelName); ?></div>
                        <table style="width:100%;border-collapse:collapse;font-size:7pt;">
                            ...
                            <?php $__currentLoopData = $typeData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $cap=match($type){'single'=>1,'double'=>2,'triple'=>3,'quad'=>4,default=>2}; $bgS=match($type){'double'=>'background:#5B9BD5;color:white;','triple'=>'background:#FFFF00;color:#333;','quad'=>'background:#00B050;color:white;',default=>''}; ?>
                            <tr>
                                <td style="border:1px solid #ddd;padding:2px 4px;<?php echo e($bgS); ?>font-weight:bold;text-align:center;"><?php echo e(strtoupper($type)); ?></td>
                                <td style="border:1px solid #ddd;padding:2px 4px;text-align:center;"><?php echo e($cap); ?></td>
                                <td style="border:1px solid #ddd;padding:2px 4px;text-align:center;"><?php echo e($info['rooms'] ?? '-'); ?></td>
                                <td style="border:1px solid #ddd;padding:2px 4px;text-align:center;"><?php echo e($info['persons']); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <tr style="background:#f0f4ff;font-weight:bold;">
                                <td style="border:1px solid #ddd;padding:2px 4px;" colspan="2">Sub Total</td>
                                <td style="border:1px solid #ddd;padding:2px 4px;text-align:center;"><?php echo e(array_sum(array_column($typeData,'rooms'))); ?></td>
                                <td style="border:1px solid #ddd;padding:2px 4px;text-align:center;"><?php echo e(array_sum(array_column($typeData,'persons'))); ?></td>
                            </tr>
                        </table>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div style="background:#4472C4;color:white;font-weight:bold;padding:2px 5px;font-size:7pt;text-align:right;">
                            TOTAL: <?php echo e($ctTotalRooms); ?> kamar &nbsp;|&nbsp; <?php echo e($ctTotalPersons); ?> jiwa
                        </div>
                    <?php else: ?>
    ...
    <table class="roomlist" style="margin-top:10px;">
        ...
        <tbody>
            ...
            <?php $isFirst = $firstInGroup[$idx] ?? true; $span = $groupSpan[$idx] ?? 1; ?>
            <tr <?php if($row['type'] === 'family'): ?> class="family-row" <?php endif; ?>>
                
                <?php if($isFirst): ?>
                <td class="room-position-cell" <?php if($span > 1): ?> rowspan="<?php echo e($span); ?>" <?php endif; ?>><?php echo e($row['room_position']); ?></td>
                <?php endif; ?>

                <td class="text-center"><?php echo e($row['no']); ?></td>
                <td>
                    <?php if($row['type'] === 'family'): ?>
                        &nbsp;&nbsp;<em>+ <?php echo e($row['name']); ?></em>
                    <?php else: ?>
                        <strong><?php echo e($row['name']); ?></strong>
                    <?php endif; ?>
                </td>
                <td class="text-center" style="font-size:6pt;"><?php echo e($row['booking_code']); ?></td>
                <td class="text-center"><?php echo e($row['status']); ?></td>
                <td class="text-center
                    <?php if(str_contains($row['room_type'],'double')): ?> room-type-double
                    <?php elseif(str_contains($row['room_type'],'triple')): ?> room-type-triple
                    <?php elseif(str_contains($row['room_type'],'quad')): ?> room-type-quad
                    <?php endif; ?>">
                    <?php echo e(strtoupper($row['room_type'])); ?>

                </td>

                
                <?php if($isFirst): ?>
                <td class="hotel-madinah-cell room-no-cell" <?php if($span > 1): ?> rowspan="<?php echo e($span); ?>" <?php endif; ?>><?php echo e($row['room_no_madinah']); ?></td>
                <td class="hotel-madinah-cell text-center" <?php if($span > 1): ?> rowspan="<?php echo e($span); ?>" <?php endif; ?>><?php echo e($row['madinah_hotel']); ?></td>
                <td class="hotel-madinah-cell text-center" <?php if($span > 1): ?> rowspan="<?php echo e($span); ?>" <?php endif; ?>><?php echo e($row['madinah_ci']); ?></td>
                <td class="hotel-madinah-cell text-center" <?php if($span > 1): ?> rowspan="<?php echo e($span); ?>" <?php endif; ?>><?php echo e($row['madinah_co']); ?></td>
                <td class="hotel-makkah-cell room-no-cell" <?php if($span > 1): ?> rowspan="<?php echo e($span); ?>" <?php endif; ?>><?php echo e($row['room_no_makkah']); ?></td>
                <td class="hotel-makkah-cell text-center" <?php if($span > 1): ?> rowspan="<?php echo e($span); ?>" <?php endif; ?>><?php echo e($row['makkah_hotel']); ?></td>
                <td class="hotel-makkah-cell text-center" <?php if($span > 1): ?> rowspan="<?php echo e($span); ?>" <?php endif; ?>><?php echo e($row['makkah_ci']); ?></td>
                <td class="hotel-makkah-cell text-center" <?php if($span > 1): ?> rowspan="<?php echo e($span); ?>" <?php endif; ?>><?php echo e($row['makkah_co']); ?></td>
                <?php endif; ?>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td style="width:40%; text-align:right; vertical-align:bottom;">
                    <small>Dicetak: <?php echo e(now()->format('d/m/Y H:i')); ?></small>
                </td>
            </tr>
        </table>
    </div>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views/admin/travel/document/roomlist-stream-pdf.blade.php ENDPATH**/ ?>