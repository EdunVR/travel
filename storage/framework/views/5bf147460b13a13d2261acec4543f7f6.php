...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Jurnal Umum']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Jurnal Umum')]); ?>
  <div x-data="journalsManagement()" x-init="init()" class="space-y-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'finance.jurnal.create')): ?>
                          ...
                          <tr class="border-t border-slate-100 hover:bg-slate-50 group" 
                              ...
                              <td class="px-4 py-3">
                                  <div class="flex items-center gap-2">
                                      ...
                                      <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'finance.jurnal.edit')): ?>
                                      ...
                                      <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'finance.jurnal.delete')): ?>
                                      ...
                                      <?php if(auth()->user()->role->name === 'super_admin'): ?>
      ...
      <div class="bg-white rounded-2xl w-full max-w-3xl" @click.away="closeImportModal()">
        <div class="p-6 border-b border-slate-200">
          <div class="flex items-start justify-between">
            ...
            <a href="<?php echo e(route('finance.journals.template')); ?>" 
  ...
  <script>
    function journalsManagement() {
      return {
        ...
        // Routes
        routes: {
          journalsData: '<?php echo e(route("finance.journals.data")); ?>',
          journalStats: '<?php echo e(route("finance.journals.stats")); ?>',
          showJournal: '<?php echo e(route("finance.journals.show", ["id" => ":id"])); ?>',
          storeJournal: '<?php echo e(route("finance.journals.store")); ?>',
          updateJournal: '<?php echo e(route("finance.journals.update", ["id" => ":id"])); ?>',
          postJournal: '<?php echo e(route("finance.journals.post", ["id" => ":id"])); ?>',
          deleteJournal: '<?php echo e(route("finance.journals.delete", ["id" => ":id"])); ?>',
          deleteSuperadminJournal: '<?php echo e(route("finance.journals.delete-superadmin", ["id" => ":id"])); ?>',
          outletsData: '<?php echo e(route("finance.outlets.data")); ?>',
          accountingBooksData: '<?php echo e(route("finance.accounting-books.data")); ?>',
          chartOfAccountsData: '<?php echo e(route("finance.chart-of-accounts.data")); ?>',
          bookActivityData: '<?php echo e(route("finance.book-activity.data")); ?>',
          exportJournalXLSX: '<?php echo e(route("finance.journals.export.xlsx")); ?>',
          exportJournalPDF: '<?php echo e(route("finance.journals.export.pdf")); ?>',
          importJournals: '<?php echo e(route("finance.journals.import")); ?>'
        },
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\finance\jurnal\index.blade.php ENDPATH**/ ?>