...
<head>
    <meta charset="utf-8">
    <title>Surat Peringatan - <?php echo e($sp->nomor_sp); ?></title>
    <style>
        body {
...
<body>
    <!-- Header -->
    <div class="header">
        <h1>Surat Peringatan <?php echo e($sp->jenis_sp); ?></h1>
        <p><?php echo e($sp->outlet->nama_outlet ?? 'PT. NAMA PERUSAHAAN'); ?></p>
        <p><?php echo e($sp->outlet->alamat ?? 'Alamat Perusahaan'); ?></p>
    </div>
    ...
    <div class="section">
        <table class="info-table">
            <tr>
                <td>Nomor SP</td>
                <td>: <?php echo e($sp->nomor_sp); ?></td>
            </tr>
            <tr>
                <td>Jenis SP</td>
                <td>: 
                    <?php if($sp->jenis_sp === 'SP1'): ?>
                        <span class="badge badge-sp1">SP1 - Peringatan Pertama</span>
                    <?php elseif($sp->jenis_sp === 'SP2'): ?>
            ...
            <tr>
                <td>Tanggal SP</td>
                <td>: <?php echo e($sp->tanggal_sp->format('d F Y')); ?></td>
            </tr>
            <tr>
                <td>Masa Berlaku</td>
                <td>: <?php echo e($sp->tanggal_berlaku->format('d F Y')); ?> s/d <?php echo e($sp->tanggal_berakhir ? $sp->tanggal_berakhir->format('d F Y') : 'Tidak Terbatas'); ?></td>
            </tr>
            <tr>
                <td>Status</td>
                <td>: 
    ...
    <div class="section">
        ...
        <table class="info-table">
            <tr>
                <td>Nama Lengkap</td>
                <td>: <?php echo e($sp->recruitment->name ?? '-'); ?></td>
            </tr>
            <tr>
                <td>Posisi/Jabatan</td>
                <td>: <?php echo e($sp->recruitment->position ?? '-'); ?></td>
            </tr>
            <tr>
                <td>Departemen</td>
                <td>: <?php echo e($sp->recruitment->department ?? '-'); ?></td>
            </tr>
            <tr>
                <td>Email</td>
                <td>: <?php echo e($sp->recruitment->email ?? '-'); ?></td>
            </tr>
        </table>
    </div>
    ...
    <div class="section">
        ...
        <div class="content-box">
            <p style="margin: 0; text-align: justify;"><?php echo e($sp->alasan); ?></p>
        </div>
    </div>

    <!-- Tindakan yang Diharapkan -->
    <?php if($sp->tindakan_perbaikan): ?>
    <div class="section">
        <div class="section-title">TINDAKAN PERBAIKAN YANG DIHARAPKAN</div>
        <div class="content-box">
            <p style="margin: 0; text-align: justify;"><?php echo e($sp->tindakan_perbaikan); ?></p>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="section">
        ...
        <div class="content-box">
            <p style="margin: 0; text-align: justify;"><?php echo e($sp->catatan); ?></p>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="signature-section">
        ...
        <div class="signature-box">
            ...
            <div class="signature-line">
                <p>(_____________________)</p>
                <p style="font-size: 10px;"><?php echo e($sp->recruitment->name ?? '-'); ?></p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\sdm\kontrak\pdf\sp-single.blade.php ENDPATH**/ ?>