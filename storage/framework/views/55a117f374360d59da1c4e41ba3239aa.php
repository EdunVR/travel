...
<?php $component->withAttributes([]); ?>
    <div class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('sdm.kontrak.export.kontrak.pdf')); ?>" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition">
                    <i class="fas fa-file-pdf mr-2"></i>Export PDF
                </a>
                <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'hrm.kontrak.create')): ?>
                <a href="<?php echo e(route('sdm.kontrak.kontrak.create')); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
            ...
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <select name="recruitment_id" class="w-full border-gray-300 rounded-lg">
                        ...
                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($emp->id); ?>" <?php echo e(request('recruitment_id') == $emp->id ? 'selected' : ''); ?>>
                ...
                <div>
                    ...
                    <select name="jenis_kontrak" class="w-full border-gray-300 rounded-lg">
                        ...
                        <option value="PKWT" <?php echo e(request('jenis_kontrak') == 'PKWT' ? 'selected' : ''); ?>>PKWT</option>
                        <option value="PKWTT" <?php echo e(request('jenis_kontrak') == 'PKWTT' ? 'selected' : ''); ?>>PKWTT</option>
                        <option value="Freelance" <?php echo e(request('jenis_kontrak') == 'Freelance' ? 'selected' : ''); ?>>Freelance</option>
                        <option value="Magang" <?php echo e(request('jenis_kontrak') == 'Magang' ? 'selected' : ''); ?>>Magang</option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="status" class="w-full border-gray-300 rounded-lg">
                        ...
                        <option value="diperpanjang" <?php echo e(request('status') == 'diperpanjang' ? 'selected' : ''); ?>>Diperpanjang</option>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $kontrak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <?php echo e($item->nomor_kontrak); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e($item->recruitment->name ?? '-'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <span class="px-2 py-1 bg-blue-100 text-blue-800 rounded text-xs"><?php echo e($item->jenis_kontrak); ?></span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                ...
                                <?php echo e($item->tanggal_selesai ? $item->tanggal_selesai->format('d/m/Y') : 'Tidak Terbatas'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e($item->durasi ?? '-'); ?> bulan
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                ...
                                <?php elseif($item->status === 'diperpanjang'): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <div class="flex gap-3 items-center">
                                    <!-- Generate & Print PDF -->
                                    <button onclick="openPrintModal(<?php echo e($item->id); ?>, '<?php echo e(addslashes($item->nomor_kontrak)); ?>')" 
                                    ...
                                    <!-- Edit -->
                                    <a href="<?php echo e(route('sdm.kontrak.kontrak.edit', $item->id)); ?>" 
                                    ...
                                    <!-- Delete -->
                                    <form action="<?php echo e(route('sdm.kontrak.kontrak.destroy', $item->id)); ?>" 
                                          method="POST" 
                                          class="inline" 
                                          onsubmit="return confirm('Yakin ingin menghapus kontrak <?php echo e(addslashes($item->nomor_kontrak)); ?>?')">
                                        <?php echo csrf_field(); ?>
    ...
    <script>
        function openPrintModal(kontrakId, nomorKontrak) {
            ...
            const pdfUrl = '<?php echo e(route("sdm.kontrak.kontrak.print", ":id")); ?>'.replace(':id', kontrakId);
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\sdm\kontrak\kontrak-index.blade.php ENDPATH**/ ?>