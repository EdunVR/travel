            ...
            <div class="bg-white rounded-lg shadow-sm border p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($totalOutlets ?? 0); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($totalUsers ?? 0); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($totalRoles ?? 0); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($totalConfigs ?? 0); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.sistem.pengaturan.index')); ?>" 
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center p-3 bg-blue-50 rounded-lg">
                            ...
                            <div class="ml-3 flex-1">
                                ...
                                <p class="text-xs text-gray-600"><?php echo e(now()->format('d/m/Y H:i')); ?></p>
                            </div>
                        </div>
    ...
    <script>
        ...
        function createBackup() {
            if (confirm('Apakah Anda yakin ingin membuat backup database? Proses ini mungkin memakan waktu beberapa menit.')) {
                ...
                fetch('<?php echo e(route("admin.sistem.create-backup")); ?>', {
                    method: 'POST',
                    headers: {
        ...
        function showBackupList() {
            fetch('<?php echo e(route("admin.sistem.backups")); ?>')
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-1 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium">${'<?php echo e(PHP_VERSION); ?>'}</span>
                            </div>
                            <div class="flex justify-between">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium">${'<?php echo e(app()->environment()); ?>'}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-1 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium">${'<?php echo e(config("database.default")); ?>'}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Database:</span>
                                <span class="font-medium">${'<?php echo e(config("database.connections.mysql.database")); ?>'}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function clearCache() {
            if (confirm('Apakah Anda yakin ingin menghapus cache aplikasi?')) {
                ...
                fetch('<?php echo e(route("admin.sistem.clear-cache")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function runMigration() {
            if (confirm('Apakah Anda yakin ingin menjalankan migrasi database? Pastikan Anda sudah backup data.')) {
                ...
                fetch('<?php echo e(route("admin.sistem.run-migration")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function optimizeDb() {
            if (confirm('Apakah Anda yakin ingin mengoptimasi database?')) {
                ...
                fetch('<?php echo e(route("admin.sistem.optimize-database")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function showAppSettings() {
            fetch('<?php echo e(route("admin.sistem.app-settings")); ?>')
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        function downloadBackup(filename) {
            window.location.href = `<?php echo e(route('admin.sistem.backups.download', '')); ?>/${filename}`;
        }
        ...
        function restoreBackup(filename) {
            if (confirm(`Apakah Anda yakin ingin restore database dari backup "${filename}"?\n\nPERINGATAN: Ini akan mengganti semua data yang ada dengan data dari backup!`)) {
                ...
                fetch('<?php echo e(route("admin.sistem.restore-backup")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function deleteBackup(filename) {
            if (confirm(`Apakah Anda yakin ingin menghapus backup "${filename}"?`)) {
                fetch(`<?php echo e(route('admin.sistem.backups.delete', '')); ?>/${filename}`, {
                    method: 'DELETE',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function populateCompanySettingsForm(settings) {
            ...
            if (settings.company_logo) {
                ...
                logoImg.src = '<?php echo e(asset("storage/")); ?>/' + settings.company_logo;
            ...
            if (settings.company_favicon) {
                ...
                faviconImg.src = '<?php echo e(asset("storage/")); ?>/' + settings.company_favicon;
        ...
        document.getElementById('companySettingsForm').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route("admin.sistem.pengaturan.update")); ?>', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\sistem\index.blade.php ENDPATH**/ ?>