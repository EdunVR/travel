        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50 <?php echo e($aff->id == $currentAffiliator->id ? 'bg-green-50' : ''); ?>">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="font-semibold text-gray-900">
                                        ...
                                        <?php if($aff->id == $currentAffiliator->id): ?>
    ...
    <div class="bg-gradient-to-r from-green-600 to-green-500 rounded-xl shadow-lg p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <div class="text-3xl font-bold">#<?php echo e($yourPosition); ?></div>
            </div>
            <div class="text-right">
                <div class="text-sm opacity-90 mb-1">Total Earnings</div>
                <div class="text-2xl font-bold">Rp <?php echo e(number_format($currentAffiliator->total_earnings, 0, ',', '.')); ?></div>
            </div>
        </div>
    </div>
    <?php endif; ?>
...
<?php echo $__env->make('affiliate.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\affiliate\leaderboard.blade.php ENDPATH**/ ?>