...
<?php $__env->startSection('title', 'Bagi Hasil Kelompok - ' . $group->name); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid">
    <div class="card-all shadow mb-4">
        <a href="<?php echo e(route('irp.profit-management.index', ['tab' => 'group'])); ?>" class="btn btn-light btn-sm mb-3">
            <i data-feather="arrow-left"></i> Kembali
        </a>

        <?php if($history->status == 'draft'): ?>
        <div class="card mb-4">
            ...
            <form action="<?php echo e(route('irp.profit-management.update-distribution-group', $group->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="period" class="form-control" 
                                    value="<?php echo e(old('period', $history->period)); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" name="distribution_date" class="form-control" 
                                    value="<?php echo e(old('distribution_date', $history->distribution_date ? $history->distribution_date->format('Y-m-d') : now()->format('Y-m-d'))); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="new_total_profit" class="form-control" 
                                    value="<?php echo e(old('new_total_profit', $history->total_profit)); ?>" step="0.01" required>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="useCustomPercentage" 
                                        name="use_custom_percentage" value="1" <?php echo e($history->use_custom_percentage ? 'checked' : ''); ?>>
                                    <label class="custom-control-label font-weight-bold" for="useCustomPercentage">Gunakan Persentase Custom</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" id="customPercentageField" style="<?php echo e(!$history->use_custom_percentage ? 'display:none;' : ''); ?>">
                            <div class="form-group">
                                <label class="font-weight-bold">Persentase Custom (%)</label>
                                <input type="number" name="custom_percentage" class="form-control" 
                                    value="<?php echo e(old('custom_percentage', $history->custom_percentage)); ?>" step="0.01">
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
                    ...
                    <div class="card-body bg-white">
                        <div class="d-flex flex-column">
                            ...
                            <div class="mb-4 p-3 border-bottom">
                                <h5 class="font-weight-bold text-primary mb-3"><?php echo e($group->name); ?></h5>
                                <p class="text-muted mb-0"><?php echo e($group->description ?? 'Tidak ada deskripsi'); ?></p>
                            </div>
                            ...
                            <div class="mb-4 p-3 border-bottom">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-weight-bold"><?php echo e($history->period ?? '-'); ?></div>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-weight-bold">
                                            <?php if($history->distribution_date): ?>
                                                <?php echo e(\Carbon\Carbon::parse($history->distribution_date)->translatedFormat('d F Y')); ?>
                            ...
                            <div class="p-3">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <span class="font-weight-bold text-primary">Rp <?php echo e(number_format($history->total_profit, 0, ',', '.')); ?></span>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="text-muted">Total Investasi</span>
                                    <span class="font-weight-bold text-success">Rp <?php echo e(number_format($total_investment, 0, ',', '.')); ?>

                                    </span>
                                </div>
                                <?php if($history->use_custom_percentage): ?>
            ...
            <div class="col-lg-8 mb-4">
                    ...
                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            <span class="badge badge-primary">
                                ...
                                Investor: <?php echo e($uniqueInvestorsCount); ?>

                            </span>
                            <span class="badge badge-info">
                                <i data-feather="credit-card" width="14" height="14" class="mr-1"></i>
                                Rekening: <?php echo e($validAccountsCount); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $group->investors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $investor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="color-badge" style="background-color: <?php echo e($investorColor); ?>"></span>
                                            </td>
                                            <td>
                                                <div class="font-weight-bold"><?php echo e($investor->investor->name); ?></div>
                                                <small class="text-muted">
                                                    <span class="badge badge-<?php echo e($investor->investor->category == 'internal' ? 'primary' : 'success'); ?>">
                                                        <?php echo e(ucfirst($investor->investor->category)); ?>
                                            ...
                                            <td>
                                                <?php if($account): ?>
                                                <div class="font-weight-bold"><?php echo e($account->bank_name); ?></div>
                                            ...
                                            <td class="text-right font-weight-bold">
                                                Rp <?php echo e(number_format($accountInvestment, 0, ',', '.')); ?>

                                            </td>
                                            <td class="text-right">
                                                <div class="font-weight-bold"><?php echo e(number_format($effectivePercentage)); ?>%</div>
                                                <?php if($account): ?>
                                                <small class="d-block text-muted">Estimasi</small>
                                                <?php endif; ?>
                                            </td>
                                            <td class="text-right">
                                                <div class="font-weight-bold">Rp <?php echo e(number_format($profitShare, 0, ',', '.')); ?></div>
                                                <small class="d-block text-muted">
                                                    <?php echo e(number_format(($accountInvestment / $total_investment) * 100, 2)); ?>%
                                                </small>
                                            </td>
                                        </tr>
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body bg-white">
                        <form action="<?php echo e(route('irp.profit-management.confirm-payment-group', $group->id)); ?>" 
                            method="POST" 
                ...
                <div class="card mt-4 border-left-success">
                    ...
                    <div class="card-body text-center">
                        <a href="<?php echo e(asset('storage/'.$history->proof_file)); ?>" target="_blank" class="btn btn-primary">
...
$(document).ready(function() {
    ...
    var chart = new Chart(ctx, {
        type: 'doughnut',
        data: {
            labels: <?php echo json_encode($group->investors->pluck('investor.name')->toArray()); ?>,
            datasets: [{
                data: <?php echo json_encode($group->investors->pluck('investment_amount')->toArray()); ?>,
                backgroundColor: <?php echo json_encode($group->investors->map(function($item, $index) use ($colorPalette) {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\irp\profit_management\show_group.blade.php ENDPATH**/ ?>