<footer class="bg-gray-900 text-white pt-16 pb-8">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                <!-- Company Info -->
                <div>
                    <img src="<?php echo e(asset('img/logo-auto.png')); ?>" alt="Ghava Shankara Nusantara" class="h-10 mb-4">
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\partials\footer.blade.php ENDPATH**/ ?>