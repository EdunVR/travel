                    ...
                    <div class="system-status">
                        ...
                        <div class="status-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <span class="font-weight-bold" style="color: #1976d2;" id="last-update"><?php echo e(now()->format('H:i')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="input-group input-group-sm mr-3" style="width: 200px;">
                        ...
                        <select name="id_outlet" id="id_outlet" class="form-control form-control-sm border-0 bg-light">
                            ...
                            <?php $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($outlet->id_outlet); ?>" <?php echo e($id_outlet == $outlet->id_outlet ? 'selected' : ''); ?>>
...
<?php if ($__env->exists('produksi.create')) echo $__env->make('produksi.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if ($__env->exists('produksi.detail-modal')) echo $__env->make('produksi.detail-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if ($__env->exists('produksi.laporan-form')) echo $__env->make('produksi.laporan-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<script>
    ...
    $(function () {
        ...
        table = $('.table-produksi').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('produksi.data')); ?>',
                data: function (d) {
        ...
        $('#id_outlet').on('change', function () {
            ...
            $.ajax({
                url: '<?php echo e(route('produksi.index')); ?>',
                type: 'GET',
                data: {
                    id_outlet: id_outlet
                },
    ...
    function updateDashboardData() {
        ...
        $.ajax({
            url: '<?php echo e(route("produksi.getDashboardData")); ?>',
            type: 'GET',
            data: {
                id_outlet: outletId
            },
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\produksi\index.blade.php ENDPATH**/ ?>