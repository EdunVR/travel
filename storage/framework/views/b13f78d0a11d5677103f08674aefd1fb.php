...
<script>
    ...
    $(function () {
        table = $('.table-penjualan').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('admin.penjualan.data')); ?>',
                data: function (d) {
        ...
        $('#print-btn').on('click', function () {
            ...
            form.method = 'POST';
            form.action = '<?php echo e(route("admin.penjualan.cetak.post")); ?>';
            form.target = '_blank';
    ...
    $('#print-simple-btn').on('click', function () {
        ...
        let form = document.createElement('form');
        form.method = 'POST';
        form.action = '<?php echo e(route("admin.penjualan.cetak.sederhana.post")); ?>';
        form.target = '_blank';
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\penjualan\index.blade.php ENDPATH**/ ?>