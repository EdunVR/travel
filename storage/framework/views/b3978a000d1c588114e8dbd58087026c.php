...
<div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="modal-create">
    <div class="modal-dialog modal-lg" role="document">
        <form id="form-create" action="<?php echo e(route('produk.store')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\produk\create-modal.blade.php ENDPATH**/ ?>