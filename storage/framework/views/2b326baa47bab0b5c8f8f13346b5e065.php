...
<?php $__env->startSection('title'); ?>
    Laporan Hutang dan Piutang <?php echo e(tanggal_indonesia($tanggalAwal, false)); ?> s/d <?php echo e(tanggal_indonesia($tanggalAkhir, false)); ?>
...
<?php if ($__env->exists('laporan_hutang_piutang.form')) echo $__env->make('laporan_hutang_piutang.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<script>
    ...
    $(function () {
        table = $('.table').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('laporan_hutang_piutang.data', [$tanggalAwal, $tanggalAkhir])); ?>',
                dataSrc: function(json) {
                    ...
                    $('#exportPdf').attr('href', '<?php echo e(route('laporan_hutang_piutang.export_pdf', ['awal' => ':awal', 'akhir' => ':akhir', 'totalHutang' => ':totalHutang', 'totalPiutang' => ':totalPiutang'])); ?>'
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\laporan_hutang_piutang\index.blade.php ENDPATH**/ ?>