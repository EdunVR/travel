...
<body>
    ...
    <div class="content">
        <p>Halo <strong><?php echo e($affiliator->full_name); ?></strong>,</p>
        ...
        <center>
            <a href="<?php echo e(route('affiliate.login')); ?>" class="button">Login Sekarang</a>
        </center>
    ...
    <div class="footer">
        ...
        <p>&copy; <?php echo e(date('Y')); ?> HM Tour & Travel. All rights reserved.</p>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\emails\password-changed.blade.php ENDPATH**/ ?>