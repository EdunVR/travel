...
<?php $__env->startSection('title', 'Daftar Buku Akuntansi'); ?>
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="<?php echo e(route('financial.book.accounts')); ?>" class="btn btn-primary btn-sm mr-2">
                    <i data-feather="book-open"></i> Akun Buku
                </a>
                <a href="<?php echo e(route('financial.book.sub_classes')); ?>" class="btn btn-info btn-sm mr-2">
                    <i data-feather="layers"></i> Kelola Subclass
                </a>
                <a href="<?php echo e(route('financial.book.create')); ?>" class="btn btn-success btn-sm">
                ...
                <table class="table table-bordered table-hover" id="booksTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo e($book->start_date->format('d M Y')); ?> - 
                                <?php echo e($book->end_date->format('d M Y')); ?>

                            </td>
                            <td class="text-center">
                                <?php if($book->currency == 'IDR'): ?>
                            ...
                            <td class="text-center">
                                ...
                                <?php elseif($book->status == 'active'): ?>
                                    <span class="badge badge-success">Aktif</span>
                                <?php else: ?>
                                    <span class="badge badge-danger">Tutup</span>
                                <?php endif; ?>
                            </td>
                            <td><?php echo e($book->creator->name); ?></td>
                            <td class="text-center">
                                <div class="btn-group btn-group-sm">
                                    <a href="<?php echo e(route('financial.book.opening_balances', $book->id)); ?>" 
                                    class="btn btn-info" title="Saldo Awal">
                                        <i data-feather="dollar-sign" width="16"></i>
                                    </a>
                                    <?php if($book->status == 'draft'): ?>
                                        <button class="btn btn-sm btn-primary edit-book-btn" data-book-id="<?php echo e($book->id); ?>" title="Edit">
                                            <i data-feather="edit" width="16"></i>
                                        </button>
                                        <button class="btn btn-danger btn-sm delete-book-btn" 
                                                data-book-id="<?php echo e($book->id); ?>" 
                                                data-book-name="<?php echo e($book->name); ?>"
                                                title="Hapus">
                                    ...
                                    <?php if($book->status === 'active'): ?>
                                        <button class="btn btn-sm btn-danger close-book-btn" data-book-id="<?php echo e($book->id); ?>">
                                        <i data-feather="lock" width="16"></i> Tutup Buku
                                        </button>
                                    <?php endif; ?>
                                    <?php if($book->status === 'closed'): ?>
                                        <a href="<?php echo e(route('financial.book.backup', $book->id)); ?>" class="btn btn-sm btn-info">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.close-book-btn').click(function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('financial.book.close_confirmation', '')); ?>/" + bookId,
                type: 'GET',
        ...
        function processBookClosing(bookId, password) {
            ...
            $.ajax({
                url: "<?php echo e(route('financial.book.close', '')); ?>/" + bookId,
                type: 'POST',
                data: {
        ...
        $('.edit-book-btn').click(function() {
            ...
            $.ajax({
                url: "<?php echo e(route('financial.book.edit', '')); ?>/" + bookId,
                type: 'GET',
                success: function(response) {
                    Swal.close();
        ...
        function updateBook(bookId) {
            ...
            $.ajax({
                url: "<?php echo e(route('financial.book.update', '')); ?>/" + bookId,
                type: 'PUT',
                data: formData,
                headers: {
        ...
        $(document).on('click', '.delete-book-btn', function() {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return fetch(`<?php echo e(route('financial.book.delete', '')); ?>/${bookId}`, {
                        method: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\financial\book\list.blade.php ENDPATH**/ ?>