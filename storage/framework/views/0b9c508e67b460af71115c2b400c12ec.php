    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content modal-glass">
            ...
            <div class="modal-body">
                <form id="form-laporan-preview" action="<?php echo e(route('produksi.generateLaporan')); ?>" method="GET" target="_blank">
                    <form id="form-laporan-download" action="<?php echo e(route('produksi.downloadLaporan')); ?>" method="GET">
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\produksi\laporan-form.blade.php ENDPATH**/ ?>