    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="investmentForm" method="POST" enctype="multipart/form-data"
                action="<?php echo e(route('irp.investor.account.investment.store', ['investor' => $investor->id, 'account' => '__ACCOUNT_ID__'])); ?>">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\irp\investor\partials\investment_modal.blade.php ENDPATH**/ ?>