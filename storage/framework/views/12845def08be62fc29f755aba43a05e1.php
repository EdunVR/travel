...
<body>
    ...
    <div class="desktop-layout">
        ...
        <div class="main-content">
            ...
            <?php if(request()->routeIs('investor.dashboard')): ?>
                <!-- Special Home Page Top Navigation -->
                <nav class="top-nav-home" id="topNavHome">
                    ...
                    <div class="balance-container">
                        ...
                        <div class="balance-amount">Rp<?php echo e(number_format($totalSaldo_semua, 0, ',', '.')); ?>,-</div>
                        <?php if($totalSaldoTertahan != 0): ?>
                            <div class="text-sm text-gray-500" style="margin-top: -15px;">
                                Terdapat saldo tertahan sebesar: <strong>Rp<?php echo e(number_format($totalSaldoTertahan, 0, ',', '.')); ?></strong>
                            </div>
                        <?php endif; ?>
                        <div class="balance-actions">
                            ...
                            <!-- <a href="https://wa.me/6289699497272?text=Assalamualaikum%20warohmatullahi%20wabarokatuh%2C%20Saya%20atas%20nama%20<?php echo e(urlencode(Auth::guard('investor')->user()->name)); ?>%20ingin%20menambah%20modal%20syirkah%2C%20mohon%20untuk%20di%20proses" 
    ...
    <div id="withdrawalModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
            <div class="bg-white rounded-lg p-6 w-full max-w-md">
                ...
                <form action="<?php echo e(route('investor.withdrawals.store')); ?>" method="POST" id="withdrawalForm">
                    <?php echo csrf_field(); ?>
                        ...
                        <select id="account_id" name="account_id" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500" onchange="updateBalance()"
                            ...
                            <?php $__currentLoopData = $investor->accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($account->id); ?>"
                                        data-balance="<?php echo e($account->profit_balance - $account->saldo_tertahan); ?>"
                                        data-tertahan="<?php echo e($account->saldo_tertahan); ?>">
                                    <?php echo e($account->bank_name); ?> - <?php echo e($account->account_number); ?> (Rp<?php echo e(number_format($account->profit_balance - $account->saldo_tertahan, 0, ',', '.')); ?>)
                                </option>
                    ...
                    <div class="mb-4">
                        ...
                        <div id="availableBalance" class="text-xl font-semibold">
                            Rp<?php echo e(number_format($investor->accounts->sum('profit_balance') - $investor->accounts->sum('saldo_tertahan'), 0, ',', '.')); ?>

                        </div>
                        
                        <?php if($investor->accounts->sum('saldo_tertahan') > 0): ?>
                            <div id="saldoTertahan" class="text-sm text-gray-500 mt-1" style="font-family: 'Dongle', sans-serif; font-size: 16px;">
                                Terdapat saldo tertahan Rp<?php echo e(number_format($investor->accounts->sum('saldo_tertahan'), 0, ',', '.')); ?>

                            </div>
                        <?php endif; ?>

                        <input type="hidden" id="maxAmount" value="<?php echo e($investor->accounts->sum('profit_balance')); ?>">
                    </div>
    ...
    <script>
        ...
        function updateBalance() {
            ...
            if (accountSelect.value === 'all') {
                const totalBalance = <?php echo e($investor->accounts->sum('profit_balance') - $investor->accounts->sum('saldo_tertahan')); ?>;
                balanceDisplay.textContent = 'Rp' + formatNumber(totalBalance);
                saldoTertahanDisplay.textContent = 'Terdapat saldo tertahan Rp' + formatNumber(<?php echo e($investor->accounts->sum('saldo_tertahan')); ?>);
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\investor\layouts\app.blade.php ENDPATH**/ ?>