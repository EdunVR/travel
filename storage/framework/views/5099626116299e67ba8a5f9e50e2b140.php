    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <a href="<?php echo e(route('hrm.attendance.create')); ?>" class="btn btn-primary">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link <?php echo e($activeTab === 'daily' ? 'active' : ''); ?>" id="daily-tab" data-toggle="tab" href="#daily" role="tab">Harian</a>
                </li>
                <!-- <li class="nav-item">
                    <a class="nav-link <?php echo e($activeTab === 'weekly' ? 'active' : ''); ?>" id="weekly-tab" data-toggle="tab" href="#weekly" role="tab">Mingguan</a>
                </li> -->
                <li class="nav-item">
                    <a class="nav-link <?php echo e($activeTab === 'monthly' ? 'active' : ''); ?>" id="monthly-tab" data-toggle="tab" href="#monthly" role="tab">Bulanan</a>
                </li>
            </ul>
                ...
                <div class="tab-pane fade" id="daily" role="tabpanel" aria-labelledby="daily-tab">
                    ...
                    <form id="dailyFilterForm" onsubmit="filterAttendance(event, 'daily')">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="date" id="date" class="form-control" value="<?php echo e($selectedDate); ?>">
                            </div>
                        ...
                        <div class="alert alert-info">
                            <i class="fas fa-calendar-day"></i> Tanggal: <?php echo e(Carbon\Carbon::parse($selectedDate)->translatedFormat('d F Y')); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="dailyTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $dailyAttendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($attendance->recruitment->fingerprint_id); ?></td>
                                        <td><?php echo e($attendance->recruitment->name); ?></td>
                                        <td><?php echo e($attendance->recruitment->position ?? '-'); ?></td>
                                        <td><?php echo e($scheduleIn); ?></td>
                                        <td><?php echo e($scheduleOut); ?></td>
                                        <td class="text-center <?php echo e($cellClass); ?>" title="<?php echo e($tooltip); ?>" style="cursor: help;">
                                        ...
                                        <td class="text-center"><?php echo e($attendance->late_minutes ?? 0); ?></td>
                                        <td class="text-center"><?php echo e($attendance->early_minutes ?? 0); ?></td>
                                        <td class="text-center"><?php echo e($attendance->overtime_minutes ?? 0); ?></td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="<?php echo e(route('hrm.attendance.edit', $attendance->id)); ?>" class="btn btn-icon btn-warning mr-1" title="Edit">
                                                    <!-- <i data-feather="edit"></i> -->
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form action="<?php echo e(route('hrm.attendance.destroy', $attendance->id)); ?>" method="POST" style="display:inline;">
                                                    <?php echo csrf_field(); ?>
                ...
                <div class="tab-pane fade" id="monthly" role="tabpanel" aria-labelledby="monthly-tab">
                    <div class="mt-3">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="month" name="monthly_month" id="monthly_month" class="form-control" value="<?php echo e($monthlyMonth); ?>">
                                    </div>
                                </div>
                        ...
                        <div class="alert alert-info">
                            ...
                            <?php echo e($monthlyData['startDate']->translatedFormat('d M Y')); ?> - 
                            <?php echo e($monthlyData['endDate']->translatedFormat('d M Y')); ?>
                            ...
                            <table class="table table-bordered table-hover" id="monthlyTable" width="100%" cellspacing="0">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <?php $__currentLoopData = $monthlyData['dates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <th class="text-center" style="min-width: 60px;">
                                            <div class="font-weight-bold"><?php echo e($date->format('d')); ?></div>
                                            <div class="small"><?php echo e($dayNames[$date->dayOfWeek]); ?></div>
                                        </th>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $monthlyData['employees']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <tr>
                                        <td><?php echo e($loop->iteration); ?></td>
                                        <td><?php echo e($employee['fingerprint_id']); ?></td>
                                        ...
                                        ?>
                                        <td class="text-center <?php echo e($cellClass); ?>" <?php if(isset($tooltip)): ?> title="<?php echo e($tooltip); ?>" <?php endif; ?> style="cursor: help;">
                                            <span class="<?php echo e($statusClass); ?>"><?php echo e($status); ?></span>
                                        </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <td class="text-center"><?php echo e($employee['total_present']); ?></td>
                                        <td class="text-center"><?php echo e($employee['total_absent']); ?></td>
                                        <td class="text-center"><?php echo e($employee['total_late']); ?></td>
                                        <td class="text-center"><?php echo e($employee['total_early']); ?></td>
                                        <td class="text-center"><?php echo e($employee['total_overtime']); ?></td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
...
<div class="modal fade" id="setWorkHoursModal" tabindex="-1" role="dialog" aria-labelledby="setWorkHoursModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('hrm.attendance.set-work-hours')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php $__env->startSection('daily-table'); ?>
    <!-- Isi tabel harian -->
...
<?php $__env->startSection('monthly-table'); ?>
    <!-- Isi tabel bulanan -->
    <table class="table table-bordered">
        <!-- ... -->
    </table>
...
async function filterAttendance(event, tabName) {
    ...
    try {
        // Kirim request AJAX
        const response = await fetch("<?php echo e(route('hrm.attendance.index')); ?>?" + new URLSearchParams(formData), {
            headers: {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\hrm\attendance\index.blade.php ENDPATH**/ ?>