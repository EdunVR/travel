        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6 text-left">
                ...
                <div class="space-y-1 text-sm text-yellow-800">
                    <div><strong>Nama:</strong> <?php echo e($affiliator->full_name); ?></div>
                    <div><strong>No. HP:</strong> <?php echo e($affiliator->phone_number); ?></div>
                    <div><strong>Email:</strong> <?php echo e($affiliator->email); ?></div>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\affiliate\pending.blade.php ENDPATH**/ ?>