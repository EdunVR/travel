...
<div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <img class="mx-auto h-16 w-auto" src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-3xl">
        <div class="bg-white py-8 px-6 shadow rounded-lg sm:px-10">
            <form class="mb-0 space-y-6" action="<?php echo e(route('investor.register')); ?>" method="POST" id="registrationForm">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('investor.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\investor\auth\register.blade.php ENDPATH**/ ?>