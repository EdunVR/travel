...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'MORRA ERP'); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/travel-responsive.css')); ?>">
    
    <!-- Travel Management Modal & Notification CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('css/travel-modals.css')); ?>">
    
    <!-- Travel Management Validation CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('css/travel-validation.css')); ?>">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="brand-link">
                <img src="<?php echo e(asset('img/logo-auto.png')); ?>" alt="Logo" class="brand-image img-circle elevation-3">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; <?php echo e(date('Y')); ?> MORRA ERP.</strong>
            All rights reserved.
        </footer>
    </div>
        ...
        $(document).ready(function() {
            ...
            searchInput.on('input', function() {
                ...
                searchTimeout = setTimeout(function() {
                    $.ajax({
                        url: '<?php echo e(route("admin.inventaris.search.autocomplete")); ?>',
                        method: 'GET',
                        data: { q: query },
            ...
            searchInput.on('keypress', function(e) {
                if (e.which === 13) {
                    ...
                    const query = $(this).val().trim();
                    if (query.length >= 2) {
                        window.location.href = '<?php echo e(route("admin.inventaris.search")); ?>?q=' + encodeURIComponent(query);
                    }
                }
            });
            ...
            function loadNotificationCount() {
                $.ajax({
                    url: '<?php echo e(route("admin.inventaris.notifications.unread-count")); ?>',
                    method: 'GET',
                    success: function(response) {
                        if (response.success) {
    ...
    <script src="<?php echo e(asset('js/travel-ui-helpers.js')); ?>"></script>
    
    <!-- Travel Management Validation Helpers -->
    <script src="<?php echo e(asset('js/travel-validation-errors.js')); ?>"></script>
    
    <?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\layouts\admin.blade.php ENDPATH**/ ?>