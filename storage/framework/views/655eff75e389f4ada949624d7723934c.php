...
<body>
        ...
        <table style="width: 100%; margin-bottom: 20px; border: none;">
            <tr>
                <td style="width: 50%; vertical-align: top; border: none; padding: 0;">
                    ...
                    <strong>Jatuh Tempo:</strong> <?php echo e($invoice->due_date->format('d/m/Y')); ?>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($item->deskripsi); ?></td>
                <td class="text-center"><?php echo e(number_format($item->kuantitas, 2)); ?></td>
                ...
                <td class="text-right">
                    ...
                    <?php echo e(number_format($item->diskon * $item->kuantitas, 0, ',', '.')); ?>
    ...
    <div class="bank-accounts">
        ...
        <div style="padding: 10px; background: #f8f9fa; border-radius: 5px;">
            ...
            <span style="font-weight: bold; color: #667eea;"><?php echo e($companySettings['bank_name']); ?></span><br>
            <?php endif; ?>
            
            <?php if($companySettings['bank_account_number']): ?>
            <span style="font-family: monospace; font-size: 14px;">No. Rek: <?php echo e($companySettings['bank_account_number']); ?></span><br>
            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\penjualan\invoice\print_backup.blade.php ENDPATH**/ ?>