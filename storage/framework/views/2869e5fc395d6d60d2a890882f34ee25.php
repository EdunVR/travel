    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition">
                <h4 class="font-bold text-gray-900 mb-2"><?php echo e($package->package_name); ?></h4>
                <div class="text-sm text-gray-600 mb-3">
                    <div>Durasi: <?php echo e($package->duration); ?> hari</div>
                    <div class="font-bold text-green-600 mt-1">Rp <?php echo e(number_format($package->price, 0, ',', '.')); ?></div>
                </div>
                <div class="flex gap-2">
                    <button onclick="copyPackageLink('<?php echo e(route('public.paket.show', $package->id)); ?>?ref=<?php echo e($affiliator->username); ?>')"
                            class="flex-1 px-3 py-2 bg-green-50 hover:bg-green-100 text-green-600 text-sm rounded-lg transition">
                        <i class="fas fa-copy mr-1"></i> Copy Link
                    </button>
                    <a href="https://wa.me/?text=<?php echo e(urlencode('Paket ' . $package->package_name . ' - ' . route('public.paket.show', $package->id) . '?ref=' . $affiliator->username)); ?>"
                       target="_blank"
...
<?php echo $__env->make('affiliate.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\affiliate\marketing.blade.php ENDPATH**/ ?>