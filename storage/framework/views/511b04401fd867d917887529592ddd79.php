...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Kelola Manifest']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Kelola Manifest')]); ?>
  ...
  function manifestManager() {
    return {
      keberangkatanId: <?php echo e($keberangkatan->id ?? 'null'); ?>,
      keberangkatan: <?php echo json_encode($keberangkatan ?? new stdClass, 15, 512) ?>,
      manifestRows: <?php echo json_encode($manifestRows ?? [], 15, 512) ?>,
      selectedRows: [],
      loading: false,
      saving: false,
      ...
      // Data already loaded from server via <?php echo json_encode($manifestRows, 15, 512) ?>
      ...
      async saveOrder() {
        ...
        try {
          ...
          const res = await fetch(`<?php echo e(url('')); ?>/admin/inventaris/travel/keberangkatan/${this.keberangkatanId}/save-manifest-order`, {
            method: 'POST',
            headers: {
      ...
      downloadPdf() {
        window.open(`<?php echo e(url('')); ?>/admin/inventaris/travel/keberangkatan/${this.keberangkatanId}/manifest-pdf`, '_blank');
      },

      downloadExcel() {
        window.open(`<?php echo e(url('')); ?>/admin/inventaris/travel/keberangkatan/${this.keberangkatanId}/manifest-excel`, '_blank');
      },
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views/admin/travel/keberangkatan/manage-manifest.blade.php ENDPATH**/ ?>