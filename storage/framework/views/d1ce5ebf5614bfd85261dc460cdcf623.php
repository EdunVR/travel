...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Travel / Task Management']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Travel / Task Management')]); ?>
  <div class="space-y-4 overflow-x-hidden">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="flex flex-wrap gap-2">
        <a href="<?php echo e(route('admin.inventaris.travel.tasks.my-tasks')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-primary-600 text-white px-4 py-2 hover:bg-primary-700">
        ...
        <div>
          ...
          <select id="teamFilter" class="w-full rounded-xl border border-slate-200 px-3 py-2 focus:ring-2 focus:ring-primary-200">
            ...
            <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($team->team_code); ?>" <?php echo e($selectedTeam == $team->team_code ? 'selected' : ''); ?>>
    ...
    $(document).ready(function() {
      ...
      function initTable() {
        ...
        table = $('#tasksTable').DataTable({
          ...
          serverSide: true,
          ajax: {
            url: '<?php echo e(route("admin.inventaris.travel.tasks.data")); ?>',
            data: function(d) {
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\travel\task\index.blade.php ENDPATH**/ ?>