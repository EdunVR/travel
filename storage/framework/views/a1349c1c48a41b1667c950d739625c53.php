...
<?php $component->withAttributes([]); ?>
    <div class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Pre Order <?php echo e($preorder->kode_preorder); ?></h1>
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('admin.penjualan.preorders.index')); ?>" 
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border p-6">
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <span class="inline-flex px-3 py-1 text-sm font-semibold rounded-full <?php echo e($preorder->status_badge); ?>">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="text-gray-900 font-medium"><?php echo e($preorder->kode_preorder); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Tanggal</label>
                            <p class="text-gray-900"><?php echo e($preorder->tanggal->format('d/m/Y')); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Customer</label>
                            <p class="text-gray-900"><?php echo e($preorder->customer->nama ?? '-'); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Total</label>
                            <p class="text-gray-900 font-bold text-lg">Rp <?php echo e(number_format($preorder->total, 0, ',', '.')); ?></p>
                        </div>
                        <?php if($preorder->dp_amount): ?>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">DP Amount</label>
                            <p class="text-gray-900">Rp <?php echo e(number_format($preorder->dp_amount, 0, ',', '.')); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Sisa Pembayaran</label>
                            <p class="text-gray-900">Rp <?php echo e(number_format($preorder->remaining_payment, 0, ',', '.')); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-gray-900"><?php echo e($preorder->catatan); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
                        ...
                        <table class="w-full">
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <?php if($item->product): ?>
                                                <p class="text-xs text-gray-500"><?php echo e($item->product->name); ?></p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4 text-sm text-gray-900"><?php echo e(number_format($item->qty, 2)); ?></td>
                                    <td class="px-4 py-4 text-sm text-gray-900">Rp <?php echo e(number_format($item->harga, 0, ',', '.')); ?></td>
                                    <td class="px-4 py-4 text-sm font-medium text-gray-900">Rp <?php echo e(number_format($item->subtotal, 0, ',', '.')); ?></td>
                                </tr>
                            ...
                            <tfoot class="bg-gray-50">
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-sm font-medium text-gray-900">Rp <?php echo e(number_format($preorder->subtotal, 0, ',', '.')); ?></td>
                                </tr>
                                <?php if($preorder->diskon > 0): ?>
                                <tr>
                                    <td colspan="3" class="px-4 py-3 text-right text-sm font-medium text-gray-900">Diskon:</td>
                                    <td class="px-4 py-3 text-sm font-medium text-red-600">-Rp <?php echo e(number_format($preorder->diskon, 0, ',', '.')); ?></td>
                                </tr>
                                <?php endif; ?>
                                <?php if($preorder->pajak > 0): ?>
                                <tr>
                                    <td colspan="3" class="px-4 py-3 text-right text-sm font-medium text-gray-900">Pajak:</td>
                                    <td class="px-4 py-3 text-sm font-medium text-gray-900">Rp <?php echo e(number_format($preorder->pajak, 0, ',', '.')); ?></td>
                                </tr>
                                <?php endif; ?>
                                <tr>
                                    <td colspan="3" class="px-4 py-3 text-right text-sm font-bold text-gray-900">Total:</td>
                                    <td class="px-4 py-3 text-sm font-bold text-gray-900">Rp <?php echo e(number_format($preorder->total, 0, ',', '.')); ?></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
    ...
    <script>
        ...
        function printDocument(type) {
            ...
            const url = `<?php echo e(route('admin.penjualan.preorders.print.modal', ['preorder' => $preorder->id, 'type' => 'TYPE'])); ?>`.replace('TYPE', type);
        ...
        function downloadPdf() {
            if (currentPrintType) {
                const url = `<?php echo e(route('admin.penjualan.preorders.print.download', ['preorder' => $preorder->id, 'type' => 'TYPE'])); ?>`.replace('TYPE', currentPrintType);
        ...
        document.getElementById('statusForm').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route("admin.penjualan.preorders.updateStatus", $preorder->id)); ?>', {
                method: 'POST',
                headers: {
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\pre-orders\show.blade.php ENDPATH**/ ?>