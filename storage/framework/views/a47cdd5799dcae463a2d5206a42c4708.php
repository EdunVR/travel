                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="asset_type" id="asset_type" class="form-select">
                                <option value="">Semua</option>
                                <option value="tangible" <?php echo e(request('asset_type') == 'tangible' ? 'selected' : ''); ?>>Berwujud</option>
                                <option value="intangible" <?php echo e(request('asset_type') == 'intangible' ? 'selected' : ''); ?>>Tidak Berwujud</option>
                                <option value="building" <?php echo e(request('asset_type') == 'building' ? 'selected' : ''); ?>>Bangunan</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                <input type="text" name="search" id="search" class="form-control" value="<?php echo e(request('search')); ?>" placeholder="Nama/Kode Aktiva">
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" class="asset-checkbox" value="<?php echo e($asset->id); ?>">
                            </td>
                            <td>
                                <?php if($asset->photo_path): ?>
                                <img src="<?php echo e(asset('storage/' . $asset->photo_path)); ?>" alt="<?php echo e($asset->name); ?>" class="img-thumbnail" style="width: 50px; height: 50px; object-fit: cover;">
                                <?php else: ?>
                            ...
                            <td>
                                <?php if($asset->asset_type == 'tangible'): ?>
                                    <span class="badge bg-primary">Berwujud</span>
                                <?php elseif($asset->asset_type == 'intangible'): ?>
                                    <span class="badge bg-info">Tidak Berwujud</span>
                                <?php else: ?>
                                    <span class="badge bg-secondary">Bangunan</span>
                                <?php endif; ?>
                            </td>
                            <td><?php echo e($asset->asset_group); ?></td>
                            <td><?php echo e($asset->quantity); ?> <?php echo e($asset->unit); ?></td>
                            <td class="text-end"><?php echo e(number_format($asset->unit_price, 2)); ?></td>
                            <td class="text-end"><?php echo e(number_format($asset->total_cost, 2)); ?></td>
                            <td class="text-end"><?php echo e(number_format($residualValue, 2)); ?></td>
                            <td><?php echo e($asset->acquisition_date->format('d/m/Y')); ?></td>
                            <td class="text-center"><?php echo e($asset->useful_life); ?> tahun</td>
                            <td class="text-end"><?php echo e(number_format($monthlyDepreciation, 2)); ?></td>
                            <td>
                                <div class="btn-group btn-group-sm" role="group">
                                    <button class="btn btn-primary edit-btn" data-id="<?php echo e($asset->id); ?>" title="Edit">
                                        <i data-feather="edit"></i>
                                    </button>
                                    <button class="btn btn-info generate-btn" data-id="<?php echo e($asset->id); ?>" title="Generate Depresiasi">
                                        <i data-feather="refresh-cw"></i>
                                    </button>
                                    <button class="btn btn-danger delete-btn" data-id="<?php echo e($asset->id); ?>" title="Hapus">
...
$(document).ready(function() {
    ...
    $('#deleteSelectedBtn').click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?php echo e(route("financial.fixed-asset.delete-selected")); ?>',
                    type: 'POST',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        ids: selectedIds
    ...
    function generateAssetCode() {
        ...
        $.get("<?php echo e(route('financial.fixed-asset.generate-code')); ?>", function(response) {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\financial\fixed-asset\index.blade.php ENDPATH**/ ?>