                    ...
                    <tr class="hover:bg-slate-50 transition">
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex justify-center gap-1">
                                ...
                                <form action="<?php echo e(route('admin.inventaris.affiliate.approve', $aff)); ?>" method="POST" class="inline">
                                ...
                                <form action="<?php echo e(route('admin.inventaris.affiliate.suspend', $aff)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                ...
                                <?php endif; ?>
                                <form action="<?php echo e(route('admin.inventaris.affiliate.destroy', $aff)); ?>" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus mitra <?php echo e($aff->full_name); ?>? Data yang terkait dengan mitra ini juga akan terhapus.')">
