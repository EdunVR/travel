...
<?php $__env->startSection('title', 'Dashboard Investor'); ?>
    ...
    <main class="p-3"> <!-- Mengurangi padding main -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-3 compact-gap"> <!-- Mengurangi gap -->
                ...
                <div class="flex items-start gap-2">
                    ...
                    <div class="w-[55%]">
                        <div class="text-xl font-bold font-dongle" style="font-size: 1.6rem; text-align: right;">
                            Rp<?php echo e(number_format($totalInvestment, 0, ',', '.')); ?>
                        ...
                        <div class="compact-mt">
                            <div class="flex justify-between text-xs text-gray-500"> <!-- text-sm -> text-xs -->
                                ...
                                <span class="whitespace-nowrap">Rp<?php echo e(number_format($totalInvestmentRAW, 0, ',', '.')); ?></span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-1.5">
                                <div class="bg-amber-500 h-1.5 rounded-full progress-bar" 
                                    style="width: <?php echo e($totalInvestmentRAW > 0 ? min(($activeInvestment / $totalInvestmentRAW) * 100, 100) : 0); ?>%">
                                </div>
                            </div>
                            <div class="flex justify-between text-xs text-gray-500 compact-mt"> <!-- text-sm -> text-xs -->
                                ...
                                <span class="whitespace-nowrap">Rp<?php echo e(number_format($totalWithdrawn, 0, ',', '.')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-[50px] shadow compact-p hover:shadow-md transition-shadow">
                <div class="flex items-start gap-2">
                    ...
                    <div class="w-[55%]">
                        <div class="text-xl font-bold font-dongle" style="font-size: 1.6rem; text-align: right;">
                            Rp<?php echo e(number_format($averageMonthlyProfit, 0, ',', '.')); ?>

                        </div>
                        <?php if($profitChangePercentage > 0): ?>
                            <span class="text-xs text-green-500 font-dongle block whitespace-nowrap" style="font-size: 1.0rem;"> <!-- 1.2rem -> 1.0rem -->
                                +<?php echo e(number_format($profitChangePercentage, 2)); ?>% <i class="fas fa-arrow-up"></i>
                            </span>
                        <?php elseif($profitChangePercentage < 0): ?>
                            <span class="text-xs text-red-500 font-dongle block whitespace-nowrap" style="font-size: 1.0rem;"> <!-- 1.2rem -> 1.0rem -->
                                <?php echo e(number_format($profitChangePercentage, 2)); ?>% <i class="fas fa-arrow-down"></i>
                            </span>
                        <?php endif; ?>
                        ...
                        <div class="compact-mt">
                            <div class="flex justify-between text-xs text-gray-500 compact-mt"> <!-- text-sm -> text-xs -->
                                ...
                                <span class="whitespace-nowrap">Rp<?php echo e(number_format($currentMonthProfit, 0, ',', '.')); ?></span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-1.5">
                                <div class="bg-amber-500 h-1.5 rounded-full progress-bar" 
                                    style="width: <?php echo e(min(($currentMonthProfit / max($averageMonthlyProfit, 1)) * 100, 100)); ?>%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="w-[55%]">
                        ...
                        <div>
                            <div class="flex justify-between text-xs"> <!-- text-sm -> text-xs -->
                                ...
                                <span class="font-medium whitespace-nowrap">Rp<?php echo e(number_format($currentMonthWithdrawal, 0, ',', '.')); ?></span>
                            </div>
                            <div class="flex justify-between text-xs"> <!-- text-sm -> text-xs -->
                                <span class="text-gray-500 whitespace-nowrap">Total Pencairan</span>
                                <span class="font-medium whitespace-nowrap">Rp<?php echo e(number_format($totalWithdrawals, 0, ',', '.')); ?></span>
                            </div>
                        </div>
                        
                        <div class="text-right compact-mt">
                            <a href="<?php echo e(route('investor.withdrawals')); ?>" class="text-xs text-purple-600 hover:text-purple-800 font-medium whitespace-nowrap"> <!-- text-sm -> text-xs -->
            ...
            <div class="bg-white rounded-lg shadow compact-p hover:shadow-md transition-shadow">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <div class="text-xs bg-gray-100 px-2 py-0.5 rounded-full"> <!-- text-sm -> text-xs -->
                        Rata-rata: <?php echo e(number_format($averagePercentage, 2)); ?>%
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="px-3 py-2 border-b flex justify-between items-center compact-p"> <!-- Mengurangi padding -->
                ...
                <a href="<?php echo e(route('investor.activities')); ?>" class="text-xs text-green-600 hover:text-green-800 font-medium"> <!-- text-sm -> text-xs -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            new Chart(profitWithdrawalCtx, {
                ...
                data: {
                    ...
                    datasets: [
                        ...
                        {
                            label: 'Pencairan',
                            data: <?php echo json_encode($monthlyWithdrawals, 15, 512) ?>,
            ...
            new Chart(investmentGrowthCtx, {
                type: 'line',
                data: {
                    labels: <?php echo json_encode($investmentGrowthLabels, 15, 512) ?>,
                    datasets: [{
                        label: 'Nilai Investasi',
                        data: <?php echo json_encode($investmentGrowthData, 15, 512) ?>,
                        borderColor: '#8B5CF6',
...
<?php echo $__env->make('investor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\investor\dashboard.blade.php ENDPATH**/ ?>