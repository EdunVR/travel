...
<?php $__env->startSection('title', 'Investasi Saya - Portal Investor'); ?>
        ...
        <div class="mb-4"> <!-- dikurangi dari mb-6 -->
            <div class="bg-white rounded-[40px] shadow-md p-3"> <!-- dikurangi dari p-4 -->
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex flex-col justify-center">
                        ...
                        <p class="total-investment font-bold text-green-600">
                            Rp<?php echo e(number_format($investor->total_investment, 0, ',', '.')); ?>
                ...
                <!-- <div class="mt-3 text-center"> 
                    <a href="https://wa.me/6289699497272?text=Assalamualaikum%20warohmatullahi%20wabarokatuh%2C%20Saya%20atas%20nama%20<?php echo e(urlencode(Auth::guard('investor')->user()->name)); ?>%20ingin%20mengajukan%20akun%20investasi%20baru%2C%20mohon%20untuk%20di%20proses"
            ...
            <?php $__empty_1 = true; $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="account-card">
                    ...
                    <div class="account-header">
                        <div class="account-icon <?php echo e($account->status === 'active' ? 'bg-green-500' : 'bg-gray-500'); ?>">
                            <i class="fas fa-university"></i>
                        </div>
                        <div class="account-info">
                            <h3 class="account-title"><?php echo e($account->bank_name); ?></h3>
                            <p class="account-number"><?php echo e($account->account_number); ?></p>
                        </div>
                        <span class="account-status <?php echo e($account->status === 'active' ? 'status-active' : 'status-inactive'); ?>">
                    ...
                    <div class="account-details">
                        <div class="detail-row">
                            ...
                            <span class="detail-value">Rp<?php echo e(number_format($account->total_investment, 0, ',', '.')); ?></span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">Sub-Total Keuntungan</span>
                            <span class="detail-value">Rp<?php echo e(number_format($account->total_profit, 0, ',', '.')); ?></span>
                        </div>
                        <div class="detail-row">
                            <span class="detail-label">Sub-Total Dicairkan</span>
                            <span class="detail-value">Rp<?php echo e(number_format($account->total_withdrawals, 0, ',', '.')); ?></span>
                        </div>
                        <?php if($account->saldo_tertahan != 0): ?>
                            <div class="detail-row">
                                <span class="detail-label">Sub-Saldo Tertahan</span>
                                <span class="detail-value">Rp<?php echo e(number_format($account->saldo_tertahan, 0, ',', '.')); ?></span>
                            </div>
                        <?php endif; ?>
                        <div class="detail-row">
                            <span class="detail-label">Sub-Saldo Saat Ini</span>
                            <span class="detail-value">Rp<?php echo e(number_format($account->profit_balance - $account->saldo_tertahan, 0, ',', '.')); ?></span>
                        </div>
                    </div>
                    
                    <!-- Account Footer -->
                    <div class="account-footer">
                        <a href="<?php echo e(route('investor.investments.show', $account->id)); ?>" class="detail-link">
...
<?php echo $__env->make('investor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\investor\accounts\index.blade.php ENDPATH**/ ?>