...
<?php $__env->startSection('title', 'Manajemen Bagi Hasil Kelompok'); ?>
...
<div class="modal fade" id="createGroupModal" tabindex="-1" role="dialog" aria-labelledby="createGroupModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('irp.profit-management.store-group')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\irp\profit_management\groups.blade.php ENDPATH**/ ?>