    ...
    function attendanceCrud() {
      return {
        ...
        async fetchEmployees() {
          try {
            const response = await fetch('<?php echo e(route("sdm.attendance.employees")); ?>');
            const data = await response.json();
            this.employees = data;
          } catch (error) {
        ...
        exportData() {
          if (this.currentTab === 'daily') {
            window.open(`<?php echo e(route('sdm.attendance.export.excel')); ?>?start_date=${this.filterDate}&end_date=${this.filterDate}`, '_blank');
          } else {
            window.open(`<?php echo e(route('sdm.attendance.export.monthly.pdf')); ?>?month=${this.filterMonth}&year=${this.filterYear}`, '_blank');
          }
        },
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\sdm\attendance\index-tailwind.blade.php ENDPATH**/ ?>