...
<?php $__env->startSection('title', 'Manajemen Akuntansi'); ?>
        ...
        <div class="col-md-8">
            <div class="accounting-section">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form id="journalForm" method="POST" action="<?php echo e(route('financial.accounting.storeJournal')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <table class="table table-bordered" id="journalsTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e(number_format($journal->entries->sum('debit'), 0)); ?></td>
                                        <td><?php echo e(number_format($journal->entries->sum('credit'), 0)); ?></td>
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="#" class="btn btn-info show-journal" 
                                                    data-url="<?php echo e(route('financial.journals.show', $journal->id)); ?>">
                                                    <i data-feather="eye"></i>
                                                </a>
                                                <a href="<?php echo e(route('financial.journals.edit_journal', $journal->id)); ?>" 
                                                    class="btn btn-warning">
                                                    <i data-feather="edit"></i>
                                                </a>
                                                <form action="<?php echo e(route('financial.journals.destroy_journal', $journal->id)); ?>" 
...
<div class="modal fade" id="addAccountModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('financial.accounting.storeAccount')); ?>">
                <?php echo csrf_field(); ?>
...
<!-- Modal Detail Jurnal -->
<?php echo $__env->make('financial.accounting.journals.show', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    $(document).on('submit', '#journalFilterForm', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route("financial.accounting.filterJournals")); ?>',
            type: 'GET',
            data: $(this).serialize(),
            success: function(response) {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\financial\accounting\index.blade.php ENDPATH**/ ?>