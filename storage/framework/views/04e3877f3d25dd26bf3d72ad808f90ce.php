...
<section class="bg-gradient-to-br from-green-50 to-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-md p-6 mb-8">
            <form action="<?php echo e(route('public.paket.index')); ?>" method="GET" class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <!-- Perusahaan -->
                <div>
            ...
            <?php if(request()->hasAny(['outlet_id', 'bulan', 'package_type'])): ?>
