...
<?php $__env->startSection('title', 'Tambah Prospek Baru'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('prospek.store')); ?>" method="POST" id="prospekForm">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control" id="tanggal" name="tanggal" 
                                                value="<?php echo e(old('tanggal', \Carbon\Carbon::now()->format('Y-m-d\TH:i'))); ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <!-- <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="jenis" name="jenis">
                                                ...
                                                <option value="Perusahaan" <?php echo e(old('jenis') == 'Perusahaan' ? 'selected' : ''); ?>>Perusahaan</option>
                                                <option value="Perorangan" <?php echo e(old('jenis') == 'Perorangan' ? 'selected' : ''); ?>>Perorangan</option>
                                                <option value="UKM" <?php echo e(old('jenis') == 'UKM' ? 'selected' : ''); ?>>UKM</option>
                                                <option value="Koperasi" <?php echo e(old('jenis') == 'Koperasi' ? 'selected' : ''); ?>>Koperasi</option>
                                            </select>
                                        </div>
                                    </div> -->
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="pemilik_manager" name="pemilik_manager" 
                                                   value="<?php echo e(old('pemilik_manager')); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="section-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kapasitas_produksi" name="kapasitas_produksi" 
                                                   value="<?php echo e(old('kapasitas_produksi')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sistem_produksi" name="sistem_produksi" 
                                                   value="<?php echo e(old('sistem_produksi')); ?>">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="bahan_bakar" name="bahan_bakar" 
                                                   value="<?php echo e(old('bahan_bakar')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="menggunakan_boiler" name="menggunakan_boiler" 
                                                   value="<?php echo e(old('menggunakan_boiler')); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="informasi_perusahaan" name="informasi_perusahaan" rows="3"><?php echo e(old('informasi_perusahaan')); ?></textarea>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="current_status" name="current_status" required>
                                                <?php $__currentLoopData = App\Models\Prospek::STATUSES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($key); ?>" <?php echo e(old('current_status') == $key ? 'selected' : ''); ?>>
                                                        <?php echo e($value); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="recruitment_id" name="recruitment_id" required>
                                                ...
                                                <?php $__currentLoopData = $recruitments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recruitment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($recruitment->id); ?>" <?php echo e(old('recruitment_id') == $recruitment->id ? 'selected' : ''); ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="id_outlet" name="id_outlet" required>
                                                <?php $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($outlet->id_outlet); ?>" <?php echo e(old('id_outlet') == $outlet->id_outlet ? 'selected' : ''); ?>>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="section-body">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="alamat" name="alamat" rows="2"><?php echo e(old('alamat')); ?></textarea>
                                        </div>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\crm\prospek\create.blade.php ENDPATH**/ ?>