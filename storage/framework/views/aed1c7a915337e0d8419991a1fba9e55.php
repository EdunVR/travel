...
function rejectPermintaanApp() {
    return {
        ...
        async submitRejection() {
            ...
            try {
                const response = await fetch(`<?php echo e(route('admin.supply-chain.permintaan-barang.reject', ':id')); ?>`.replace(':id', this.selectedItem.id), {
                    method: 'POST',
                    headers: {
...
</script><?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\supply-chain\permintaan-barang\modals\reject.blade.php ENDPATH**/ ?>