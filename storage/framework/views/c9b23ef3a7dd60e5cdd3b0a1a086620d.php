                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="list-group" id="productCategories">
                            ...
                            <a href="#" class="list-group-item list-group-item-action" data-category="<?php echo e($category->id); ?>">
...
$(function() {
    ...
    function loadProducts(category = 'all', search = '') {
        $.get('<?php echo e(route("api.products")); ?>', {
            category: category,
            search: search
        }, function(response) {
            ...
            if (response.data.length > 0) {
                response.data.forEach(product => {
                    const imageUrl = product.images.length > 0 ? 
                        '<?php echo e(asset("storage")); ?>/' + product.images[0].path : 
                        '<?php echo e(asset("img/no-image.png")); ?>';
    ...
    function loadProductDetail(id) {
        $.get('<?php echo e(route("api.products")); ?>/${id}', function(response) {
            ...
            if (response.images.length > 0) {
                response.images.forEach((image, index) => {
                    carousel.append(`
                        <div class="carousel-item ${index === 0 ? 'active' : ''}">
                            <img src="<?php echo e(asset('storage')); ?>/${image.path}" class="d-block w-100" style="height: 300px; object-fit: contain;">
                        </div>
                    `);
                });
            } else {
                carousel.append(`
                    <div class="carousel-item active">
                        <img src="<?php echo e(asset('img/no-image.png')); ?>" class="d-block w-100" style="height: 300px; object-fit: contain;">
                    </div>
                `);
            }
        ...
        if (cartItems.length > 0) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Proses checkout
                    $.post('<?php echo e(route("jemaah.checkout")); ?>', {
                        _token: '<?php echo e(csrf_token()); ?>',
                        member_id: '<?php echo e($member->id); ?>',
                        items: cartItems
                    }, function(response) {
                        if (response.success) {
                            cartItems = [];
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\jemaah\tabs\produk.blade.php ENDPATH**/ ?>