<div class="modal fade" id="modal-form" tabindex="-1" role="dialog" aria-labelledby="modal-form">
    <div class="modal-dialog modal-lg" role="document">
        <form action="<?php echo e(route('laporan_hutang_piutang.index')); ?>" method="get" data-toggle="validator" class="form-horizontal">
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\laporan_hutang_piutang\form.blade.php ENDPATH**/ ?>