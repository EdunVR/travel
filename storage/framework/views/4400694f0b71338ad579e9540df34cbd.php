...
function tourPlanTab() {
    return {
        packageId: <?php echo e($package->id); ?>,
        tourPlans: [],
        loading: false,
        saving: false,
        ...
        async loadTourPlans() {
            this.loading = true;
            try {
                const response = await fetch(`<?php echo e(url('admin/inventaris/travel/package')); ?>/${this.packageId}/tour-plans`);
                if (response.ok) {
        ...
        addDay() {
            ...
            const departureDate = new Date('<?php echo e($package->departure_date); ?>');
        ...
        loadStandardTourPlan() {
            ...
            const departureDate = new Date('<?php echo e($package->departure_date); ?>');
            const duration = <?php echo e($package->duration_days ?? 9); ?>;
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views/admin/travel/package/partials/tour-plan-tab.blade.php ENDPATH**/ ?>