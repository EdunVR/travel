...
<head>
    ...
    <style>
        ...
        <?php elseif($template === 'invoice_delivery'): ?>
...
<body>
            ...
            <tr>
                ...
                <td style="width: 50%;">
                    <table class="date-trxid">
                        ...
                        <tr>
                            <td>Nama Customer</td>
                            <td>: <?php echo e($invoice->member ? $invoice->member->nama : ($invoice->prospek ? $invoice->prospek->nama : 'Pelanggan Umum')); ?></td>
                        </tr>
                        <tr>
                            <td>Tempo</td>
                ...
                <td style="width: 50%;">
                    <table class="date-trxid">
                        ...
                        <tr>
                            <td>Operator</td>
                            <td>: <?php echo e($invoice->user->name ?? 'System'); ?></td>
                        </tr>
                        <tr>
                            <td>Status</td>
        ...
        <tbody>
            <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="text-right"><?php echo e(number_format($item->kuantitas, 0)); ?></td>
                    <td><?php echo e($item->deskripsi); ?></td>
                    <td class="text-right">Rp <?php echo e(number_format($item->harga_normal, 0, ',', '.')); ?></td>
                    <td class="text-right"><?php echo e($item->diskon > 0 ? 'Rp ' . number_format($item->diskon * $item->kuantitas, 0, ',', '.') : '-'); ?></td>
    ...
    <div class="total-section">
        <table>
            <tr>
                ...
                <td class="text-right"><b>Rp <?php echo e(number_format($invoice->subtotal, 0, ',', '.')); ?></b></td>
            </tr>
            <?php if($invoice->total_diskon > 0): ?>
            <tr>
                <td colspan="4" class="text-right"><b>Diskon</b></td>
                <td class="text-right"><b>Rp <?php echo e(number_format($invoice->total_diskon, 0, ',', '.')); ?></b></td>
            </tr>
            <?php endif; ?>
            <tr>
                <td colspan="4" class="text-right"><b>Total Bayar</b></td>
                <td class="text-right"><b>Rp <?php echo e(number_format($invoice->total, 0, ',', '.')); ?></b></td>
            </tr>
        ...
        <div class="due-date-info">
            ...
            ?>
            <?php echo e($dueDate->format('d F Y')); ?>

            <?php if($diffInDays > 0): ?>
                (<?php echo e($diffInDays); ?> hari lagi)
            <?php elseif($diffInDays == 0): ?>
                (Hari ini)
            <?php else: ?>
                (Terlambat <?php echo e(abs($diffInDays)); ?> hari)
            <?php endif; ?>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class="footer">
        <table>
            <tr>
                ...
                <td style="width: 33%;">
                    <b>Tanda Terima</b><br>
                    ( <?php echo e($invoice->member ? $invoice->member->nama : ($invoice->prospek ? $invoice->prospek->nama : 'Pelanggan Umum')); ?> )
                </td>
                <!-- Kolom Tengah: Pesan -->
                ...
                <td style="width: 33%; text-align: right;">
                    <b>Hormat Kami</b><br>
                    ( <?php echo e($invoice->user->name ?? 'System'); ?> )
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="section-invoice">
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 15%;">
                        ...
                        <img src="<?php echo e(request()->has('preview') ? $companySettings['logo_url'] : public_path(str_replace(url('/'), '', $companySettings['logo_url']))); ?>" 
                             alt="Logo" 
                             class="company-logo">
                        <?php endif; ?>
                    </td>
        ...
        <div class="bank-info">
            ...
            <?php $__currentLoopData = $bankAccounts->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span style="font-size: 10px;">
                    <?php echo e($bank->bank_name); ?> - <?php echo e($bank->account_number); ?> a/n <?php echo e($bank->account_holder); ?>
                ...
                <tr>
                    ...
                    <td style="width: 33%; text-align: center;">
                        ...
                        <div class="signature-box" style="position: relative; display: inline-block;">
                            ...
                            <img src="<?php echo e(request()->has('preview') ? asset(auth()->user()->signature_path) : public_path(auth()->user()->signature_path)); ?>" 
                                 alt="Tanda Tangan" 
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 25%; text-align: right;">
                        ...
                        ?>
                        <img src="data:image/png;base64,<?php echo e(DNS1D::getBarcodePNG($deliveryBarcode, 'C39', $barcodeOptions['width'], $barcodeOptions['height'])); ?>" alt="barcode">
                    </td>
                </tr>
            </table>
        </div>
                ...
                <tr>
                    ...
                    <td style="width: 50%;">
                        <table>
                            <tr>
                                ...
                                <td>: SJ-<?php echo e($invoice->no_invoice); ?></td>
                            </tr>
                            <tr>
                                <td>Tanggal Kirim</td>
                    ...
                    <td style="width: 50%;">
                        <table>
                            ...
                            <tr>
                                <td colspan="2"><?php echo e($invoice->member ? $invoice->member->nama : ($invoice->prospek ? $invoice->prospek->nama : 'Pelanggan Umum')); ?></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <?php if($invoice->member && $invoice->member->alamat): ?>
                                        <?php echo e($invoice->member->alamat); ?>

                                    <?php elseif($invoice->prospek && $invoice->prospek->alamat): ?>
                                        <?php echo e($invoice->prospek->alamat); ?>
            ...
            <tbody>
                <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="text-center"><?php echo e(number_format($item->kuantitas, 0)); ?></td>
                        <td>-</td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                
                <?php for($i = count($invoice->items); $i < 5; $i++): ?>
                    <tr>
        ...
        <div style="display: table; width: 100%;">
            ...
            <div style="display: table-cell; width: 30%; vertical-align: top; text-align: right;">
                ...
                <div style="font-size: 16px; font-weight: bold; margin-bottom: 5px;">
                    No: <?php echo e($invoice->no_invoice); ?>

                </div>
                <div style="font-size: 14px;">
                    Tanggal: <?php echo e($invoice->tanggal->format('d/m/Y')); ?>
        ...
        <table style="width: 100%; margin-bottom: 20px; border: none;">
            <tr>
                <td style="width: 50%; vertical-align: top; border: none; padding: 0;">
                    ...
                    <strong>No. Invoice:</strong> <?php echo e($invoice->no_invoice); ?><br>
                    <strong>Tanggal:</strong> <?php echo e($invoice->tanggal->format('d/m/Y')); ?><br>
                </td>
                <td style="width: 50%; vertical-align: top; border: none; padding: 0;">
                    <strong style="color: #667eea;">Kepada:</strong><br>
                    <?php if($invoice->member): ?>
                        <?php echo e($invoice->member->nama); ?><br>
                        <?php echo e($invoice->member->alamat); ?><br>
                        Telp: <?php echo e($invoice->member->telepon); ?>

                    <?php elseif($invoice->prospek): ?>
                        <?php echo e($invoice->prospek->nama); ?><br>
                        <?php echo e($invoice->prospek->alamat); ?><br>
                        Telp: <?php echo e($invoice->prospek->telepon); ?>
            ...
            <td style="width: 30%; border: none;">
                <table style="width: 100%; background: white; border-radius: 8px; overflow: hidden;">
                    <tr>
                        ...
                        <td style="padding: 8px; text-align: right; background: #f8f9fa;">Rp <?php echo e(number_format($invoice->subtotal, 0, ',', '.')); ?></td>
                    </tr>
                    <?php if($invoice->total_diskon > 0): ?>
                    <tr>
                        <td style="padding: 8px;"><strong>Total Diskon:</strong></td>
                        <td style="padding: 8px; text-align: right;">- Rp <?php echo e(number_format($invoice->total_diskon, 0, ',', '.')); ?></td>
                    </tr>
                    <?php endif; ?>
                    <tr style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
                        <td style="padding: 12px;"><strong>TOTAL:</strong></td>
                        <td style="padding: 12px; text-align: right; font-weight: bold;">Rp <?php echo e(number_format($invoice->total, 0, ',', '.')); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <div class="bank-accounts">
        ...
        <div style="padding: 10px; background: #f8f9fa; border-radius: 5px;">
            ...
            <span class="bank-name"><?php echo e($companySettings['bank_name']); ?></span><br>
            <?php endif; ?>
            
            <?php if($companySettings['bank_account_number']): ?>
            <span class="account-number">No. Rek: <?php echo e($companySettings['bank_account_number']); ?></span><br>
            <?php endif; ?>
            
            <?php if($companySettings['bank_account_name']): ?>
            <span style="color: #6c757d; font-style: italic;">a/n <?php echo e($companySettings['bank_account_name']); ?></span>
            <?php endif; ?>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="print-footer">
        <div style="text-align: center; margin-bottom: 20px;">
            <div style="margin-bottom: 10px;">
                ...
                <?php echo e($invoice->tanggal->format('d F Y')); ?>
            ...
            <td style="width: 30%; border: none;">
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="padding: 5px; text-align: right;">Rp <?php echo e(number_format($invoice->subtotal, 0, ',', '.')); ?></td>
                    </tr>
                    <?php if($invoice->total_diskon > 0): ?>
                    <tr>
                        <td style="padding: 5px;"><strong>Total Diskon:</strong></td>
                        <td style="padding: 5px; text-align: right;">- Rp <?php echo e(number_format($invoice->total_diskon, 0, ',', '.')); ?></td>
                    </tr>
                    <?php endif; ?>
                    <tr style="background-color: #ecf0f1;">
                        <td style="padding: 8px;"><strong>TOTAL:</strong></td>
                        <td style="padding: 8px; text-align: right; font-weight: bold;">Rp <?php echo e(number_format($invoice->total, 0, ',', '.')); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <div class="bank-accounts">
        ...
        <div class="bank-account-item">
            ...
            <?php if($companySettings['bank_account_name']): ?>
            <span class="account-holder">a/n <?php echo e($companySettings['bank_account_name']); ?></span>
            <?php endif; ?>
        </div>
    </div>
    <?php endif; ?>
    ...
    <?php if($invoice->jenis_pembayaran === 'transfer' && $invoice->hasBuktiTransfer()): ?>
    <div style="margin-top: 20px; padding: 10px; border: 1px solid #27ae60; background: #d5f4e6; border-radius: 5px;">
        ...
        Bank: <?php echo e($invoice->nama_bank); ?> | Pengirim: <?php echo e($invoice->nama_pengirim); ?><br>
        Jumlah: Rp <?php echo e(number_format($invoice->jumlah_transfer, 0, ',', '.')); ?> | Tanggal: <?php echo e($invoice->tanggal_pembayaran->format('d/m/Y')); ?>
...
</html><?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\penjualan\invoice\print.blade.php ENDPATH**/ ?>