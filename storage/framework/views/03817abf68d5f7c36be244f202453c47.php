...
<head>
    ...
    <script src="<?php echo e(asset('js/chat-panel.js')); ?>"></script>
...
<?php endif; ?>
    ...
    <div class="lg:pl-80 transition-all overflow-x-hidden" x-data="tabSystem()">
        ...
        <footer class="px-4 lg:px-6 pb-6 text-xs text-slate-500">
            © <?php echo e(date('Y')); ?> Admin ERP. Semua data dummy.
        </footer>
    </div>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\components\layouts\admin-temp.blade.php ENDPATH**/ ?>