    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <a href="<?php echo e(route('sales.invoice.index')); ?>" class="btn btn-success btn-sm" style="margin-right: 10px;">
                    <i class="fa fa-plus"></i> Buat Invoice Baru
                </a>
                <a href="<?php echo e(route('sales.invoice.setting')); ?>" class="btn btn-warning btn-sm" style="margin-right: 10px;">
            ...
            <div class="box-body">
                <ul class="nav nav-tabs">
                    <li class="<?php echo e($status == 'terkini' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('sales.invoice.history', ['status' => 'terkini', 'start_date' => $start_date, 'end_date' => $end_date])); ?>">
                            <i class="fa fa-list"></i> Terkini
                        </a>
                    </li>
                    <li class="<?php echo e($status == 'menunggu' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('sales.invoice.history', ['status' => 'menunggu', 'start_date' => $start_date, 'end_date' => $end_date])); ?>">
                    ...
                    <li class="<?php echo e($status == 'lunas' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('sales.invoice.history', ['status' => 'lunas', 'start_date' => $start_date, 'end_date' => $end_date])); ?>">
                    ...
                    <li class="<?php echo e($status == 'gagal' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('sales.invoice.history', ['status' => 'gagal', 'start_date' => $start_date, 'end_date' => $end_date])); ?>">
...
<script>
    ...
    $(function () {
        table = $('#table-invoice-history').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('sales.invoice.history')); ?>',
                data: function (d) {
    ...
    function loadStatusCounts() {
        $.get(`<?php echo e(route('sales.invoice.status-counts')); ?>`, function(data) {
    ...
    $('#btn-update-status').click(function() {
        ...
        $.ajax({
            url: `<?php echo e(url('sales-management/invoice')); ?>/${invoiceId}/status`,
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    function resetFilter() {
        window.location.href = '<?php echo e(route('sales.invoice.history', ['status' => $status])); ?>';
    }
    ...
    function exportPdf() {
        ...
        const url = `<?php echo e(route('sales.invoice.export-pdf')); ?>?status=${status}&start_date=${startDate}&end_date=${endDate}`;
    ...
    function checkDueInvoices() {
        ...
        $.get(`<?php echo e(route('sales.invoice.due-soon')); ?>`, function(response) {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\sales_management\invoice\history.blade.php ENDPATH**/ ?>