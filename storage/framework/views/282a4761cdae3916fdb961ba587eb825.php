...
<body>
    <div class="header">
        <h1><?php echo e($filters['company_name'] ?? 'Nama Perusahaan'); ?></h1>
        <h2>Daftar Aktiva Tetap</h2>
        <?php if(isset($filters['outlet_name'])): ?>
            <p style="font-size: 10pt; color: #666;"><?php echo e($filters['outlet_name']); ?></p>
        <?php endif; ?>
    </div>
    ...
    <div class="filter-info">
        ...
        <?php endif; ?>
        <?php if(isset($filters['category']) && $filters['category'] !== 'all'): ?>
            <p>Kategori: <?php echo e(ucfirst($filters['category'])); ?></p>
        <?php endif; ?>
    ...
    <?php $__currentLoopData = $groupedAssets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $assets): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($category !== 'all'): ?>
        <div class="category-section">
            <div class="category-header">
                <?php echo e($category === 'building' ? 'Bangunan' : 
        ...
        <table>
            ...
            <tbody>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td style="font-family: 'Courier New', monospace;"><?php echo e($asset->code); ?></td>
                        <td><?php echo e($asset->name); ?></td>
                        <?php if($category === 'all'): ?>
                        <td>
                            <?php echo e($asset->category === 'building' ? 'Bangunan' : 
                        ...
                        <?php endif; ?>
                        <td><?php echo e(\Carbon\Carbon::parse($asset->acquisition_date)->format('d/m/Y')); ?></td>
                        <td class="text-right amount"><?php echo e(number_format($asset->acquisition_cost, 0, ',', '.')); ?></td>
                        <td style="font-size: 7pt;">
                            <?php echo e($asset->depreciation_method === 'straight_line' ? 'Garis Lurus' : 
                        ...
                        <td class="text-center"><?php echo e($asset->useful_life); ?> th</td>
                        <td class="text-right amount" style="color: #DC2626;"><?php echo e(number_format($asset->accumulated_depreciation, 0, ',', '.')); ?></td>
                        <td class="text-right amount" style="color: #059669;"><?php echo e(number_format($asset->book_value, 0, ',', '.')); ?></td>
                        <td class="text-center">
                            <span class="status-badge status-<?php echo e($asset->status); ?>">
                                <?php echo e($asset->status === 'active' ? 'Aktif' : 
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="<?php echo e($category === 'all' ? 11 : 10); ?>" class="text-center" style="padding: 20px; color: #999;">
            ...
            <tfoot>
                <tr style="background-color: #e5e7eb; font-weight: bold;">
                    <td colspan="<?php echo e($category === 'all' ? 5 : 4); ?>" class="text-right" style="padding: 8px;">
                        <?php echo e($category !== 'all' ? 'SUBTOTAL ' . strtoupper($category) : 'TOTAL'); ?>:
                    </td>
                    <td class="text-right amount" style="padding: 8px;"><?php echo e(number_format($categoryTotalAcquisition, 0, ',', '.')); ?></td>
                    <td colspan="2"></td>
                    <td class="text-right amount" style="padding: 8px; color: #DC2626;"><?php echo e(number_format($categoryTotalDepreciation, 0, ',', '.')); ?></td>
                    <td class="text-right amount" style="padding: 8px; color: #059669;"><?php echo e(number_format($categoryTotalBookValue, 0, ',', '.')); ?></td>
                    <td></td>
                </tr>
            </tfoot>
            <?php endif; ?>
    ...
    <div class="summary-box">
        <div class="summary-row">
            ...
            <span class="amount">Rp <?php echo e(number_format($grandTotalAcquisition, 0, ',', '.')); ?></span>
        </div>
        <div class="summary-row">
            <span>Total Akumulasi Penyusutan:</span>
            <span class="amount" style="color: #DC2626;">Rp <?php echo e(number_format($grandTotalDepreciation, 0, ',', '.')); ?></span>
        </div>
        <div class="summary-row total">
            <span>Total Nilai Buku:</span>
            <span class="amount" style="color: #059669;">Rp <?php echo e(number_format($grandTotalBookValue, 0, ',', '.')); ?></span>
        </div>
        <div class="summary-row" style="font-size: 9pt; margin-top: 8px; border-top: 1px solid #ccc; padding-top: 8px;">
            ...
            <span class="amount"><?php echo e($grandTotalAcquisition > 0 ? number_format(($grandTotalDepreciation / $grandTotalAcquisition) * 100, 2) : 0); ?>%</span>
        </div>
    </div>
    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\finance\aktiva-tetap\pdf.blade.php ENDPATH**/ ?>