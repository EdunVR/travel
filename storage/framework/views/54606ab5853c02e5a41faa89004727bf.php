        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div class="text-xs text-gray-500 mt-1">
                    Pending: Rp <?php echo e(number_format($stats['pending_balance'], 0, ',', '.')); ?>
                    ...
                    <?php
                        ...
                        $waitingDeparture = $affiliator->referrals()
                            ...
                            ->sum('commission_amount');
                    ?>
                    <?php if($waitingPayment > 0): ?>
                        <br><span class="text-amber-600">⏳ Menunggu Pelunasan: Rp <?php echo e(number_format($waitingPayment, 0, ',', '.')); ?></span>
                    <?php endif; ?>
                    <?php if($waitingDeparture > 0): ?>
                        <br><span class="text-blue-600">⏳ Menunggu Keberangkatan: Rp <?php echo e(number_format($waitingDeparture, 0, ',', '.')); ?></span>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                ...
                                <div class="text-right">
                                    ...
                                    <div class="mt-1">
                                        <?php if(!$referral->termin_1_released): ?>
                                            <span class="text-xs px-1.5 py-0.5 rounded bg-amber-100 text-amber-600">
                                                ⏳ Menunggu Pelunasan
                                            </span>
                                        <?php elseif($referral->termin_1_released && !$referral->termin_2_released): ?>
