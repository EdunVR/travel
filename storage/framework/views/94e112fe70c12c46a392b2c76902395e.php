...
<?php $component->withAttributes([]); ?>
            ...
            <div class="flex gap-4 items-end">
                <div>
                    ...
                    <select id="outletFilter" onchange="changeOutlet()" class="border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        <?php $__currentLoopData = $accessibleOutlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($outlet->id_outlet); ?>" <?php echo e($selectedOutletId == $outlet->id_outlet ? 'selected' : ''); ?>>
        ...
        <div class="bg-white rounded-lg shadow-sm border p-4 mb-6">
            <div class="flex justify-between items-center">
                ...
                <div class="text-sm text-gray-600">
                    Total: <span id="totalCount"><?php echo e($preOrders->total()); ?></span> Pre Order
                </div>
            </div>
        </div>
        ...
        <div id="gridView" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border p-6 hover:shadow-md transition-shadow">
                <div class="flex justify-between items-start mb-4">
                    <div>
                        <h3 class="font-semibold text-gray-900"><?php echo e($preOrder->kode_preorder); ?></h3>
                        <p class="text-sm text-gray-600"><?php echo e($preOrder->customer->nama ?? 'N/A'); ?></p>
                    </div>
                    <span class="px-2 py-1 text-xs rounded-full 
                        <?php echo e($preOrder->status === 'penawaran' ? 'bg-yellow-100 text-yellow-800' : 
                ...
                <div class="space-y-2 mb-4">
                    ...
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="font-medium">Rp <?php echo e(number_format($preOrder->total, 0, ',', '.')); ?></span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600">Items:</span>
                        <span><?php echo e($preOrder->items->count()); ?> item</span>
                    </div>
                </div>

                <div class="flex gap-2">
                    <button onclick="viewPreOrder(<?php echo e($preOrder->id); ?>)" 
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $preOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $preOrder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($preOrder->kode_preorder); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($preOrder->customer->nama ?? '-'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($preOrder->tanggal->format('d/m/Y')); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full <?php echo e($preOrder->status_badge); ?>">
                                    <?php echo e(ucfirst($preOrder->status)); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">Rp <?php echo e(number_format($preOrder->total, 0, ',', '.')); ?></div>
                                <?php if($preOrder->dp_amount): ?>
                                <div class="text-xs text-gray-500">DP: Rp <?php echo e(number_format($preOrder->dp_amount, 0, ',', '.')); ?></div>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($preOrder->items->count()); ?> item(s)</div>
                            </td>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="customer_id" id="customerId" required 
                                    ...
                                    <option value="<?php echo e($customer->id_member); ?>"><?php echo e($customer->nama); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="border rounded-lg p-4 hover:bg-gray-50 cursor-pointer" 
                             onclick="selectProduct(<?php echo e($product->id_produk); ?>, '<?php echo e($product->nama_produk); ?>', <?php echo e($product->harga_jual ?? 0); ?>)">
                            ...
                            <?php endif; ?>
                            <h4 class="font-medium text-gray-900"><?php echo e($product->nama_produk); ?></h4>
                            <p class="text-sm text-gray-600">Rp <?php echo e(number_format($product->harga_jual ?? 0, 0, ',', '.')); ?></p>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
    ...
    <script>
        ...
        function loadCustomersAndProducts() {
            ...
            // Load customers
            fetch(`<?php echo e(route('admin.penjualan.preorders.customers-by-outlet')); ?>?outlet_id=${outletId}`)
            ...
            fetch(`<?php echo e(route('admin.penjualan.preorders.products-by-outlet')); ?>?outlet_id=${outletId}`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        function viewPreOrder(preOrderId) {
            ...
            fetch(`<?php echo e(url('admin/penjualan/preorders')); ?>/${preOrderId}`, {
                headers: {
        ...
        document.getElementById('preOrderForm').addEventListener('submit', function(e) {
            ...
            const url = data.id ? `<?php echo e(url('admin/penjualan/preorders')); ?>/${data.id}` : '<?php echo e(route("admin.penjualan.preorders.store")); ?>';
        ...
        document.getElementById('statusForm').addEventListener('submit', function(e) {
            ...
            fetch(`<?php echo e(url('admin/penjualan/preorders')); ?>/${preOrderId}/update-status`, {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                },
        ...
        function changeOutlet() {
            ...
            window.location.href = '<?php echo e(route("admin.penjualan.preorders.index")); ?>' + '?' + params.toString();
        }

        // COA Modal functions
        function openCoaModal() {
            // Load COA settings
            fetch('<?php echo e(route("admin.penjualan.preorders.settings.getCoas")); ?>')
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        function showCoaModal(coas, settings) {
            ...
            document.getElementById('coaForm').addEventListener('submit', function(e) {
                ...
                fetch('<?php echo e(route("admin.penjualan.preorders.settings.store")); ?>', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                    },
        ...
        function filterData() {
            ...
            window.location.href = '<?php echo e(route("admin.penjualan.preorders.index")); ?>' + (params.toString() ? '?' + params.toString() : '');
        }
        ...
        function resetFilter() {
            ...
            window.location.href = '<?php echo e(route("admin.penjualan.preorders.index")); ?>';
        }

        // Print document function
        function printDocument(type, preOrderId) {
            const url = `<?php echo e(url('admin/penjualan/preorders')); ?>/${preOrderId}/print/${type}`;
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\pre-orders\index.blade.php ENDPATH**/ ?>