                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="info-item mb-2">
                                        ...
                                        <span class="font-weight-bold text-dark"><?php echo e($produksi->produk->nama_produk ?? 'Produk Telah Dihapus'); ?></span>
                                    </div>
                                    <div class="info-item mb-2">
                                        <small class="text-muted d-block">Outlet</small>
                                        <span class="font-weight-bold text-dark"><?php echo e($produksi->outlet->nama_outlet ?? '-'); ?></span>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="info-item mb-2">
                                        <small class="text-muted d-block">Jumlah Produksi</small>
                                        <span class="font-weight-bold text-info"><?php echo e(format_uang($produksi->jumlah)); ?> unit</span>
                                    </div>
                                    <div class="info-item mb-2">
                                        <small class="text-muted d-block">Tanggal</small>
                                        <span class="font-weight-bold text-dark"><?php echo e(tanggal_indonesia($produksi->created_at, true)); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-pastel-info h-100">
                        <div class="card-body text-center d-flex flex-column justify-content-center">
                            <div class="mb-3">
                                ...
                                <h2 class="font-weight-bold text-success mb-0"><?php echo e(format_uang($hppUnit)); ?></h2>
                            </div>
                            <small class="text-muted">Total Biaya Produksi: <?php echo e(format_uang($totalHPP)); ?></small>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-hover table-striped mb-0">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $no = 1;
                                ?>
                                <?php $__currentLoopData = $produksi->detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $subtotal = $detail->harga_beli * $detail->jumlah;
                                        $totalHPP += $subtotal;
                                    ?>
                                    <tr class="animate-fade-in" style="animation-delay: <?php echo e($no * 0.1); ?>s">
                                        <td class="text-center"><?php echo e($no++); ?></td>
                                        <td class="font-weight-bold"><?php echo e($detail->bahan->nama_bahan ?? 'Bahan Telah Dihapus'); ?></td>
                                        <td class="text-center">
                                            <span class="badge badge-pastel-primary"><?php echo e(format_uang($detail->jumlah)); ?></span>
                                        </td>
                                        <td class="text-center">
                                            <span class="badge badge-pastel-info"><?php echo e($detail->bahan->satuan->nama_satuan ?? '-'); ?></span>
                                        </td>
                                        <td class="text-center font-weight-bold text-success"><?php echo e(format_uang($detail->harga_beli)); ?></td>
                                        <td class="text-center"><?php echo e(tanggal_indonesia($detail->tanggal_harga, false)); ?></td>
                                        <td class="text-right font-weight-bold text-primary"><?php echo e(format_uang($subtotal)); ?></td>
                                    </tr>
                            ...
                            <tfoot class="bg-pastel-primary">
                                <tr class="font-weight-bold">
                                    ...
                                    <td class="text-right border-0 text-success"><?php echo e(format_uang($totalHPP)); ?></td>
                                </tr>
                                <tr class="table-pastel-info">
                                    ...
                                    <td class="text-right border-0 font-weight-bold text-success">
                                        <?php echo e(format_uang($produksi->jumlah > 0 ? round($totalHPP / $produksi->jumlah) : 0)); ?>
                ...
                <div class="col-md-4">
                    <div class="card card-pastel-primary text-center btn-hover-lift">
                        <div class="card-body py-3">
                            ...
                            <h5 class="mb-1 text-primary font-weight-bold"><?php echo e($produksi->detail->count()); ?></h5>
                ...
                <div class="col-md-4">
                    <div class="card card-pastel-info text-center btn-hover-lift">
                        <div class="card-body py-3">
                            ...
                            <h5 class="mb-1 text-info font-weight-bold"><?php echo e(format_uang($totalHPP)); ?></h5>
                ...
                <div class="col-md-4">
                    <div class="card card-pastel-success text-center btn-hover-lift">
                        <div class="card-body py-3">
                            ...
                            <h5 class="mb-1 text-success font-weight-bold"><?php echo e(format_uang($produksi->jumlah > 0 ? round($totalHPP / $produksi->jumlah) : 0)); ?></h5>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\produksi\detail.blade.php ENDPATH**/ ?>