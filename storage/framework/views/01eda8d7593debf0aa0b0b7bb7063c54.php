...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => $icon,'class' => 'w-6 h-6 text-primary-700']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($icon),'class' => 'w-6 h-6 text-primary-700']); ?>
...
<?php endif; ?>
        ...
        <div>
            <h3 class="font-semibold text-ink-900"><?php echo e($title); ?></h3>
            <?php if($desc): ?>
                <p class="mt-1 text-sm text-ink-700/80"><?php echo e($desc); ?></p>
            <?php endif; ?>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\components\card-link.blade.php ENDPATH**/ ?>