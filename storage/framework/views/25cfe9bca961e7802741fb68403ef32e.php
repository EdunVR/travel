...
<body>
    <div class="container">
        ...
        <h4 class="text-center">
            <?php echo e(tanggal_indonesia($awal, false)); ?> s/d <?php echo e(tanggal_indonesia($akhir, false)); ?>
        ...
        <table class="table table-bordered">
            <thead>
                ...
                <tr class="total-row">
                    ...
                    <td><span class="badge bg-primary"><?php echo e(format_uang($totalHPP)); ?></span></td>
                    <td><span class="badge bg-warning"><?php echo e(format_uang($totalHargaJual)); ?></span></td>
                    <td><span class="badge bg-success"><?php echo e($totalJumlah); ?></span></td>
                    <td>
                        <div class="payment-totals">
                            <span class="badge bg-info">Cash: <?php echo e(format_uang($totalCash)); ?></span>
                            <span class="badge bg-danger">Bon: <?php echo e(format_uang($totalBon)); ?></span>
                        </div>
                    </td>
                    <?php if(in_array('Tampilkan Profit', Auth::user()->akses_khusus ?? [])): ?>
                    <td><span class="badge bg-danger"><?php echo e(format_uang($totalProfit)); ?></span></td>
                    <?php endif; ?>
                </tr>
            </thead>
            <tbody>
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($row['DT_RowIndex']); ?></td>
                        <td><?php echo e($row['tanggal']); ?></td>
                        <td><?php echo e($row['nama_produk']); ?></td>
                        <td><?php echo e($row['hpp']); ?></td>
                        <td><?php echo e($row['harga_jual']); ?></td>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\laporan_penjualan\pdf.blade.php ENDPATH**/ ?>