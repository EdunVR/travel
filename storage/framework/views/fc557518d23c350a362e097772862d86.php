            ...
            <div class="box-body">
                <form id="form-setting">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo e($currentInvoiceNumber); ?>" readonly>
                        <small class="text-muted">Format: 000/BBN.INV/IX/2025</small>
                    </div>

                    <div class="form-group">
                        <label for="next_number">Nomor Berikutnya Akan Menjadi</label>
                        <input type="text" class="form-control" value="<?php echo e($nextInvoiceNumber); ?>" readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="starting_number" id="starting_number" class="form-control" 
                               value="<?php echo e($currentNumber + 1); ?>" min="1" max="999" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="year" id="year" class="form-control" 
                               value="<?php echo e(date('Y')); ?>" min="2020" max="2030" required>
                    </div>
                    ...
                    <a href="<?php echo e(route('service.invoice.history')); ?>" class="btn btn-default">
...
<script>
    $(function () {
        ...
        $('#form-setting').submit(function(e) {
            ...
            $.post('<?php echo e(route("service.invoice.update-setting")); ?>', formData, function(response) {
                if (response.success) {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\service_management\invoice\setting.blade.php ENDPATH**/ ?>