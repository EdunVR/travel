        ...
        <div class="box">
            <div class="box-header with-border">
                <table>
                    <tr>
                        <td>Outlet</td>
                        <td>: <?php echo e($supplier->outlet->nama_outlet); ?> </td>
                    </tr>
                    <tr>
                        <td>Supplier</td>
                    ...
                    <tr>
                        <td>Hutang</td>
                        <td>: <span class="label label-danger"> <?php echo e(format_uang($supplier->hutang)); ?> </span></td>
                    </tr> 
                </table>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <form action="<?php echo e(route('pembelian.store')); ?>" class="form-pembelian"
                            method="post">
                            <?php echo csrf_field(); ?>
                            ...
                            <input type="hidden" name="id_supplier" id="id_supplier" value="<?php echo e($supplier->id_supplier); ?>">
                            <input type="hidden" name="hutangHidden" id="hutangHidden" value="<?php echo e($supplier->hutang); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="number" name="diskon" id="diskon" class="form-control"
                                       min="0" value="<?php echo e($diskon); ?>" max="100">
...
<?php if ($__env->exists('pembelian_detail.detail')) echo $__env->make('pembelian_detail.detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if ($__env->exists('pembelian_detail.bahan')) echo $__env->make('pembelian_detail.bahan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if ($__env->exists('pembelian_detail.edit_jumlah')) echo $__env->make('pembelian_detail.edit_jumlah', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if ($__env->exists('pembelian_detail.form_harga')) echo $__env->make('pembelian_detail.form_harga', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php $__env->stopSection(); ?>

    <?php $__env->startPush('scripts'); ?>
        <script>
            let baseUrl = "<?php echo e(url('/')); ?>"; // Base URL Laravel

            function getHargaBeliUrl(idBahan) {
                return "<?php echo e(route('getHargaBeli', ':id')); ?>".replace(':id', idBahan);
            }
            ...
            $(function () {
                table = $('.table-pembelian').DataTable({
                        ...
                        serverSide: true,
                        autoWidth: false,
                        ajax: '<?php echo e(route('pembelian_detail.data', $id_pembelian)); ?>',
                        columns: [{
                                data: 'DT_RowIndex',
                                searchable: false,
                                sortable: false
                ...
                const bahan = <?php echo json_encode($bahan, 15, 512) ?>; 
                ...
                $('.btn-simpan').on('click', function () {
                    ...
                    $.post('<?php echo e(route('pembelian_detail.updateHutang')); ?>', {
                        '_token': $('[name=csrf-token]').attr('content'),
            ...
            function loadBahan() {
                $.ajax({
                    url: '<?php echo e(route('pembelian_detail.index')); ?>',
                    type: 'GET',
            ...
            function tambahBahan() {
                ...
                console.log(jumlah);
                $.post('<?php echo e(route('pembelian_detail.store')); ?>', {
            ...
            function loadForm(diskon = 0) {
                ...
                $.get(
                        `<?php echo e(url('/pembelian_detail/loadform')); ?>/${diskon}/${$('.total').text()}/${isChecked}/${isBayarHutang}/${hutang}`
                    )
                    .done(response => {
            ...
            function tambahHargaBahan() {
                ...
                $.post('<?php echo e(route('simpanHargaBahan')); ?>', {
            ...
            function simpanEditJumlah() {
                ...
                $.ajax({
                    url: '<?php echo e(route('pembelian_detail.updateJumlah')); ?>', // Route untuk update jumlah
                    type: 'POST',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                ...
                $.get(url)
                    .done((response) => {
                        ...
                        $('#modal-form-harga .btn-primary').on('click', function(e) {
                            ...
                            $.ajax({
                                url: "<?php echo e(url('pembelian_detail/bahan_harga')); ?>/" + response.id,
                                method: 'PUT',
                                data: dataX,
                                headers: {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\pembelian_detail\index.blade.php ENDPATH**/ ?>