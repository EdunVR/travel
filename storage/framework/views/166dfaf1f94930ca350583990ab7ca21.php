...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.admin','data' => ['title' => 'Permintaan Barang']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Permintaan Barang']); ?>
    <div x-data="permintaanBarangApp()" 
         ...
         <?php echo $__env->yieldSection(); ?>-notification="handleNotification($event.detail)"
         class="space-y-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
             ...
             <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'supply-chain.permintaan-barang.create')): ?>
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-slate-200">
                        ...
                        <div class="flex items-center gap-2">
                            <button @click="showDetail(item)" 
                             ...
                             <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'supply-chain.permintaan-barang.update')): ?>
                            ...
                            <?php if (\Illuminate\Support\Facades\Blade::check('hasPermission', 'supply-chain.permintaan-barang.approve')): ?>
        ...
        <div x-show="!loading && data.length === 0" class="bg-white rounded-xl border border-slate-200 p-12 text-center">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('supply-chain.permintaan-barang.create')): ?>
            <button @click="showCreateModal = true" 
                    class="inline-flex items-center gap-2 px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors">
        ...
        <?php echo $__env->make('admin.supply-chain.permintaan-barang.modals.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin.supply-chain.permintaan-barang.modals.detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin.supply-chain.permintaan-barang.modals.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin.supply-chain.permintaan-barang.modals.approval', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin.supply-chain.permintaan-barang.modals.reject', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
            ...
            return {
                ...
                async loadData(page = 1) {
                    ...
                    try {
                        ...
                        const response = await fetch(`<?php echo e(route('admin.supply-chain.permintaan-barang.data')); ?>?${params}`);
                ...
                async loadStats() {
                    try {
                        const response = await fetch('<?php echo e(route('admin.supply-chain.permintaan-barang.stats')); ?>');
                ...
                async loadOutlets() {
                    try {
                        const response = await fetch('<?php echo e(route('admin.supply-chain.permintaan-barang.outlets')); ?>');
                ...
                generatePdf(id) {
                    window.open(`<?php echo e(route('admin.supply-chain.permintaan-barang.pdf', ':id')); ?>`.replace(':id', id), '_blank');
                },
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\supply-chain\permintaan-barang\index.blade.php ENDPATH**/ ?>