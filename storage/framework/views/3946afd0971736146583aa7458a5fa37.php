        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-edit-jumlah">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" id="edit_id_pembelian_detail" name="id_pembelian_detail">
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\pembelian_detail\edit_jumlah.blade.php ENDPATH**/ ?>