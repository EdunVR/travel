...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Service Management <?php $__env->endSlot(); ?>
            ...
            return {
                ...
                async loadOutlets() {
                    try {
                        ...
                        const outletsData = <?php echo json_encode($outlets ?? [], 15, 512) ?>;
                        ...
                        const apiUrl = '<?php echo e(url("/api/outlets")); ?>';
                ...
                getHistoryUrl(status) {
                    const baseUrl = '<?php echo e(route("admin.service.history.index")); ?>';
                ...
                getInvoiceUrl() {
                    const baseUrl = '<?php echo e(route("admin.service.invoice.index")); ?>';
                    const params = this.getOutletParams();
                    return params ? `${baseUrl}?${params}` : baseUrl;
                },

                getOngkirUrl() {
                    const baseUrl = '<?php echo e(route("admin.service.ongkir.index")); ?>';
                    const params = this.getOutletParams();
                    return params ? `${baseUrl}?${params}` : baseUrl;
                },

                getMesinUrl() {
                    const baseUrl = '<?php echo e(route("admin.service.mesin.index")); ?>';
                    const params = this.getOutletParams();
                    return params ? `${baseUrl}?${params}` : baseUrl;
                }
            }
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\service\index.blade.php ENDPATH**/ ?>