...
<div class="row">
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-boxx">
            <div class="innerx">
                <h3><?php echo e($bahan); ?></h3>
                <p>Total Bahan</p>
            </div>
            <div class="iconx">
                <i class="fa fa-cube"></i>
            </div>
            <a href="<?php echo e(route('bahan.index')); ?>" class="small-box-footerx">Lihat <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-boxx">
            ...
            <a href="<?php echo e(route('produk.index')); ?>" class="small-box-footerx">Lihat <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-boxx">
            ...
            <a href="<?php echo e(route('member.index')); ?>" class="small-box-footerx">Lihat <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-boxx">
            ...
            <a href="<?php echo e(route('supplier.index')); ?>" class="small-box-footerx">Lihat <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- ./col -->
</div>
...
<div class="infographicx">
    <div class="infographicx-itemx">
        ...
        <p>Rp <?php echo e(number_format($total_omset, 0, ',', '.')); ?></p>
    </div>
    <div class="infographicx-itemx">
        <h4>Total Profit Hari Ini</h4>
        <p>Rp <?php echo e(number_format($total_profit, 0, ',', '.')); ?></p>
    </div>
    <div class="infographicx-itemx">
        <h4>Total BON Hari Ini</h4>
        <p>Rp <?php echo e(number_format($total_BON_harian, 0, ',', '.')); ?></p>
    </div>
    <div class="infographicx-itemx">
        <h4>Total CASH Hari Ini</h4>
        <p>Rp <?php echo e(number_format($total_CASH_harian, 0, ',', '.')); ?></p>
    </div>
</div>

<!-- Form Ubah Periode -->
<form action="<?php echo e(route('dashboard')); ?>" method="GET" class="form-inlinex text-center mb-3">
    <div class="form-groupx">
        <input type="date" name="tanggal_awal" class="form-controlx" value="<?php echo e($tanggal_awal); ?>">
    </div>
    <div class="form-groupx">
        <input type="date" name="tanggal_akhir" class="form-controlx" value="<?php echo e($tanggal_akhir); ?>">
    </div>
    ...
    <div class="col-lg-6">
        <div class="boxx">
            <div class="boxx-headerx">
                ...
                <p class="text-center">
                    <strong><?php echo e(tanggal_indonesia($tanggal_awal, false)); ?> s/d <?php echo e(tanggal_indonesia($tanggal_akhir, false)); ?></strong>
                </p>
            </div>
        ...
        datasets: [
            {
                ...
                data: <?php echo e(json_encode($data_penjualan)); ?>,
                fill: true
            },
            {
                label: 'BON Customer',
                ...
                data: <?php echo e(json_encode($data_BON)); ?>,
                fill: true
            },
            {
                label: 'Margin Profit',
                ...
                data: <?php echo e(json_encode($data_profit)); ?>,
                fill: true
            }
        ]
    };
        ...
        datasets: [
            {
                ...
                data: <?php echo e(json_encode($data_pembelian)); ?>,
                fill: true
            },
            {
                ...
                data: <?php echo e(json_encode($data_pengeluaran)); ?>,
                fill: true
            }
        ]
    };
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\admin_old\dashboard.blade.php ENDPATH**/ ?>