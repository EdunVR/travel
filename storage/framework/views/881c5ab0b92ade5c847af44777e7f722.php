<div class="row mt-3">
    <div class="col-md-12">
        ...
        <form id="keluargaForm" action="<?php echo e(route('jemaah.updateKeluarga', $member->id_member)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
$(function() {
    ...
    const anggotaKeluarga = <?php echo json_encode($member->keluarga ?? [], 15, 512) ?>;
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="image-upload-container">
                                <img src="${data.ktp_path ? '<?php echo e(asset("storage")); ?>/'+data.ktp_path : '<?php echo e(asset("img/placeholder-ktp.jpg")); ?>'" 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="image-upload-container">
                                <img src="${data.passport_path ? '<?php echo e(asset("storage")); ?>/'+data.passport_path : '<?php echo e(asset("img/placeholder-passport.jpg")); ?>'" 
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\jemaah\tabs\keluarga.blade.php ENDPATH**/ ?>