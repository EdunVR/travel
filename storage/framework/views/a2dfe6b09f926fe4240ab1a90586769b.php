    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Kelola Gerobak - <?php echo e($agen->nama); ?></h3>
                <div class="btn-group">
                    <button onclick="addForm('<?php echo e(route('agen_gerobak.gerobak.store', $agen->id_member)); ?>')" 
                            class="btn btn-success btn-xs btn-flat">
                        <i class="fa fa-plus-circle"></i> Tambah Gerobak
                    </button>
                    <button onclick="deleteSelected('<?php echo e(route('agen_gerobak.gerobak.destroy-selected', $agen->id_member)); ?>')" 
...
<?php if ($__env->exists('gerobak.form')) echo $__env->make('gerobak.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if ($__env->exists('gerobak.manage_produk')) echo $__env->make('gerobak.manage_produk', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<script>
    
    var currentAgenId = <?php echo e($agen->id_member); ?>;
    ...
    $(function () {
        tableGerobak = $('.table-gerobak').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('agen_gerobak.gerobak.data', $agen->id_member)); ?>',
                type: 'get'
            },
            columns: [
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\gerobak\index.blade.php ENDPATH**/ ?>