...
<head>
    ...
    <title>Neraca Lajur - <?php echo e($accountingBook->name); ?></title>
    <style>
        body {
    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="account-type-<?php echo e($account['account_type']); ?>">
                ...
                <td class="text-right"><?php echo e(number_format($account['trial_balance']['debit'], 2)); ?></td>
                <td class="text-right"><?php echo e(number_format($account['trial_balance']['credit'], 2)); ?></td>
                <td class="text-right"><?php echo e(number_format($account['income_statement']['debit'], 2)); ?></td>
                <td class="text-right"><?php echo e(number_format($account['income_statement']['credit'], 2)); ?></td>
                <td class="text-right"><?php echo e(number_format($account['balance_sheet']['debit'], 2)); ?></td>
                <td class="text-right"><?php echo e(number_format($account['balance_sheet']['credit'], 2)); ?></td>
            </tr>
            ...
            <tr class="total-row">
                ...
                <td class="text-right"><?php echo e(number_format($worksheetData['totals']['trial_balance']['debit'], 2)); ?></td>
                <td class="text-right"><?php echo e(number_format($worksheetData['totals']['trial_balance']['credit'], 2)); ?></td>
                <td colspan="4"></td>
            </tr>
            ...
            <tr class="total-row">
                ...
                <td class="text-right"><?php echo e(number_format($worksheetData['totals']['income_statement']['debit'], 2)); ?></td>
                <td class="text-right"><?php echo e(number_format($worksheetData['totals']['income_statement']['credit'], 2)); ?></td>
                <td colspan="2"></td>
            </tr>
            ...
            <tr class="net-income-row">
                <td colspan="6" class="text-center">
                    <strong><?php echo e($worksheetData['net_income'] >= 0 ? 'LABA BERSIH' : 'RUGI BERSIH'); ?></strong>
                </td>
                <td colspan="2" class="text-center">
                    <strong><?php echo e(number_format(abs($worksheetData['net_income']), 2)); ?></strong>
                </td>
            </tr>
            ...
            <tr class="total-row">
                ...
                <td class="text-right"><?php echo e(number_format($worksheetData['totals']['balance_sheet']['debit'], 2)); ?></td>
                <td class="text-right"><?php echo e(number_format($worksheetData['totals']['balance_sheet']['credit'], 2)); ?></td>
            </tr>
...
<?php /**PATH C:\xampp\htdocs\hm\resources\views\financial\worksheet\export_pdf.blade.php ENDPATH**/ ?>