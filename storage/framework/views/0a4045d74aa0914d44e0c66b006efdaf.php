    ...
    return {
        ...
        async submitForm() {
            ...
            try {
                ...
                const updateUrl = `<?php echo e(route('admin.supply-chain.permintaan-barang.index')); ?>/${this.form.id}`;
...
</script><?php /**PATH C:\xampp\htdocs\hm\resources\views\admin\supply-chain\permintaan-barang\modals\edit.blade.php ENDPATH**/ ?>