        ...
        <div class="box">
            <div class="box-header with-border">
                <div class="mobile-action-buttons" style="display: none; margin-bottom: 15px;">
                    <a href="<?php echo e(route('service.invoice.index')); ?>" class="btn btn-success btn-block btn-sm" style="margin-bottom: 5px;">
                        <i class="fa fa-plus"></i> Buat Invoice Baru
                    </a>
                    <div class="btn-group btn-group-justified">
                        <a href="<?php echo e(route('service.invoice.setting')); ?>" class="btn btn-warning btn-sm">
                            <i class="fa fa-cog"></i> Setting
                        </a>
                        <a href="<?php echo e(route('sparepart.index')); ?>" class="btn btn-info btn-sm">
                            <i class="fa fa-cog"></i> Sparepart
                        </a>
                    </div>
                </div>
                
                <a href="<?php echo e(route('service.invoice.index')); ?>" class="btn btn-success btn-sm desktop-btn" style="margin-right: 10px;">
                    <i class="fa fa-plus"></i> Buat Invoice Baru
                </a>
                <a href="<?php echo e(route('service.invoice.setting')); ?>" class="btn btn-warning btn-sm desktop-btn" style="margin-right: 10px;">
                    <i class="fa fa-cog"></i> Setting Nomor Invoice
                </a>
                <a href="<?php echo e(route('sparepart.index')); ?>" class="btn btn-warning btn-sm desktop-btn" style="margin-right: 10px;">
                ...
                <div class="box-tools">
                    <form id="filter-form" method="GET" style="display: inline-block; margin-right: 10px;">
                        ...
                        <div class="input-group input-group-sm" style="width: 250px;">
                            <input type="date" class="form-control" name="start_date" value="<?php echo e($start_date); ?>" placeholder="Dari Tanggal">
                            <span class="input-group-addon">s/d</span>
                            <input type="date" class="form-control" name="end_date" value="<?php echo e($end_date); ?>" placeholder="Sampai Tanggal">
            ...
            <div class="box-body">
                <ul class="nav nav-tabs">
                    <li class="<?php echo e($status == 'terkini' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('service.invoice.history', ['status' => 'terkini', 'start_date' => $start_date, 'end_date' => $end_date])); ?>">
                            <i class="fa fa-list"></i> Terkini
                        </a>
                    </li>
                    <li class="<?php echo e($status == 'menunggu' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('service.invoice.history', ['status' => 'menunggu', 'start_date' => $start_date, 'end_date' => $end_date])); ?>">
                            <i class="fa fa-clock-o"></i> Menunggu
                            <span class="label label-warning" id="count-menunggu">0</span>
                        </a>
                    </li>
                    <li class="<?php echo e($status == 'lunas' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('service.invoice.history', ['status' => 'lunas', 'start_date' => $start_date, 'end_date' => $end_date])); ?>">
                            <i class="fa fa-check-circle"></i> Lunas
                            <span class="label label-success" id="count-lunas">0</span>
                        </a>
                    </li>
                    <li class="<?php echo e($status == 'gagal' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('service.invoice.history', ['status' => 'gagal', 'start_date' => $start_date, 'end_date' => $end_date])); ?>">
                            <i class="fa fa-times-circle"></i> Gagal
                            <span class="label label-danger" id="count-gagal">0</span>
                        </a>
                    </li>
                    <li class="<?php echo e($status == 'service-berikutnya' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('service.invoice.history', ['status' => 'service-berikutnya', 'start_date' => $start_date, 'end_date' => $end_date])); ?>">
                        ...
                        <div class="table-responsive" style="margin-top: 10px;">
                            <table class="table table-stiped table-bordered" id="table-invoice-history">
                                ...
                                <thead>
                                    ...
                                    <th>Customer</th>
                                    <th>Jenis Service</th>
                                    <?php if($status != 'service-berikutnya'): ?>
                ...
                <form id="form-status">
                    ...
                    <div id="form-pembayaran" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="tanggal_pembayaran" id="tanggal_pembayaran" class="form-control" value="<?php echo e(date('Y-m-d\TH:i')); ?>">
                            <small class="text-muted">Wajib diisi untuk status LUNAS</small>
                        </div>
                    ...
                    <div id="form-service-lanjutan" style="display: none;">
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_service_berikutnya" id="tanggal_service_berikutnya" class="form-control" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>">
            ...
            <div class="modal-body">
                <form id="form-service-berikutnya">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_service_berikutnya" id="service_berikutnya_tanggal" class="form-control" required min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>">
...
<audio id="alarm-sound" loop muted>
    <source src="<?php echo e(asset('sounds/beep-beep.mp3')); ?>" type="audio/mpeg">
    <source src="<?php echo e(asset('sounds/beep-beep.wav')); ?>" type="audio/wav">
</audio>
<?php $__env->stopSection(); ?>
...
<script>
    ...
    $(function () {
        ...
        table = $('#table-invoice-history').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('service.invoice.history')); ?>',
                data: function (d) {
                    d.status = currentStatus;
                    d.start_date = '<?php echo e($start_date); ?>';
                    d.end_date = '<?php echo e($end_date); ?>';
                }
            },
    ...
    function resetFilter() {
        window.location.href = '<?php echo e(route('service.invoice.history', ['status' => $status])); ?>';
    }
    ...
    function exportPdf() {
        ...
        const status = '<?php echo e($status); ?>';
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\service_management\invoice\history.blade.php ENDPATH**/ ?>