    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="btn-group">
                    <button onclick="addForm('<?php echo e(route('agen_gerobak.store')); ?>')" class="btn btn-success btn-xs btn-flat">
                        <i class="fa fa-plus-circle"></i> Tambah Agen
                    </button>
                    <button onclick="deleteSelected('<?php echo e(route('agen_gerobak.delete_selected')); ?>')" 
...
<?php if ($__env->exists('agen_gerobak.form')) echo $__env->make('agen_gerobak.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if ($__env->exists('agen_gerobak.detail')) echo $__env->make('agen_gerobak.detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<script>
    ...
    $(function () {
        ...
        tableAgen = $('.table-agen').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('agen_gerobak.data')); ?>',
                data: function (d) {
    ...
    function loadPenjualan(agenId) {
        ...
        tablePenjualanAgen = $('.table-penjualan').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: `<?php echo e(url('agen_gerobak')); ?>/${agenId}/laporan-penjualan`,
                data: function (d) {
    ...
    function showPenjualanPerGerobak(agenId, produkId, startDate, endDate) {
        ...
        $.get(`<?php echo e(url('agen_gerobak')); ?>/${agenId}/penjualan-gerobak/${produkId}`, {
    ...
    function loadInventory(agenId) {
        const url = `<?php echo e(url('agen_gerobak')); ?>/${agenId}/inventory`;
    ...
    function loadGerobak(agenId) {
        const url = `<?php echo e(url('agen_gerobak')); ?>/${agenId}/gerobak`;
    ...
    function tambahLaporan() {
        const agenId = window.currentAgenId;
        if (agenId) {
            window.open(`<?php echo e(url('agen_gerobak')); ?>/${agenId}/laporan/create`, '_blank');
        }
    }
    ...
    function syncStok() {
        ...
        if (confirm('Sync stok dari data penjualan? Proses ini akan update stok agen berdasarkan transaksi POS.')) {
            $.post(`<?php echo e(url('agen_gerobak')); ?>/${agenId}/sync-stok`, {
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\agen_gerobak\index.blade.php ENDPATH**/ ?>