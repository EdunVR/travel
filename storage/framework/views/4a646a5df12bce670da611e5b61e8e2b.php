    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img src="<?php echo e(asset('img/placeholder-ktp.jpg')); ?>" class="img-fluid" id="docPreviewImage">
            </div>
        </div>
    </div>
</div>
...
<script>
    $(function() {
        ...
        $('#docPreviewModal').on('show.bs.modal', function (event) {
            const button = $(event.relatedTarget);
            const docType = button.data('doctype');
            let imageUrl = '<?php echo e(asset('img/placeholder-')); ?>' + docType + '.jpg';
            
            $('#docPreviewImage').attr('src', imageUrl);
        });
    });
</script>
<?php /**PATH C:\xampp\htdocs\hm\resources\views\jemaah\tabs\dokumen.blade.php ENDPATH**/ ?>