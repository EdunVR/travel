...
<?php $__env->startSection('coa-content'); ?>
<div class="box">
    ...
    <div class="box-body">
        <form id="poPenjualanForm" action="<?php echo e(route('settings.coa.update-po-penjualan')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                                        ...
                                        <select name="accounting_book_id" id="accounting_book_id" class="form-control select2" required>
                                            ...
                                            <?php $__currentLoopData = $accountingBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($book->id); ?>" 
                                                    <?php echo e($settings->accounting_book_id == $book->id ? 'selected' : ''); ?>>
                                                    <?php echo e($book->name); ?> - <?php echo e($book->currency); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="akun_piutang_po" id="akun_piutang_po" class="form-control select2" required>
                                            ...
                                            ?>
                                            <?php $__currentLoopData = $assetAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($account['code']); ?>" 
                                                    <?php echo e($settings->akun_piutang_po == $account['code'] ? 'selected' : ''); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="akun_uang_muka_po" id="akun_uang_muka_po" class="form-control select2" required>
                                            ...
                                            ?>
                                            <?php $__currentLoopData = $liabilityAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($account['code']); ?>" 
                                                    <?php echo e($settings->akun_uang_muka_po == $account['code'] ? 'selected' : ''); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="akun_pendapatan_diterima_dimuka" id="akun_pendapatan_diterima_dimuka" class="form-control select2" required>
                                            ...
                                            <?php $__currentLoopData = $liabilityAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($account['code']); ?>" 
                                                    <?php echo e($settings->akun_pendapatan_diterima_dimuka == $account['code'] ? 'selected' : ''); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="akun_pendapatan_po" id="akun_pendapatan_po" class="form-control select2" required>
                                            ...
                                            <?php $__currentLoopData = $revenueAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($account['code']); ?>" 
                                                    <?php echo e($settings->akun_pendapatan_po == $account['code'] ? 'selected' : ''); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="akun_ongkir_po" id="akun_ongkir_po" class="form-control select2" required>
                                            ...
                                            <?php $__currentLoopData = $revenueAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($account['code']); ?>" 
                                                    <?php echo e($settings->akun_ongkir_po == $account['code'] ? 'selected' : ''); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="akun_diskon_penjualan" id="akun_diskon_penjualan" class="form-control select2" required>
                                            ...
                                            <?php $__currentLoopData = $expenseAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($account['code']); ?>" 
                                                    <?php echo e($settings->akun_diskon_penjualan == $account['code'] ? 'selected' : ''); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="akun_hpp_po" id="akun_hpp_po" class="form-control select2" required>
                                            ...
                                            <?php $__currentLoopData = $expenseAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($account['code']); ?>" 
                                                    <?php echo e($settings->akun_hpp_po == $account['code'] ? 'selected' : ''); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="akun_persediaan_po" id="akun_persediaan_po" class="form-control select2" required>
                                            ...
                                            <?php $__currentLoopData = $assetAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($account['code']); ?>" 
                                                    <?php echo e($settings->akun_persediaan_po == $account['code'] ? 'selected' : ''); ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo e(route('settings.coa.index')); ?>" class="btn btn-default">
...
<?php if($settings->akun_piutang_po): ?>
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <?php if($settings->accountingBook): ?>
                            <strong><?php echo e($settings->accountingBook->name); ?></strong><br>
                            <small class="text-muted"><?php echo e($settings->accountingBook->currency); ?> - <?php echo e($settings->accountingBook->description); ?></small>
                        <?php else: ?>
                    ...
                    <div class="panel-body">
                        <table class="table table-condensed">
                            <tr>
                                ...
                                <td><?php echo e($settings->akun_piutang_po); ?> - <?php echo e($accountNames['akun_piutang_po'] ?? 'Tidak ditemukan'); ?></td>
                            </tr>
                            <tr>
                                <td><strong>Uang Muka:</strong></td>
                                <td><?php echo e($settings->akun_uang_muka_po); ?> - <?php echo e($accountNames['akun_uang_muka_po'] ?? 'Tidak ditemukan'); ?></td>
                            </tr>
                            <tr>
                                <td><strong>Pendapatan Diterima Dimuka:</strong></td>
                                <td><?php echo e($settings->akun_pendapatan_diterima_dimuka); ?> - <?php echo e($accountNames['akun_pendapatan_diterima_dimuka'] ?? 'Tidak ditemukan'); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <table class="table table-condensed">
                            <tr>
                                ...
                                <td><?php echo e($settings->akun_pendapatan_po); ?> - <?php echo e($accountNames['akun_pendapatan_po'] ?? 'Tidak ditemukan'); ?></td>
                            </tr>
                            <tr>
                                <td><strong>Pendapatan Ongkir:</strong></td>
                                <td><?php echo e($settings->akun_ongkir_po); ?> - <?php echo e($accountNames['akun_ongkir_po'] ?? 'Tidak ditemukan'); ?></td>
                            </tr>
                            <tr>
                                <td><strong>Diskon Penjualan:</strong></td>
                                <td><?php echo e($settings->akun_diskon_penjualan); ?> - <?php echo e($accountNames['akun_diskon_penjualan'] ?? 'Tidak ditemukan'); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <table class="table table-condensed">
                            <tr>
                                ...
                                <td><?php echo e($settings->akun_hpp_po); ?> - <?php echo e($accountNames['akun_hpp_po'] ?? 'Tidak ditemukan'); ?></td>
                            </tr>
                            <tr>
                                <td><strong>Persediaan:</strong></td>
                                <td><?php echo e($settings->akun_persediaan_po); ?> - <?php echo e($accountNames['akun_persediaan_po'] ?? 'Tidak ditemukan'); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('#validateBtn').click(function() {
        ...
        $.ajax({
            url: '<?php echo e(route("settings.coa.validate-accounts")); ?>',
            type: 'POST',
            data: formData,
            headers: {
...
<?php echo $__env->make('settings.coa.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hm\resources\views\settings\coa\po_penjualan.blade.php ENDPATH**/ ?>