...
<title>Pembayaran Lunas - {{ $booking->booking_code }} | HM Tour</title>
...
<div class="p-8 space-y-6">
    <div class="bg-green-50 border-2 border-green-200 rounded-xl p-6">
        ...
        <p class="text-green-700 text-sm">
            Seluruh pembayaran untuk paket <strong>{{ $package->package_name }}</strong> 
            dengan kode booking <strong>{{ $booking->booking_code }}</strong> telah diterima dengan baik.
        </p>
    </div>
    ...
    <div class="bg-gray-50 rounded-xl p-5 space-y-3">
        <div class="flex justify-between items-center">
            ...
            <span class="font-bold text-gray-900">{{ $package->package_name }}</span>
        </div>
        <div class="flex justify-between items-center">
        ...
        <div class="flex justify-between items-center">
            ...
            <span class="font-bold text-gray-900">{{ \Carbon\Carbon::parse($package->departure_date)->format('d M Y') }}</span>
        </div>
        @endif
    </div>
