        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-4">
                    ...
                    <div class="space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-blue-900">{{ $booking->booking_code }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-blue-700">Jumlah Dibayar:</span>
                            <span class="font-semibold text-blue-900">Rp {{ number_format($payment->amount, 0, ',', '.') }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-blue-700">Tanggal Upload:</span>
                            <span class="font-semibold text-blue-900">{{ $payment->created_at->format('d M Y H:i') }}</span>
                        </div>
                        <div class="flex justify-between">
                ...
                <div class="flex gap-3">
                    <a href="{{ url('/') }}" class="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-3 px-6 rounded-lg text-center transition-all">
                        Kembali ke Homepage
                    </a>
                    <a href="{{ route('public.paket.invoice', ['packageId' => $package->id, 'bookingId' => $booking->id]) }}" 
