...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <div class="page-header text-center">
                    ...
                    <p class="text-muted mb-0">{{ $package->package_name }}</p>
                    ...
                    <div class="card-body">
                        <table class="table table-borderless mb-0">
                            <tr>
                                ...
                                <td>: {{ $bookingData['jamaah_name'] }}</td>
                            </tr>
                            <tr>
                                <td>No. HP</td>
                                <td>: {{ $bookingData['jamaah_phone'] }}</td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td>: {{ $bookingData['jamaah_email'] }}</td>
                            </tr>
                            <tr>
                                <td>Tipe Kamar</td>
                                <td>: {{ ucfirst($bookingData['room_type']) }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                @if(!empty($bookingData['family_members']))
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                @foreach($bookingData['family_members'] as $fm)
                                <tr>
                                    <td>{{ $fm['nama'] ?? '-' }}</td>
                                    <td>{{ $fm['hubungan'] ?? '-' }}</td>
                                    <td>
                                        @if(!empty($fm['tanggal_lahir']))
                                            ...
                                            ({{ \Carbon\Carbon::parse($fm['tanggal_lahir'])->age }} tahun)
                                        @else
                                            -
                                        @endif
                                    </td>
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">Rp {{ number_format($eq['price'], 0, ',', '.') }}</td>
                                    <td class="text-right">Rp {{ number_format($eq['subtotal'], 0, ',', '.') }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                ...
                <!-- Form Konfirmasi -->
                <form action="{{ route('public.booking.payment.process', ['token' => $token]) }}" method="POST" enctype="multipart/form-data" id="paymentForm">
                    @csrf
    ...
    <script>
        ...
        const originalAmount = {{ $bookingData['total_price'] }};
