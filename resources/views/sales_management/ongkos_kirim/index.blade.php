    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <button onclick="addForm('{{ route('sales.ongkos-kirim.store') }}')" class="btn btn-success btn-xs btn-flat">
...
@includeIf('sales_management.ongkos_kirim.form')
@endsection
...
<script>
    ...
    $(function () {
        table = $('#table-ongkir').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '{{ route('sales.ongkos-kirim.index') }}',
            },
            columns: [
