...
<x-layouts.admin :title="'Penjualan / Invoice Penjualan'">
  ...
  <script>
    function invoicePenjualan() {
      return {
        view: 'grid',
        selectedOutlet: @json($selectedOutlet), // Default outlet dari controller - keep for compatibility
        ...
        async loadCustomerTypePrices(customer) {
            ...
            try {
                const url = `{{ route("admin.penjualan.pos.customer-type-prices") }}?id_tipe=${customer.id_tipe}&outlet_id=${this.selectedOutlet}`;
