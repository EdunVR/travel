<x-layouts.admin>
    <x-slot name="title">Penjualan Antar Outlet</x-slot>
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4" x-data="interOutletSaleApp()">
        <script>
            ...
            window.routes = {
                interOutletProducts: '{{ route('admin.penjualan.inter-outlet.products') }}',
                interOutletOutlets: '{{ route('admin.penjualan.inter-outlet.outlets') }}',
                interOutletStore: '{{ route('admin.penjualan.inter-outlet.store') }}',
                interOutletHistory: '{{ route('admin.penjualan.inter-outlet.history') }}',
                interOutletPrint: '{{ route('admin.penjualan.inter-outlet.index') }}',
                interOutletPriceProducts: '{{ route('admin.penjualan.inter-outlet.price-products') }}',
                interOutletUpdatePrice: '{{ route('admin.penjualan.inter-outlet.update-price') }}',
                interOutletBulkUpdatePrices: '{{ route('admin.penjualan.inter-outlet.bulk-update-prices') }}',
                interOutletCoaModalData: '{{ route('admin.penjualan.inter-outlet.coa-modal-data') }}',
                interOutletCoaSettings: '{{ route('admin.penjualan.inter-outlet.coa-settings') }}',
                interOutletCoaSettingsUpdate: '{{ route('admin.penjualan.inter-outlet.coa-settings') }}'
            };
        </script>
        <!-- Header -->
        <div class="mb-6">
        ...
        <div x-show="showHistory" x-cloak 
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-7xl h-[95vh] overflow-hidden">
                ...
                <div class="p-6 overflow-y-auto h-[calc(95vh-120px)]">
                    <!-- Filters -->
                                        ...
                                        <tr class="hover:bg-slate-50">
                                            ...
                                            <td class="px-4 py-4 text-center">
                                                <div class="flex items-center justify-center gap-1">
                                                    ...
                                                    <!-- Accept Button (only for pending transactions) -->
                                                    ...
                                                    <!-- Delete Button (only for pending transactions) -->
                                                    <button x-show="transaction.can_delete" 
        ...
        <div x-show="showPriceSettings" x-cloak 
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-6xl h-[95vh] overflow-hidden">
                <div class="flex items-center justify-between p-6 border-b border-slate-200">
                    <div>
    ...
    @include('admin.penjualan.inter-outlet.coa-settings')
</x-layouts.admin>