...
<head>
    <meta charset="utf-8">
    <title>Invoice {{ $preorder->kode_preorder }}</title>
    <style>
        body {
...
<body>
    ...
    <div style="text-align: center; margin-bottom: 20px;">
        <span class="status-badge">{{ strtoupper($preorder->status) }}</span>
    </div>
    ...
    <div class="invoice-info">
        <table>
            <tr>
                ...
                <td style="width: 2%;">:</td>
                <td>{{ $preorder->updated_at->format('d/m/Y') }}</td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td>:</td>
                ...
                <td>:</td>
                <td>{{ $preorder->updated_at->addDays(30)->format('d/m/Y') }}</td>
            </tr>
            <tr>
                <td>Telp</td>
                <td>:</td>
                ...
                <td>Status</td>
                <td>:</td>
                <td><strong>{{ strtoupper($preorder->status) }}</strong></td>
            </tr>
        </table>
    </div>
    ...
    <table class="items-table">
        ...
        <tbody>
            ...
            <tr style="background-color: #f0f0f0;">
                ...
                <td class="text-right"><strong>Rp {{ number_format($preorder->total, 0, ',', '.') }}</strong></td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="payment-info">
        ...
        <table class="payment-table">
            <tr>
                ...
                <td style="width: 5%;">:</td>
                <td><strong>Rp {{ number_format($preorder->total, 0, ',', '.') }}</strong></td>
            </tr>
            @if($preorder->dp_amount)
            <tr>
                <td>Down Payment (DP):</td>
                <td>:</td>
                <td><strong>Rp {{ number_format($preorder->dp_amount, 0, ',', '.') }}</strong></td>
            </tr>
            <tr style="background-color: #ffebee;">
                <td>Sisa Pembayaran:</td>
                <td>:</td>
                <td><strong>Rp {{ number_format($preorder->remaining_payment, 0, ',', '.') }}</strong></td>
            </tr>
            @else
            <tr style="background-color: #ffebee;">
    ...
    <div style="margin-top: 40px; text-align: center; font-size: 10px; color: #666;">
        Invoice ini dicetak pada {{ now()->format('d/m/Y H:i:s') }}<br>
