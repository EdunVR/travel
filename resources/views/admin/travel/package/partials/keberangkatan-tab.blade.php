{{-- Tab Keberangkatan di Detail Paket --}}
<div class="space-y-4">
    <!-- Header Actions -->
                ...
                <div class="px-5 py-4 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="flex gap-1 ml-3">
                            ...
                            <a :href="`{{ url('') }}/admin/inventaris/travel/keberangkatan/${kb.id}/stiker-koper`"
                               target="_blank"
                               class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg border border-slate-200 hover:bg-slate-50 text-xs"
                            ...
                            <tbody class="divide-y divide-slate-100">
                                <template x-for="booking in kb.bookings" :key="booking.id">
                                    <tr class="hover:bg-slate-50">
                                        ...
                                        <td class="px-3 py-2 text-center">
                                            <a :href="`{{ url('admin/inventaris/travel/booking') }}/${booking.id}`"
...
{{-- Modal Tambah/Edit Keberangkatan --}}
...
{{-- Modal Laporan Keuangan Keberangkatan --}}
