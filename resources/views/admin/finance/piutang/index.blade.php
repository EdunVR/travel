    ...
    function piutangManagement() {
      return {
        ...
        async redirectToBookingPayment(bookingId) {
          ...
          window.location.href = `{{ route('admin.inventaris.booking.index') }}?booking_id=${bookingId}&open_payment=1`;
        },
        ...
        showInvoicePreview(piutang) {
          ...
          if (piutang.source_id) {
            window.location.href = `{{ route('admin.inventaris.booking.index') }}?booking_id=${piutang.source_id}`;
          } else {
            this.showNotification('error', 'Data booking tidak tersedia');
          }
        },
        ...
        exportExcel() {
          ...
          window.location.href = `{{ route('finance.piutang.export.excel') }}?${params}`;
        },
        ...
        exportPdf() {
          ...
          window.location.href = `{{ route('finance.piutang.export.pdf') }}?${params}`;
        }
      };
    }
  </script>
