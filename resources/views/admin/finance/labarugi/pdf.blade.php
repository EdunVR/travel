    ...
    <div class="container">
        ...
        <div class="info-section">
            <div class="info-row">
                ...
                <div class="info-value">{{ now()->translatedFormat('d F Y H:i:s') }}</div>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <div class="info-value">{{ ($filters['comparison_enabled'] ?? false) ? 'Dengan Perbandingan' : 'Standar' }}</div>
            </div>
        </div>

        <!-- Profit & Loss Statement Table -->
        <table class="main-table {{ ($filters['comparison_enabled'] ?? false) ? 'comparison-table' : '' }}">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <!-- Empty Row -->
                <tr>
                    <td colspan="{{ ($filters['comparison_enabled'] ?? false) ? 6 : 3 }}" style="border: none; height: 10px; background: transparent;"></td>
                </tr>
                ...
                <!-- LABA/RUGI BERSIH -->
                <tr class="grand-total-row {{ ($data['summary']['net_income'] ?? 0) >= 0 ? 'profit-row' : 'loss-row' }}">
                    <td></td>
            ...
            <div class="ratios-right">
                <div class="ratio-box">
                    ...
                    <div class="ratio-item">
                        ...
                        <span class="ratio-value">Rp {{ number_format($data['summary']['total_revenue'] ?? 0, 0, ',', '.') }}</span>
                    </div>
                    <div class="ratio-item">
                        <span class="ratio-label">Total Beban:</span>
                        <span class="ratio-value">Rp {{ number_format($data['summary']['total_expense'] ?? 0, 0, ',', '.') }}</span>
                    </div>
                    <div class="ratio-item">
                        <span class="ratio-label">Laba/Rugi Bersih:</span>
                        <span class="ratio-value {{ ($data['summary']['net_income'] ?? 0) >= 0 ? 'positive' : 'negative' }}">
                            Rp {{ number_format($data['summary']['net_income'] ?? 0, 0, ',', '.') }}
                        </span>
                    </div>
                </div>
            </div>
        ...
        <!-- Footer -->
        <div class="footer">
            <p><strong>{{ $companySettings['company_name'] ?? $filters['company_name'] ?? 'Nama Perusahaan' }}</strong> - Laporan Laba Rugi</p>
