    ...
    <div x-show="!isLoading && !error" class="space-y-6">
      ...
      <div class="rounded-2xl border border-slate-200 bg-white shadow-card overflow-hidden print-section">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-sm profit-loss-table">
            <thead class="bg-slate-50">
              <tr>
                ...
                <th x-show="filters.comparison && profitLossData.comparison.enabled" class="px-4 py-3 text-right border-r border-slate-200">Periode Pembanding</th>
                <th x-show="filters.comparison && profitLossData.comparison.enabled" class="px-4 py-3 text-right border-r border-slate-200">Selisih</th>
                <th x-show="filters.comparison && profitLossData.comparison.enabled" class="px-4 py-3 text-right">Perubahan (%)</th>
              </tr>
            </thead>
            <tbody>
              {{-- PENDAPATAN --}}
