    ...
    <div x-data="historyData()" x-init="init()" class="space-y-4">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <a href="{{ route('admin.service.invoice.index') }}" class="inline-flex items-center gap-2 rounded-xl bg-blue-600 text-white px-4 py-2 hover:bg-blue-700 shadow-md border border-blue-600">
    ...
    <script>
        function historyData() {
            return {
                ...
                selectedOutlets: [{{ $selectedOutlet }}],
                ...
                async checkDueSoonInvoices() {
                    try {
                        ...
                        const response = await fetch(`{{ url('/admin/service/invoice/due-soon') }}?${params}`);
                        const result = await response.json();
