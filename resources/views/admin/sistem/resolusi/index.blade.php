<x-layouts.admin title="Setting Resolusi">
    ...
    function resolutionSettings() {
        return {
            ...
            async loadSettings() {
                try {
                    const response = await fetch('{{ route('admin.sistem.resolusi.get') }}');
            ...
            async saveSettings() {
                ...
                try {
                    const response = await fetch('{{ route('admin.sistem.resolusi.store') }}', {
                        method: 'POST',
                        headers: {
            ...
            async resetSettings() {
                ...
                try {
                    const response = await fetch('{{ route('admin.sistem.resolusi.reset') }}', {
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': '{{ csrf_token() }}'
                        }
