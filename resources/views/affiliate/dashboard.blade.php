    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sticky top-4">
                    ...
                    <div class="p-4 bg-gradient-to-r from-green-600 to-green-500 text-white text-center">
                        <div class="w-16 h-16 rounded-full bg-white/20 flex items-center justify-center text-white font-bold text-xl mx-auto mb-2 overflow-hidden border-2 border-white/30">
                            ...
                            @else
                                {{ strtoupper(substr($affiliator->full_name, 0, 2)) }}
                            @endif
                        </div>
                        <div class="font-semibold text-sm">{{ $affiliator->full_name }}</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div class="text-2xl font-bold text-gray-900">{{ number_format($stats['total_clicks']) }}</div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div class="text-xs text-gray-500 mt-1">Konversi {{ $stats['conversion_rate'] }}%</div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div class="text-2xl font-bold text-green-600">Rp {{ number_format($stats['available_balance'], 0, ',', '.') }}</div>
        ...
        <div class="grid lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="p-6">
                        @if($recentReferrals->where('status', '!=', 'rejected')->count() > 0)
                        <div class="space-y-3">
                            @foreach($recentReferrals->where('status', '!=', 'rejected') as $referral)
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                <div class="flex-1">
                                    <div class="font-semibold text-gray-900 text-sm">
                                        {{ $referral->package->package_name ?? 'Paket Tidak Tersedia' }}
                                    </div>
                                    <div class="text-xs text-gray-500 mt-1">
                                        {{ $referral->order_date->format('d M Y H:i') }}
                                    </div>
                                </div>
                            ...
                            <div class="flex items-center justify-between p-4 bg-red-50 rounded-lg">
                                <div class="flex-1">
                                    ...
                                    <div class="text-xs text-red-600 mt-1">
                                        <i class="fas fa-info-circle mr-1"></i>{{ $referral->notes }}
                                    </div>
                                    @endif
                                </div>
                                <div class="text-right">
                ...
                <!-- Voucher Diskon Saya -->
                <div class="bg-white rounded-xl shadow-sm border border-gray-100" x-data="affiliateVoucherManager({{ $affiliator->id }})">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <form action="{{ route('affiliate.payout.request') }}" method="POST">
                        ...
                        <div class="mb-4 p-3 bg-gray-50 rounded-lg text-xs">
                            ...
                            <div class="text-gray-600">{{ $affiliator->bank_name }}</div>
                            <div class="text-gray-600">{{ $affiliator->bank_account_number }}</div>
                            <div class="text-gray-600">{{ $affiliator->bank_account_name }}</div>
                        </div>
                        @endif
                        <button type="submit" 
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center justify-between text-xs">
                            ...
                            <div class="text-green-600 font-semibold">
                                +Rp {{ number_format($click->commission_amount, 0, ',', '.') }}
                            </div>
                        </div>
                        @endforeach
                    </div>
