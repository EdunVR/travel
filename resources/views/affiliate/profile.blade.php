        ...
        <form action="{{ route('affiliate.profile.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="full_name" value="{{ old('full_name', $affiliator->full_name) }}" required
                ...
                <div>
                    ...
                    <input type="text" value="{{ $affiliator->username }}" readonly
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $affiliator->email) }}" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    @error('email')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" name="phone_number" value="{{ old('phone_number', $affiliator->phone_number) }}" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    @error('phone_number')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="border-t pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="bank_name" value="{{ old('bank_name', $affiliator->bank_name) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">No. Rekening</label>
                            <input type="text" name="bank_account_number" value="{{ old('bank_account_number', $affiliator->bank_account_number) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" name="bank_account_name" value="{{ old('bank_account_name', $affiliator->bank_account_name) }}"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>
                </div>
