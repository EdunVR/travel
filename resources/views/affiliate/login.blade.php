...
<body class="bg-gradient-to-br from-green-50 to-emerald-100 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-md px-4">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form action="{{ route('affiliate.login.process') }}" method="POST">
                @csrf
                ...
                <div class="flex items-center justify-end mt-4">
                    <a href="{{ route('affiliate.forgot-password') }}" class="text-sm text-green-600 hover:text-green-700 font-medium">
                        Lupa Password?
                    </a>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    Belum punya akun? 
                    <a href="{{ route('affiliate.register') }}" class="text-green-600 hover:text-green-700 font-medium">
                        Daftar di sini
                    </a>
                </p>
            </div>
